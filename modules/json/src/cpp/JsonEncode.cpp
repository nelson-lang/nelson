...
namespace Nelson {
    ...
    //=============================================================================
    static void encode_character(wchar_t ch)
    {
        switch (ch)
        {
            case L'"':
    ...
    //=============================================================================
    static void encode_double(double val, bool convertNanInf)
    {
        if (std::isnan(val))
        {
            if (convertNanInf)
    ...
    //=============================================================================
    static void encode_single(single val, bool convertNanInf)
    {
        if (std::isnan(val))
        {
            if (convertNanInf)
    ...
    //=============================================================================
    static ArrayOf jsonEncodeInternal(ArrayOf ValueToEncode, bool convertNanInf, std::wstring &errorMessage)
    {
    ...
    //=============================================================================
    ArrayOf jsonEncode(ArrayOf ValueToEncode, bool convertNanInf, std::wstring &errorMessage)
    {
        jsonString.clear();
