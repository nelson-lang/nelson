...
namespace Nelson {
	...
	static bool transformStringArray(JsonVariable &jsVar, size_t totaldims)
	{
		...
		case 1:
		{
			...
			std::transform(jsVar.vectorJsonVariable.begin(), jsVar.vectorJsonVariable.end(), jsVar.vectorString.begin(), [](JsonVariable val)
			{
				return val.scalarString;
			});
		}
		break;
		case 2:
	...
	static bool transformLogicalArray(JsonVariable &jsVar, size_t totaldims)
	{
		...
		case 1:
		{
			...
			std::transform(jsVar.vectorJsonVariable.begin(), jsVar.vectorJsonVariable.end(), jsVar.vectorLogical.begin(), [](JsonVariable val)
			{
				return val.scalarLogical;
			});
		}
		break;
		case 2:
	...
	static bool transformDoubleArray(JsonVariable &jsVar, size_t totaldims)
	{
		...
		case 1:
		{
			...
			std::transform(jsVar.vectorJsonVariable.begin(), jsVar.vectorJsonVariable.end(), jsVar.vectorDouble.begin(), [](JsonVariable val)
			{
				return val.scalarDouble;
			});
		}
		break;
		case 2:
	...
	//=============================================================================
	static bool importTokens(const jsmntok_t* tokens, JsonVariable &jsVar)
	{
		bool res = false;
	...
	//=============================================================================
	static ArrayOf jsonDecodeInternal(std::wstring stringToDecode, std::wstring &errorMessage)
	{
