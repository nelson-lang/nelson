...
static const nlsGateway gateway[] = {
    ...
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_STR, "isequal"),
        (ptrBuiltin)Nelson::HandleGateway::handle_isequalBuiltin, 1, 2 },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_STR, "isequaln"),
        (ptrBuiltin)Nelson::HandleGateway::handle_isequalBuiltin, 1, 2 },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_STR, "isequalto"),
        (ptrBuiltin)Nelson::HandleGateway::handle_isequalBuiltin, 1, 2 },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_STR, "get"),
        (ptrBuiltin)Nelson::HandleGateway::handle_getBuiltin, 1, 1 },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_STR, "set"),
        (ptrBuiltin)Nelson::HandleGateway::handle_setBuiltin, 1, 1, CPP_BUILTIN_WITH_EVALUATOR },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_STR, "invoke"),
        (ptrBuiltin)Nelson::HandleGateway::handle_invokeBuiltin, 1, 1, CPP_BUILTIN_WITH_EVALUATOR },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_STR, "display"),
        (ptrBuiltin)Nelson::HandleGateway::handle_displayBuiltin, 0, 2,
        CPP_BUILTIN_WITH_EVALUATOR },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_STR, "disp"),
        (ptrBuiltin)Nelson::HandleGateway::handle_dispBuiltin, 0, 1, CPP_BUILTIN_WITH_EVALUATOR },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_STR, "delete"),
        (ptrBuiltin)Nelson::HandleGateway::handle_deleteBuiltin, 0, 1, CPP_BUILTIN_WITH_EVALUATOR },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_STR, "isvalid"),
        (ptrBuiltin)Nelson::HandleGateway::handle_isvalidBuiltin, 1, 1,
        CPP_BUILTIN_WITH_EVALUATOR },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_STR, "fieldnames"),
        (ptrBuiltin)Nelson::HandleGateway::handle_fieldnamesBuiltin, 1, 1,
        CPP_BUILTIN_WITH_EVALUATOR },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_STR, "methods"),
        (ptrBuiltin)Nelson::HandleGateway::handle_methodsBuiltin, 1, 1 },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_STR, "ismethod"),
        (ptrBuiltin)Nelson::HandleGateway::handle_ismethodBuiltin, 1, 2 },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_STR, "isprop"),
        (ptrBuiltin)Nelson::HandleGateway::handle_ispropBuiltin, 1, 2 },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_STR, "properties"),
        (ptrBuiltin)Nelson::HandleGateway::handle_propertiesBuiltin, 1, 1 },
};
//=============================================================================
