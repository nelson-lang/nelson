...
static const nlsGateway gateway[] = {
    ...
    { "properties", (void*)Nelson::HandleGateway::propertiesBuiltin, 1, 1, CPP_BUILTIN_WITH_EVALUATOR },
    ...
    { "handle_horzcat_handle", (void*)Nelson::HandleGateway::handle_horzcat_handleBuiltin, 1, 2,
        CPP_BUILTIN },
    { "handle_eq_handle", (void*)Nelson::HandleGateway::handle_eq_handleBuiltin, 1, 2, CPP_BUILTIN },
    { "generic_eq_handle", (void*)Nelson::HandleGateway::generic_eq_handleBuiltin, 1, 2, CPP_BUILTIN },
    { "handle_eq_generic", (void*)Nelson::HandleGateway::handle_eq_genericBuiltin, 1, 2, CPP_BUILTIN },
    { "handle_isequal", (void*)Nelson::HandleGateway::handle_isequalBuiltin, 1, 2, CPP_BUILTIN },
    { "handle_isequaln", (void*)Nelson::HandleGateway::handle_isequalBuiltin, 1, 2, CPP_BUILTIN },
    { "handle_isequalto", (void*)Nelson::HandleGateway::handle_isequalBuiltin, 1, 2, CPP_BUILTIN },

    { "handle_get", (void*)Nelson::HandleGateway::handle_getBuiltin, 1, 1, CPP_BUILTIN },
    { "handle_set", (void*)Nelson::HandleGateway::handle_setBuiltin, 1, 1, CPP_BUILTIN_WITH_EVALUATOR },
    { "handle_invoke", (void*)Nelson::HandleGateway::handle_invokeBuiltin, 1, 1,
        CPP_BUILTIN_WITH_EVALUATOR },
    { "handle_disp", (void*)Nelson::HandleGateway::handle_dispBuiltin, 0, 1, CPP_BUILTIN_WITH_EVALUATOR },
    ...
    { "handle_fieldnames", (void*)Nelson::HandleGateway::handle_fieldnamesBuiltin, 1, 1,
        CPP_BUILTIN_WITH_EVALUATOR },
    { "handle_methods", (void*)Nelson::HandleGateway::handle_methodsBuiltin, 1, 1, CPP_BUILTIN },
    { "handle_ismethod", (void*)Nelson::HandleGateway::handle_ismethodBuiltin, 1, 2, CPP_BUILTIN },
    { "handle_isprop", (void*)Nelson::HandleGateway::handle_ispropBuiltin, 1, 2, CPP_BUILTIN },
    { "handle_properties", (void*)Nelson::HandleGateway::handle_propertiesBuiltin, 1, 1, CPP_BUILTIN },
};
//=============================================================================
