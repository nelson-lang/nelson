...
;==============================================================================
Source: {#RootPath}bin\{#BinPath}\icudt63.dll; DestDir: {app}\bin\{#BinPath}\;
Source: {#RootPath}bin\{#BinPath}\icuuc63.dll; DestDir: {app}\bin\{#BinPath}\;
Source: {#RootPath}bin\{#BinPath}\icuin63.dll; DestDir: {app}\bin\{#BinPath}\;
