...
;==============================================================================
Source: {#RootPath}bin\{#BinPath}\icudt64.dll; DestDir: {app}\bin\{#BinPath}\;
Source: {#RootPath}bin\{#BinPath}\icuuc64.dll; DestDir: {app}\bin\{#BinPath}\;
Source: {#RootPath}bin\{#BinPath}\icuin64.dll; DestDir: {app}\bin\{#BinPath}\;
