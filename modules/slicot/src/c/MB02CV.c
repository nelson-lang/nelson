    ...
    *info = 0;
    ...
    if (lrdef) {
        ...
        for (i__ = 1; i__ <= i__1; ++i__) {
            ...
            d__1 = -s / c__;
            daxpy_(n, &d__1, &g[g_dim1 + 1], &c__1, &f1[i__ * f1_dim1 + 1], &c__1);
            dscal_(n, &c__, &g[g_dim1 + 1], &c__1);
            d__1 = -s;
            daxpy_(n, &d__1, &f1[i__ * f1_dim1 + 1], &c__1, &g[g_dim1 + 1], &c__1);
            /* L10: */
        }
        len = *q;
        pos = 1;
        ...
        if (nbl > 0) {
            ...
            for (i__ = 1; i__1 < 0 ? i__ >= i__2 : i__ <= i__2; i__ += i__1) {
                ...
                for (j = i__; j <= i__3; ++j) {
                    ...
                    d__1 = -s / c__;
                    daxpy_(&len, &d__1, &g[g_offset], &c__1, &f1[j * f1_dim1 + 1], &c__1);
