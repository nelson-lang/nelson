...
EXPORTSYMBOL /* Subroutine */ int tf01od_(nh1, nh2, nr, nc, h__, ldh, t, ldt, info) integer *nh1,
    *nh2, *nr, *nc;
doublereal* h__;
integer* ldh;
doublereal* t;
integer *ldt, *info;
{
    ...
    *info = 0;
    ...
    for (it = 1; i__2 < 0 ? it >= i__1 : it <= i__1; it += i__2) {
        dlacpy_("Full", nh1, nh2, &h__[ih * h_dim1 + 1], ldh, &t[it + t_dim1], ldt, 4L);
        ih += *nh2;
        /* L10: */
    }
