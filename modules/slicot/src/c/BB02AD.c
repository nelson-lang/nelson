...
EXPORTSYMBOL /* Subroutine */ int bb02ad_(def, nr, dpar, ipar, bpar, chpar, vec, n, m, p, a, lda, b,
    ldb, c__, ldc, q, ldq, r__, ldr, s, lds, x, ldx, dwork, ldwork, info, def_len,
    chpar_len) char* def;
integer* nr;
doublereal* dpar;
integer* ipar;
...
ftnlen chpar_len;
{
    ...
    static integer ndef[52] /* was [4][13] */ = { 2, 2, 0, 100, 2, 2, 0, 0, 2, 2, 0, 0, 3, 3, 0, 0,
        4, 4, 0, 0, 4, 0, 0, 0, 4, 0, 0, 0, 5, 0, 0, 0, 6, 0, 0, 0, 9, 0, 0, 0, 11, 0, 0, 0, 13, 0,
        0, 0, 26 };
    static integer mdef[26] /* was [2][13] */ = { 1, 1, 2, 2, 1, 1, 2, 3, 2, 1, 2, 0, 4, 0, 2, 0, 2,
        0, 3, 0, 2, 0, 2, 0, 6 };
    static integer pdef[26] /* was [2][13] */ = { 1, 2, 2, 2, 2, 2, 3, 3, 4, 1, 4, 0, 4, 0, 5, 0, 2,
        0, 2, 0, 4, 0, 4, 0, 12 };
    static struct
    {
        char e_1[510];
        ...
        { 'V', 'a', 'n', ' ', 'D', 'o', 'o', 'r', 'e', 'n', ' ', '1', '9', '8', '1', ',', ' ', 'E',
            'x', '.', ' ', 'I', 'I', ':', ' ', 's', 'i', 'n', 'g', 'u', 'l', 'a', 'r', ' ', 'R',
            ' ', 'm', 'a', 't', 'r', 'i', 'x', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ...
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'L',
            'a', 'u', 'b', ' ', '1', '9', '7', '9', ',', ' ', 'E', 'x', '.', ' ', '2', ':', ' ',
            'u', 'n', 'c', 'o', 'n', 't', 'r', 'o', 'l', 'l', 'a', 'b', 'l', 'e', '-', 'u', 'n',
            'o', 'b', 's', 'e', 'r', 'v', 'a', 'b', 'l', 'e', ' ', 'd', 'a', 't', 'a', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
        ...
        { 'P', 'a', 'p', 'p', 'a', 's', ' ', 'e', 't', ' ', 'a', 'l', '.', ' ', '1', '9', '8', '0',
            ...
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'I',
            'o', 'n', 'e', 's', 'c', 'u', '/', 'W', 'e', 'i', 's', 's', ' ', '1', '9', '9', '2',
            ' ', ':', ' ', 's', 'i', 'n', 'g', 'u', 'l', 'a', 'r', ' ', 'R', ' ', 'm', 'a', 't',
            'r', 'i', 'x', ',', ' ', 'n', 'o', 'n', 'z', 'e', 'r', 'o', ' ', 'S', ' ', 'm', 'a',
            't', 'r', 'i', 'x', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ...
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'L',
            'a', 'u', 'b', ' ', '1', '9', '7', '9', ',', ' ', 'E', 'x', '.', ' ', '3', ':', ' ',
            'i', 'n', 'c', 'r', 'e', 'a', 's', 'i', 'n', 'g', 'l', 'y', ' ', 'i', 'l', 'l', '-',
            'c', 'o', 'n', 'd', 'i', 't', 'i', 'o', 'n', 'e', 'd', ' ', 'R', '-', 'm', 'a', 't',
            'r', 'i', 'x', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ...
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ' },
        { 0 },
        { 'J', 'o', 'n', 'c', 'k', 'h', 'e', 'e', 'r', 'e', ' ', '1', '9', '8', '1', ':', ' ', '(',
            'A', ',', 'B', ')', ' ', 'c', 'o', 'n', 't', 'r', 'o', 'l', 'l', 'a', 'b', 'l', 'e',
            ',', ' ', 'n', 'o', ' ', 's', 'o', 'l', 'u', 't', 'i', 'o', 'n', ' ', 'X', ' ', '<',
            '=', ' ', '0', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ...
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'i',
            'n', 'c', 'r', 'e', 'a', 's', 'i', 'n', 'g', 'l', 'y', ' ', 'b', 'a', 'd', ' ', 's',
            'c', 'a', 'l', 'e', 'd', ' ', 's', 'y', 's', 't', 'e', 'm', ' ', 'a', 's', ' ', 'e',
            'p', 's', ' ', '-', '>', ' ', 'o', 'o', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ...
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ' },
        { 0 },
        { 'S', 'u', 'n', ' ', '1', '9', '9', '8', ':', ' ', 'R', ' ', 's', 'i', 'n', 'g', 'u', 'l',
            'a', 'r', ',', ' ', 'Q', ' ', 'n', 'o', 'n', '-', 'd', 'e', 'f', 'i', 'n', 'i', 't',
            'e', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ...
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'P',
            'e', 't', 'k', 'o', 'v', ' ', 'e', 't', '.', ' ', 'a', 'l', '.', ' ', '1', '9', '8',
            '9', ' ', ':', ' ', 'i', 'n', 'c', 'r', 'e', 'a', 's', 'i', 'n', 'g', 'l', 'y', ' ',
            'b', 'a', 'd', ' ', 's', 'c', 'a', 'l', 'i', 'n', 'g', ' ', 'a', 's', ' ', 'e', 'p',
            's', ' ', '-', '>', ' ', 'o', 'o', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ...
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ' },
        { 0 },
        { 'A', 'c', 'k', 'e', 'r', 's', 'o', 'n', '/', 'F', 'u', ' ', '1', '9', '7', '0', ' ', ':',
            ' ', 's', 'a', 't', 'e', 'l', 'l', 'i', 't', 'e', ' ', 'c', 'o', 'n', 't', 'r', 'o',
            'l', ' ', 'p', 'r', 'o', 'b', 'l', 'e', 'm', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ...
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'P',
            'a', 'p', 'p', 'a', 's', ' ', 'e', 't', ' ', 'a', 'l', '.', ' ', '1', '9', '8', '0',
            ':', ' ', 'p', 'r', 'o', 'c', 'e', 's', 's', ' ', 'c', 'o', 'n', 't', 'r', 'o', 'l',
            ' ', 'o', 'f', ' ', 'p', 'a', 'p', 'e', 'r', ' ', 'm', 'a', 'c', 'h', 'i', 'n', 'e',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ...
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ' },
        { 0 },
        { 'L', 'i', 't', 'k', 'o', 'u', 'h', 'i', ' ', '1', '9', '8', '3', ' ', ':', ' ', 's', 'y',
            's', 't', 'e', 'm', ' ', 'w', 'i', 't', 'h', ' ', 's', 'l', 'o', 'w', ' ', 'a', 'n',
            'd', ' ', 'f', 'a', 's', 't', ' ', 'm', 'o', 'd', 'e', 's', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
        ...
        { 'L', 'u', '/', 'L', 'i', 'n', ' ', '1', '9', '9', '3', ',', ' ', 'E', 'x', '.', ' ', '4',
            ...
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ' },
        { 0 },
        { 'G', 'a', 'j', 'i', 'c', '/', 'S', 'h', 'e', 'n', ' ', '1', '9', '9', '3', ',', ' ', 'S',
            'e', 'c', 't', 'i', 'o', 'n', ' ', '2', '.', '7', '.', '4', ':', ' ', 'c', 'h', 'e',
            'm', 'i', 'c', 'a', 'l', ' ', 'p', 'l', 'a', 'n', 't', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ...
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ' },
        { 0 },
        { 'D', 'a', 'v', 'i', 's', 'o', 'n', '/', 'W', 'a', 'n', 'g', ' ', '1', '9', '7', '4', ':',
            ' ', 'n', 'o', 'n', 'z', 'e', 'r', 'o', ' ', 'S', ' ', 'm', 'a', 't', 'r', 'i', 'x',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
        ...
        { 'P', 'a', 't', 'n', 'a', 'i', 'k', ' ', 'e', 't', ' ', 'a', 'l', '.', ' ', '1', '9', '8',
            ...
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ' },
        { 0 },
        { 'S', 'i', 'm', 'a', ' ', '1', '9', '9', '6', ',', ' ', 'S', 'e', 'c', '.', ' ', '1', '.',
            '2', '.', '2', ':', ' ', 'p', 'a', 'p', 'e', 'r', ' ', 'm', 'a', 'c', 'h', 'i', 'n',
            'e', ' ', 'm', 'o', 'd', 'e', 'l', ' ', 'e', 'r', 'r', 'o', 'r', ' ', 'i', 'n', 't',
            'e', 'g', 'r', 'a', 't', 'o', 'r', 's', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ...
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ' },
        { 0 },
        { 'S', 'i', 'm', 'a', ' ', '1', '9', '9', '6', ',', ' ', 'E', 'x', '.', ' ', '2', '.', '6',
            ':', ' ', 'p', 'a', 'p', 'e', 'r', ' ', 'm', 'a', 'c', 'h', 'i', 'n', 'e', ' ', 'm',
            'o', 'd', 'e', 'l', ' ', 'w', 'i', 't', 'h', ' ', 'w', 'i', 't', 'h', ' ', 'd', 'i',
            's', 't', 'u', 'r', 'b', 'a', 'n', 'c', 'e', 's', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ...
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ' },
        { 0 },
        { 'P', 'o', 'w', 'e', 'r', ' ', 'p', 'l', 'a', 'n', 't', ' ', 'm', 'o', 'd', 'e', 'l', ',',
            ' ', 'K', 'a', 't', 'a', 'y', 'a', 'm', 'a', ' ', 'e', 't', ' ', 'a', 'l', '.', ',',
            ' ', '1', '9', '8', '5', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
            ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
...
#define notes ((char*)&equiv_26)
    ...
    integer a_dim1, a_offset, b_dim1, b_offset, c_dim1, c_offset, s_dim1, s_offset, x_dim1,
        x_offset, i__1, i__2;
    ...
    *info = 0;
    ...
    if (nr[1] >= 2 && !(lsame_(def, "D", 1L, 1L) || lsame_(def, "N", 1L, 1L))) {
        ...
        *info = -24;
    } else if (nr[1] == 1 && (nr[2] == 1 || nr[2] == 3 || nr[2] == 4)
        || nr[1] == 2 && (nr[2] == 1 || nr[2] >= 3) || nr[1] == 4) {
    ...
    if (nr[1] == 1) {
        ...
        if (nr[2] == 1) {
            ...
            /*     .. and compute A <- C' A C */
            dsymm_("L", "L", &ipar[1], &ipar[1], &c_b34, &c__[c_offset], ldc, &a[a_offset], lda,
                &c_b7, &dwork[1], &ipar[1], 1L, 1L);
            dsymm_("R", "L", &ipar[1], &ipar[1], &c_b34, &c__[c_offset], ldc, &dwork[1], &ipar[1],
                &c_b7, &a[a_offset], lda, 1L, 1L);
            q[1] = dpar[1];
            q[4] = dpar[1];
            q[6] = dpar[1];
            x[x_dim1 + 1] = dpar[1];
            ...
            dsymm_("L", "L", &ipar[1], &ipar[1], &c_b34, &c__[c_offset], ldc, &x[x_offset], ldx,
                &c_b7, &dwork[1], &ipar[1], 1L, 1L);
            dsymm_("R", "L", &ipar[1], &ipar[1], &c_b34, &c__[c_offset], ldc, &dwork[1], &ipar[1],
                &c_b7, &x[x_offset], ldx, 1L, 1L);
        ...
        if (*(unsigned char*)&ident[3] == '0') {
            ...
            if (*info == 0) {
                ...
                if (*(unsigned char*)ident == '0') {
                    ...
                    i__1 = ipar[1];
                    for (i__ = 1; i__ <= i__1; ++i__) {
                        dspmv_("L", &ipar[2], &c_b34, &r__[1], &b[i__ + b_dim1], ldb, &c_b7,
                            &dwork[(i__ - 1) * ipar[1] + 1], &c__1, 1L);
                        /* L100: */
                    }
                    dgemv_("T", &ipar[2], &ipar[1], &c_b34, &dwork[1], &ipar[1], &b[b_dim1 + 1],
                        ldb, &c_b7, &r__[1], &c__1, 1L);
                    isymm = ipar[1] + 1;
                    i__1 = ipar[1];
                    for (i__ = 2; i__ <= i__1; ++i__) {
                        dgemv_("T", &ipar[2], &ipar[1], &c_b34, &dwork[1], &ipar[1],
                            &b[i__ + b_dim1], ldb, &c_b7, &b[b_dim1 + 1], ldb, 1L);
                        i__2 = ipar[1] - i__ + 1;
            ...
            if (*(unsigned char*)ident == '0') {
                ...
                if (ipar[2] == 1) {
                    ...
                    dsyrk_("L", "N", &ipar[1], &ipar[2], &c_b34, &b[b_offset], ldb, &c_b7,
    ...
    if (bpar[1]) {
        ...
        if (*(unsigned char*)&ident[2] == '0') {
            if (*(unsigned char*)&ident[1] == '0') {
                ...
                i__1 = ipar[1];
                for (i__ = 1; i__ <= i__1; ++i__) {
                    dspmv_("L", &ipar[3], &c_b34, &q[1], &c__[i__ * c_dim1 + 1], &c__1, &c_b7,
                        &dwork[(i__ - 1) * ipar[1] + 1], &c__1, 1L);
                    /* L140: */
                }
                ...
                for (i__ = 2; i__ <= i__1; ++i__) {
                    dgemv_("T", &ipar[3], &ipar[1], &c_b34, &dwork[1], &ipar[1],
                        &c__[i__ * c_dim1 + 1], &c__1, &c_b7, &q[1], &c__1, 1L);
                    i__2 = ipar[1] - i__ + 1;
                    dcopy_(&i__2, &q[i__], &c__1, &q[isymm], &c__1);
                    isymm += ipar[1] - i__ + 1;
                    /* L150: */
                }
                dgemv_("T", &ipar[3], &ipar[1], &c_b34, &dwork[1], &ipar[1], &c__[c_dim1 + 1],
                    &c__1, &c_b7, &q[1], &c__1, 1L);
            }
        } else {
            /*       .. Q = identity .. */
            if (*(unsigned char*)&ident[1] == '0') {
                ...
                if (ipar[3] == 1) {
                    ...
                    dsyrk_("L", "T", &ipar[1], &ipar[3], &c_b34, &c__[c_offset], ldc, &c_b7,
                        &dwork[1], &ipar[1], 1L, 1L);
    ...
    vec[8] = TRUE_;
    vec[9] = bpar[7];
    if (nr[1] == 1 && (nr[2] == 1 || nr[2] == 3 || nr[2] == 4)
        || nr[1] == 2 && (nr[2] == 1 || nr[2] >= 3) || nr[1] == 4) {
        vec[10] = TRUE_;
    }
