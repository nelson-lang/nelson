...
EXPORTSYMBOL /* Subroutine */ int nf01be_(iflag, nsmp, n, ipar, lipar, z__, ldz, y, ldy, x, nfevl,
    e, j, ldj, dwork, ldwork, info) integer *iflag,
    *nsmp, *n, *ipar, *lipar;
doublereal* z__;
integer* ldz;
doublereal* y;
...
integer *ldwork, *info;
{
    ...
    *info = 0;
    if (*iflag == 1) {
        ...
        /*        Workspace: need:    0. */
        i__1 = *lipar - 2;
        nf01by_("N", nsmp, &ipar[2], &c__1, &ipar[3], &i__1, &x[1], n, &z__[z_offset], ldz, &e[1],
