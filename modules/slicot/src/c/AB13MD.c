...
/* Subroutine */ int ab13md_(fact, n, z__, ldz, m, nblock, itype, x, bound, d__, g, iwork, dwork, ldwork, zwork, lzwork, info, fact_len)
char *fact;
integer *n;
doublecomplex *z__;
...
ftnlen fact_len;
{
    ...
    extern /* Subroutine */ int zgees_(), dcopy_(), zgemm_();
    ...
    extern /* Subroutine */ int dsysv_(), zcopy_(), zgemv_();
    ...
    extern /* Subroutine */ int dsycon_(), zgetrf_();
    static doublereal colsum;
    extern /* Subroutine */ int zgesvd_(), zgetri_(), zlacpy_();
