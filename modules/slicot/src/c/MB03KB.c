...
/* Subroutine */ EXPORTSYMBOL int mb03kb_(compq, whichq, ws, k, nc, kschur, j1, n1, n2, n, ni, s, t, ldt, ixt, q, ldq, ixq, tol, iwork, dwork, ldwork, info, compq_len)
char *compq;
integer *whichq;
logical *ws;
...
ftnlen compq_len;
{
    ...
    extern /* Subroutine */ EXPORTSYMBOL int mb03kc_(), mb03ke_();
    static integer v, w;
    ...
    extern /* Subroutine */ EXPORTSYMBOL int dlarfg_(), dlascl_();
