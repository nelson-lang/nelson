...
/* Subroutine */ EXPORTSYMBOL int sb02pd_(job, trana, uplo, n, a, lda, g, ldg, q, ldq, x, ldx, rcond, ferr, wr, wi, iwork, dwork, ldwork, info, job_len, trana_len, uplo_len)
char *job, *trana, *uplo;
integer *n;
doublereal *a;
integer *lda;
...
ftnlen uplo_len;
{
    ...
    integer a_dim1, a_offset, g_dim1, g_offset, q_dim1, q_offset, x_dim1, x_offset, i__1, i__2;
    /* Builtin functions */
    double sqrt();
    /* Local variables */
    static integer iscl, sdim, itau, iter;
    ...
    extern /* Subroutine */ EXPORTSYMBOL int dgees_(), sb02qd_();
    ...
    static doublereal gnorm2;
    static integer ib, ic;
    static doublereal qnorm2;
    static integer ij, ji;
    extern doublereal dlamch_();
    static integer ir, it, iu;
    ...
    extern /* Subroutine */ EXPORTSYMBOL int dgesvx_();
    static logical notrna;
    static integer ij1, ij2;
    ...
    *info = 0;
    ...
    for (iter = 1; iter <= 50; ++iter)
    {
        ...
        hnorm = dlansy_("F", uplo, &n2, &dwork[ini + 1], &n2, &dwork[1], 1L, 1L);
        ...
        else
        {
            ...
            for (j = 1; j <= i__1; ++j)
            {
                ...
                i__2 = j - 1;
                dswap_(&i__2, &dwork[(*n + 1) * n2 + j], &n2, &dwork[(*n + j) * n2 + 1], &c__1);
                /* L180: */
            }
        }
