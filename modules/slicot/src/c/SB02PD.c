...
/* Subroutine */ int sb02pd_(job, trana, uplo, n, a, lda, g, ldg, q, ldq, x, ldx, rcond, ferr, wr, wi, iwork, dwork, ldwork, info, job_len, trana_len, uplo_len)
char *job, *trana, *uplo;
integer *n;
doublereal *a;
integer *lda;
...
ftnlen uplo_len;
{
    ...
    extern /* Subroutine */ int dgees_(), sb02qd_();
