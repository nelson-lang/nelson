...
/* Subroutine */ int ab13dd_(dico, jobe, equil, jobd, n, m, p, fpeak, a, lda, e, lde, b, ldb, c__, ldc, d__, ldd, gpeak, tol, iwork, dwork, ldwork, cwork, lcwork, info, dico_len, jobe_len, equil_len, jobd_len)
...
ftnlen jobd_len;
{
    ...
    extern /* Subroutine */ int tg01ad_();
    static doublereal gamma;
    extern doublereal ab13dx_();
    extern /* Subroutine */ int tb01id_(), tg01bd_();
    static doublereal omega;
    extern /* Subroutine */ int dgemm_(), mb01sd_(), dggev_(), mb03xd_();
    ...
    extern /* Subroutine */ int dgebal_(), dggbal_();
    ...
    extern /* Subroutine */ int dgesvd_();
    static doublereal safmin;
    extern /* Subroutine */ int dlacpy_();
    static doublereal safmax, maxred, bignum;
    extern /* Subroutine */ int dhgeqz_(), dlascl_(), xerbla_(), dhseqr_(), dlasrt_();
    static integer maxcwk;
    static logical lequil;
    extern /* Subroutine */ int dormhr_(), dtrcon_(), dorgqr_();
