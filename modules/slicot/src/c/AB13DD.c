...
/* Subroutine */ EXPORTSYMBOL int ab13dd_(dico, jobe, equil, jobd, n, m, p, fpeak, a, lda, e, lde, b, ldb, c__, ldc, d__, ldd, gpeak, tol, iwork, dwork, ldwork, cwork, lcwork, info, dico_len, jobe_len, equil_len, jobd_len)
...
ftnlen jobd_len;
{
    ...
    extern /* Subroutine */ EXPORTSYMBOL int tg01ad_();
    static doublereal gamma;
    extern doublereal ab13dx_();
    extern /* Subroutine */ EXPORTSYMBOL int tb01id_(), tg01bd_();
    static doublereal omega;
    extern /* Subroutine */ EXPORTSYMBOL int dgemm_(), mb01sd_(), dggev_(), mb03xd_();
    ...
    extern /* Subroutine */ EXPORTSYMBOL int dgebal_(), dggbal_();
    static integer ih, ii, im;
    extern doublereal dlamch_();
    static doublereal pi;
    extern doublereal dlange_();
    static integer ir, is, nn, iu, iv, pm;
    static doublereal fpeaki, gammal;
    static integer lw;
    static doublereal tm, gammas;
    extern /* Subroutine */ EXPORTSYMBOL int dgehrd_();
    static logical ilascl;
    static integer ny;
    static doublereal fpeaks;
    extern /* Subroutine */ EXPORTSYMBOL int dgeqrf_();
    static logical ilescl;
    extern /* Subroutine */ EXPORTSYMBOL int dgesvd_();
    static doublereal safmin;
    extern /* Subroutine */ EXPORTSYMBOL int dlacpy_();
    static doublereal safmax, maxred, bignum;
    extern /* Subroutine */ EXPORTSYMBOL int dhgeqz_(), dlascl_(), xerbla_(), dhseqr_(), dlasrt_();
    static integer maxcwk;
    static logical lequil;
    extern /* Subroutine */ EXPORTSYMBOL int dormhr_(), dtrcon_(), dorgqr_();
    static logical usepen;
    static integer mincwr;
    static doublereal anrmto, enrmto;
    static integer minwrk, maxwrk;
    static doublereal smlnum;
    static integer ih12, ihi, ipa, iar, ias, ibs, ibt, ipe, ibv, icu, ies, ilo, isb, isc, isl, nei;
    static doublereal eps, rat;
    static integer nws, n2pm;
    /*     SLICOT RELEASE 5.0. */
    ...
    *info = 0;
    ...
    dlacpy_("Full", n, m, &b[b_offset], ldb, &dwork[ib], n, 4L);
    ...
    if (fulle)
    {
        ...
        iwrk = ibt + *n;
        dlacpy_("Full", n, n, &e[e_offset], lde, &dwork[ie], n, 4L);
...
L120:
    ...
    else
    {
        ...
        dlacpy_("Full", n, m, &dwork[ibv], n, &dwork[isb], n, 4L);
        mb01sd_("Column", n, m, &dwork[isb], n, &dwork[1], &dwork[isl], 6L);
