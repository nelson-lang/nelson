...
EXPORTSYMBOL /* Subroutine */ int ib01pd_(meth, job, jobcv, nobr, n, m, l, nsmpl, r__, ldr, a, lda, c__, ldc, b, ldb, d__, ldd, q, ldq, ry, ldry, s, lds, o, ldo, tol, iwork, dwork, ldwork, iwarn, info, meth_len, job_len, jobcv_len)
char *meth, *job, *jobcv;
...
ftnlen jobcv_len;
{
    ...
    static integer i__;
    extern /* Subroutine */ int mb03od_(), dgemm_(), mb02ud_();
    static integer rank11;
    extern logical lsame_();
    extern /* Subroutine */ int ib01px_(), ib01py_();
    static integer rankm;
    extern /* Subroutine */ int mb02qy_();
    ...
    extern /* Subroutine */ int dsyrk_(), dtrsm_();
    static integer n2;
    ...
    extern /* Subroutine */ int dtrcon_(), dormqr_();
