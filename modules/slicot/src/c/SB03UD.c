...
/* Subroutine */ int sb03ud_(job, fact, trana, uplo, lyapun, n, scale, a, lda, t, ldt, u, ldu, c__, ldc, x, ldx, sepd, rcond, ferr, wr, wi, iwork, dwork, ldwork, info, job_len, fact_len, trana_len, uplo_len, lyapun_len)
