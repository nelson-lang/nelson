...
/* Subroutine */ EXPORTSYMBOL int tg01dd_(compz, l, n, p, a, lda, e, lde, c__, ldc, z__, ldz, dwork, ldwork, info, compz_len)
char *compz;
integer *l, *n, *p;
doublereal *a;
integer *lda;
...
ftnlen compz_len;
{
    ...
    static integer ln;
    extern /* Subroutine */ EXPORTSYMBOL int dgerqf_(), dlaset_(), xerbla_();
