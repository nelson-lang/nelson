...
EXPORTSYMBOL /* Subroutine */ int ag08by_(first, n, m, p, svlmax, abcd, ldabcd, e, lde, nr, pr, ninfz, dinfz, nkronl, infz, kronl, tol, iwork, dwork, ldwork, info)
logical *first;
integer *n, *m, *p;
...
integer *ldwork, *info;
{
    ...
    extern /* Subroutine */ int dlaset_(), xerbla_(), dlapmt_(), dlatzm_(), dormqr_();
