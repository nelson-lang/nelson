...
/* Subroutine */ EXPORTSYMBOL int sb10pd_(n, m, np, ncon, nmeas, a, lda, b, ldb, c__, ldc, d__, ldd, tu, ldtu, ty, ldty, rcond, tol, dwork, ldwork, info)
...
integer *ldwork, *info;
{
    ...
    *info = 0;
    ...
    i__1 = *n + np1;
    dlacpy_("Full", n, n, &a[a_offset], lda, &dwork[iext], &i__1, 4L);
    i__1 = *n + np1;
