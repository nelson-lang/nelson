...
EXPORTSYMBOL /* Subroutine */ int ab09bx_(dico, job, ordsel, n, m, p, nr, a, lda, b, ldb, c__, ldc, d__, ldd, hsv, t, ldt, ti, ldti, tol1, tol2, iwork, dwork, ldwork, iwarn, info, dico_len, job_len, ordsel_len)
...
ftnlen ordsel_len;
{
    ...
    extern /* Subroutine */ int ab09dd_(), ma02ad_(), ma02dd_();
    static integer j, k;
    ...
    extern /* Subroutine */ int sb03ou_();
    static integer nminr;
    extern /* Subroutine */ int dtrmm_(), dtpmv_(), dtrmv_();
    static integer ij;
