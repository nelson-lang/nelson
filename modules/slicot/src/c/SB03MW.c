...
EXPORTSYMBOL /* Subroutine */ int sb03mw_(ltran, lupper, t, ldt, b, ldb, scale, x, ldx, xnorm, info)
...
integer *info;
{
    ...
    /* Local variables */
    static doublereal btmp[3], temp, smin;
    ...
    *info = 0;
    ...
    /* Computing MAX */
    /* Computing MAX */
    d__6 = (d__1 = t[t_dim1 + 1], abs(d__1)), d__7 = (d__2 = t[(t_dim1 << 1) + 1], abs(d__2)), d__6 = max(d__6,d__7), d__7 = (d__3 = t[t_dim1 + 2], abs(d__3)), d__6 = max(d__6,d__7), d__7 = (d__4 = t[(t_dim1 << 1) + 2], abs(d__4));
