...
/* Subroutine */ EXPORTSYMBOL int sg03bw_(trans, m, n, a, lda, c__, ldc, e, lde, d__, ldd, x, ldx, scale, info, trans_len)
char *trans;
integer *m, *n;
doublereal *a;
integer *lda;
...
ftnlen trans_len;
{
    ...
    extern /* Subroutine */ EXPORTSYMBOL int mb02uu_(), mb02uv_();
