...
/* Subroutine */ int fb01vd_(n, m, l, p, ldp, a, lda, b, ldb, c__, ldc, q, ldq, r__, ldr, k, ldk, tol, iwork, dwork, ldwork, info)
integer *n, *m, *l;
doublereal *p;
integer *ldp;
doublereal *a;
...
integer *ldwork, *info;
{
    ...
    extern /* Subroutine */ int dcopy_(), dtrmm_(), daxpy_(), dtrsm_();
    ...
    extern /* Subroutine */ int dlaset_(), xerbla_(), dpocon_();
