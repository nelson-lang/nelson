...
/* Subroutine */ int sb02rd_(job, dico, hinv, trana, uplo, scal, sort, fact, lyapun, n, a, lda, t, ldt, v, ldv, g, ldg, q, ldq, x, ldx, sep, rcond, ferr, wr, wi, s, lds, iwork, dwork, ldwork, bwork, info, job_len, dico_len, hinv_len, trana_len, uplo_len, scal_len, sort_len, fact_len, lyapun_len)
...
ftnlen lyapun_len;
{
    ...
    static integer i__;
    extern /* Subroutine */ int mb02pd_(), dgees_(), dscal_(), mb01sd_(), sb02qd_(), sb02sd_();
    static logical lscal;
    extern logical lsame_();
    static char equed[1];
    static logical discr;
    extern logical sb02mr_(), sb02ms_(), sb02mv_(), sb02mw_();
    extern /* Subroutine */ int dgesv_(), mb01ru_(), sb02ru_(), dcopy_(), dswap_();
    static logical lhinv;
    static doublereal gnorm;
    extern /* Subroutine */ int daxpy_(), dsymm_();
