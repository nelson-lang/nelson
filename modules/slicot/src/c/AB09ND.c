...
/* Subroutine */ int ab09nd_(dico, job, equil, ordsel, n, m, p, nr, alpha, a, lda, b, ldb, c__, ldc, d__, ldd, ns, hsv, tol1, tol2, iwork, dwork, ldwork, iwarn, info, dico_len, job_len, equil_len, ordsel_len)
