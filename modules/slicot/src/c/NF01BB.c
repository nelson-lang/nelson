...
/* Subroutine */ EXPORTSYMBOL int nf01bb_(iflag, nfun, lx, ipar, lipar, u, ldu, y, ldy, x, nfevl, e, j, ldj, jte, dwork, ldwork, info)
...
integer *ldwork, *info;
{
    ...
    *info = 0;
    ...
    else if (*iflag == 2)
    {
        ...
        /*                   prefer:  larger. */
        i__1 = *lipar - 2;
        nf01bd_("C", &nsmp, &m, &l, &ipar[6], &i__1, &x[1], lx, &u[u_offset], ldu, &e[1], &j[j_offset], ldj, &jte[1], &dwork[1], ldwork, info, 1L);
