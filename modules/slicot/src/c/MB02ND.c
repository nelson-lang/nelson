...
/* Subroutine */ EXPORTSYMBOL int mb02nd_(m, n, l, rank, theta, c__, ldc, x, ldx, q, inul, tol, reltol, iwork, dwork, ldwork, bwork, iwarn, info)
integer *m, *n, *l, *rank;
...
integer *iwarn, *info;
{
    ...
    static integer i__, j, k, p, ifail;
    extern /* Subroutine */ EXPORTSYMBOL int dlarf_(), mb04yd_();
    ...
    static integer i1, j1, jwork;
    static doublereal dummy[1];
    static integer n1, jf, kf, mc, ij;
    ...
    extern /* Subroutine */ EXPORTSYMBOL int dgebrd_(), dlarfg_();
    static integer jv;
    static doublereal sn;
    static integer lw;
    extern /* Subroutine */ EXPORTSYMBOL int dgeqrf_(), dgerqf_(), dlaset_(), dlartg_();
    extern integer ilaenv_();
    extern /* Subroutine */ EXPORTSYMBOL int xerbla_(), dlacpy_();
    extern doublereal dlantr_();
    extern /* Subroutine */ EXPORTSYMBOL int dormbr_(), dtrcon_();
