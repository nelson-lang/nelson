...
/* Subroutine */ int mb02nd_(m, n, l, rank, theta, c__, ldc, x, ldx, q, inul, tol, reltol, iwork, dwork, ldwork, bwork, iwarn, info)
integer *m, *n, *l, *rank;
...
integer *iwarn, *info;
{
    ...
    extern /* Subroutine */ int dlarf_(), mb04yd_();
    ...
    extern /* Subroutine */ int dgebrd_(), dlarfg_();
    static integer jv;
    static doublereal sn;
    static integer lw;
    extern /* Subroutine */ int dgeqrf_(), dgerqf_(), dlaset_(), dlartg_();
    extern integer ilaenv_();
    extern /* Subroutine */ int xerbla_(), dlacpy_();
    extern doublereal dlantr_();
    extern /* Subroutine */ int dormbr_(), dtrcon_();
