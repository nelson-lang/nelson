...
EXPORTSYMBOL /* Subroutine */ int sb03td_(job, fact, trana, uplo, lyapun, n, scale, a, lda, t, ldt, u, ldu, c__, ldc, x, ldx, sep, rcond, ferr, wr, wi, iwork, dwork, ldwork, info, job_len, fact_len, trana_len, uplo_len, lyapun_len)
...
ftnlen lyapun_len;
{
    ...
    *info = 0;
    ...
    if (jobs)
    {
        ...
        /*        Workspace:  2*N*N. */
        sb03qy_("Separation", trana, lyapun, n, &t[t_offset], ldt, &u[u_offset], ldu, &x[x_offset], ldx, sep, &thnorm, &iwork[1], &dwork[1], ldwork, info, 10L, 1L, 1L);
    }
    else if (! jobx)
    {
        ...
        sb03qd_(jobl, cfact, trana, uplo, lyapun, n, scale, &a[a_offset], lda, &t[t_offset], ldt, &u[u_offset], ldu, &c__[c_offset], ldc, &x[x_offset], ldx, sep, rcond, ferr, &iwork[1], &dwork[1], ldwork, info, 1L, 1L, 1L, 1L, 1L);
        /* Computing MAX */
