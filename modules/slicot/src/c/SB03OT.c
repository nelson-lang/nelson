            ...
            if (tbyt) {
                ...
                if (kount <= *n) {
                    ...
                    if (cont) {
                        ...
                        /*                    1st column: */
                        d__1 = -a[0];
                        daxpy_(&ksize, &d__1, &dwork[k2], &c__1, &dwork[1], &c__1);
                        d__1 = -a[2];
                        daxpy_(&ksize, &d__1, &dwork[k3], &c__1, &dwork[1], &c__1);
                        /*                    2nd column: */
                        d__1 = -a[3];
                ...
                if (kount <= *n) {
                    ...
                    dswap_(&ksize, &dwork[1], &c__1, &r__[k + (k + 1) * r_dim1], ldr);
            ...
            if (tbyt) {
                ...
                if (kount >= 1) {
                    ...
                    if (cont) {
                        ...
                        daxpy_(&ksize, &d__1, &s[(k + 1) * s_dim1 + 1], &c__1, &dwork[1], &c__1);
                        d__1 = -(r__[k + k * r_dim1] * b[1] + r__[k + (k + 1) * r_dim1] * b[3]);
                        daxpy_(&ksize, &d__1, &s[k * s_dim1 + 1], &c__1, &dwork[k1], &c__1);
