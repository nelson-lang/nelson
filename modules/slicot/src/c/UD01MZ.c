...
EXPORTSYMBOL /* Subroutine */ int ud01mz_(m, n, l, nout, a, lda, text, info, text_len) integer *m,
    *n, *l, *nout;
doublecomplex* a;
integer* lda;
char* text;
    ...
    for (j = 1; j <= i__1; ++j) {
        ...
        for (i__ = 1; i__ <= i__2; ++i__) {
            ...
            for (jj = j1; jj <= i__3; ++jj) {
                do_fio(&c__2, (char*)&a[i__ + jj * a_dim1], (ftnlen)sizeof(doublereal));
            }
            e_wsfe();
            /* L60: */
        }
