...
EXPORTSYMBOL /* Subroutine */ int ib01rd_(job, n, m, l, nsmp, a, lda, b, ldb, c__, ldc, d__, ldd, u, ldu, y, ldy, x0, tol, iwork, dwork, ldwork, iwarn, info, job_len)
char *job;
integer *n, *m, *l, *nsmp;
doublereal *a;
integer *lda;
...
ftnlen job_len;
{
    ...
    static integer j, k;
    extern /* Subroutine */ int mb04od_(), mb01td_();
    ...
    extern /* Subroutine */ int dlaset_(), xerbla_(), dgelss_(), dtrcon_();
