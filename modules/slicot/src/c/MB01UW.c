...
/* Subroutine */ EXPORTSYMBOL int mb01uw_(side, trans, m, n, alpha, h__, ldh, a, lda, dwork, ldwork, info, side_len, trans_len)
char *side, *trans;
integer *m, *n;
...
ftnlen trans_len;
{
    ...
    extern /* Subroutine */ EXPORTSYMBOL int dswap_(), dtrmm_(), daxpy_(), dtrmv_();
    static integer jw;
