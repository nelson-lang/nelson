...
/* Subroutine */ EXPORTSYMBOL int md03ad_(xinit, alg, stor, uplo, fcn, jpj, m, n, itmax, nprint, ipar, lipar, dpar1, ldpar1, dpar2, ldpar2, x, nfev, njev, tol, cgtol, dwork, ldwork, iwarn, info, xinit_len, alg_len, stor_len, uplo_len)
char *xinit, *alg, *stor, *uplo;
/* Subroutine */ EXPORTSYMBOL int (*fcn) (), (*jpj) ();
...
ftnlen uplo_len;
{
    ...
    integer dpar1_dim1, dpar1_offset, dpar2_dim1, dpar2_offset, i__1, i__2, i__3, i__4;
    ...
    static integer e, i__, iflag;
    extern /* Subroutine */ EXPORTSYMBOL int mb02wd_(), mb02xd_();
    ...
    static integer iw1, iw2, jw1, jw2, wrkopt, jac, ldj, jte;
    ...
    --ipar;
    dpar1_dim1 = *ldpar1;
    dpar1_offset = dpar1_dim1 + 1;
    dpar1 -= dpar1_offset;
    dpar2_dim1 = *ldpar2;
    dpar2_offset = dpar2_dim1 + 1;
    dpar2 -= dpar2_offset;
    --x;
    --dwork;
    /* Function Body */
    init = lsame_(xinit, "R", 1L, 1L);
    chol = lsame_(alg, "D", 1L, 1L);
