...
/* Subroutine */ int md03ad_(xinit, alg, stor, uplo, fcn, jpj, m, n, itmax, nprint, ipar, lipar, dpar1, ldpar1, dpar2, ldpar2, x, nfev, njev, tol, cgtol, dwork, ldwork, iwarn, info, xinit_len, alg_len, stor_len, uplo_len)
...
ftnlen uplo_len;
{
    ...
    extern /* Subroutine */ int mb02wd_(), mb02xd_();
