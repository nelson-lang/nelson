...
/* Subroutine */ EXPORTSYMBOL int sb01bd_(dico, n, m, np, alpha, a, lda, b, ldb, wr, wi, nfp, nap, nup, f, ldf, z__, ldz, tol, dwork, ldwork, iwarn, info, dico_len)
char *dico;
integer *n, *m, *np;
doublereal *alpha, *a;
integer *lda;
...
ftnlen dico_len;
{
    ...
    integer a_dim1, a_offset, b_dim1, b_offset, f_dim1, f_offset, z_dim1, z_offset, i__1, i__2;
    /* Local variables */
    static logical ceig;
    ...
    extern /* Subroutine */ EXPORTSYMBOL int mb03qd_(), dgees_();
    static doublereal x, y;
    extern /* Subroutine */ EXPORTSYMBOL int dgemm_(), sb01bx_(), sb01by_();
