...
/* Subroutine */ int sb01bd_(dico, n, m, np, alpha, a, lda, b, ldb, wr, wi, nfp, nap, nup, f, ldf, z__, ldz, tol, dwork, ldwork, iwarn, info, dico_len)
char *dico;
integer *n, *m, *np;
doublereal *alpha, *a;
integer *lda;
...
ftnlen dico_len;
{
    ...
    extern /* Subroutine */ int mb03qd_(), dgees_();
    static doublereal x, y;
    extern /* Subroutine */ int dgemm_(), sb01bx_(), sb01by_();
