...
/* Subroutine */ int mb04xd_(jobu, jobv, m, n, rank, theta, a, lda, u, ldu, v, ldv, q, inul, tol, reltol, dwork, ldwork, iwarn, info, jobu_len, jobv_len)
char *jobu, *jobv;
integer *m, *n, *rank;
doublereal *theta, *a;
integer *lda;
...
ftnlen jobv_len;
{
    ...
    extern /* Subroutine */ int mb04yd_();
    extern logical lsame_();
    extern /* Subroutine */ int dlasr_(), dcopy_();
    static integer itaup, itauq;
    extern /* Subroutine */ int mb04xy_();
