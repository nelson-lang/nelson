...
/* Subroutine */ EXPORTSYMBOL int mb04xd_(jobu, jobv, m, n, rank, theta, a, lda, u, ldu, v, ldv, q, inul, tol, reltol, dwork, ldwork, iwarn, info, jobu_len, jobv_len)
char *jobu, *jobv;
integer *m, *n, *rank;
doublereal *theta, *a;
integer *lda;
...
ftnlen jobv_len;
{
    ...
    extern /* Subroutine */ EXPORTSYMBOL int mb04yd_();
    extern logical lsame_();
    extern /* Subroutine */ EXPORTSYMBOL int dlasr_(), dcopy_();
    static integer itaup, itauq;
    extern /* Subroutine */ EXPORTSYMBOL int mb04xy_();
    static char jobuy[1], jobvy[1];
    static integer jwork;
    static logical wantu, wantv;
    static integer ma, ij;
    ...
    static integer ihoush, pp1, wrkopt;
    static logical all;
    static integer ldw, ldy;
    /*     SLICOT RELEASE 5.0. */
    ...
    *info = 0;
    ...
    ljobva = lsame_(jobv, "A", 1L, 1L);
    ljobvs = lsame_(jobv, "S", 1L, 1L);
    wantu = ljobua || ljobus;
    wantv = ljobva || ljobvs;
