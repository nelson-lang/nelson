...
EXPORTSYMBOL /* Subroutine */ int ab09hx_(dico, job, ordsel, n, m, p, nr, a, lda, b, ldb, c__, ldc, d__, ldd, hsv, t, ldt, ti, ldti, tol1, tol2, iwork, dwork, ldwork, bwork, iwarn, info, dico_len, job_len, ordsel_len)
...
ftnlen ordsel_len;
{
    ...
    extern /* Subroutine */ int ab09dd_(), ma02ad_(), ab04md_();
    static integer j, k;
    extern /* Subroutine */ int dscal_(), dgemm_(), mb03ud_(), ab09hy_();
    extern logical lsame_();
    extern /* Subroutine */ int dgemv_();
    static logical discr;
    static doublereal rcond;
    static integer nminr;
    extern /* Subroutine */ int dtrmm_(), dtrmv_();
    static integer ij;
    extern doublereal dlamch_();
    static doublereal scalec;
    static integer ku, kv, kw, lw, ns;
    static doublereal scaleo;
    extern /* Subroutine */ int dgeqrf_(), dgetrf_(), dlacpy_();
