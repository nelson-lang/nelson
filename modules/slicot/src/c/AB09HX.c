...
/* Subroutine */ int ab09hx_(dico, job, ordsel, n, m, p, nr, a, lda, b, ldb, c__, ldc, d__, ldd, hsv, t, ldt, ti, ldti, tol1, tol2, iwork, dwork, ldwork, bwork, iwarn, info, dico_len, job_len, ordsel_len)
