...
/* Subroutine */ int ab05pd_(over, n1, m, p, n2, alpha, a1, lda1, b1, ldb1, c1, ldc1, d1, ldd1, a2, lda2, b2, ldb2, c2, ldc2, d2, ldd2, n, a, lda, b, ldb, c__, ldc, d__, ldd, info, over_len)
char *over;
integer *n1, *m, *p, *n2;
doublereal *alpha, *a1;
integer *lda1;
