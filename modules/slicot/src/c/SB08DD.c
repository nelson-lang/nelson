...
/* Subroutine */ EXPORTSYMBOL int sb08dd_(dico, n, m, p, a, lda, b, ldb, c__, ldc, d__, ldd, nq, nr, cr, ldcr, dr, lddr, tol, dwork, ldwork, iwarn, info, dico_len)
char *dico;
integer *n, *m, *p;
doublereal *a;
integer *lda;
...
ftnlen dico_len;
{
    ...
    extern /* Subroutine */ EXPORTSYMBOL int sb01fy_();
