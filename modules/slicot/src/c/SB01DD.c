...
integer *ldwork, *info;
{
    ...
    static integer lp1, mp1, np1, mr1, nr1, kmr;
    /*     SLICOT RELEASE 5.0. */
    ...
    *count = 1;
    ...
    d__1 = dlange_("Frobenius", n, &nblkcr, &a[nc * a_dim1 + 1], lda, &dwork[1], 9L);
    svlmax = dlapy2_(&svlmax, &d__1);
    l = 1;
    mr = nblkcr;
    nr = *n - mr + 1;
    ...
    L70:
        ...
        if (wi[ia] == 0.) {
            ...
            *count = *count + mr - i__;
            ...
            i__1 = mr - i__ - 1;
            daxpy_(&i__1, &c_b24, &y[*count + 1], &c__2, &g[i__ + 1 + (l + i__ + 1) * g_dim1], ldg);
            *count += mr - i__ - 1 << 1;
            g[i__ + ia * g_dim1] -= wr[ia];
