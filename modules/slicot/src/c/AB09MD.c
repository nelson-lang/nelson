...
/* Subroutine */ EXPORTSYMBOL int ab09md_(dico, job, equil, ordsel, n, m, p, nr, alpha, a, lda, b, ldb, c__, ldc, ns, hsv, tol, iwork, dwork, ldwork, iwarn, info, dico_len, job_len, equil_len, ordsel_len)
...
ftnlen ordsel_len;
{
    ...
    /* Local variables */
    static integer ierr;
    extern /* Subroutine */ EXPORTSYMBOL int tb01id_(), ab09ax_(), tb01kd_();
    ...
    *ns = *n - nu;
    ...
    /*                prefer larger. */
    i__1 = *ldwork - kw + 1;
    ab09ax_(dico, job, ordsel, ns, m, p, &nra, &a[nu1 + nu1 * a_dim1], lda, &b[nu1 + b_dim1], ldb, &c__[nu1 * c_dim1 + 1], ldc, &hsv[1], &dwork[kt], n, &dwork[kti], n, tol, &iwork[1], &dwork[kw], &i__1, iwarn, &ierr, 1L, 1L, 1L);
