...
/* Subroutine */ EXPORTSYMBOL int tg01fd_(compq, compz, joba, l, n, m, p, a, lda, e, lde, b, ldb, c__, ldc, q, ldq, z__, ldz, ranke, rnka22, tol, iwork, dwork, ldwork, info, compq_len, compz_len, joba_len)
...
ftnlen joba_len;
{
    ...
    static integer wrkopt, la22, na22;
