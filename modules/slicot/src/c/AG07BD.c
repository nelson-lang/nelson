...
ftnlen jobe_len;
{
    ...
    *info = 0;
    ...
    /*     Form Ai. */
    dlacpy_("Full", n, n, &a[a_offset], lda, &ai[ai_offset], ldai, 4L);
    dlacpy_("Full", m, n, &c__[c_offset], ldc, &ai[*n + 1 + ai_dim1], ldai, 4L);
    ...
    i__1 = *n + *m;
    dlaset_("Full", &i__1, m, &c_b10, &c_b10, &ei[(*n + 1) * ei_dim1 + 1], ldei, 4L);
    /*     Form Bi. */
    dlaset_("Full", n, m, &c_b10, &c_b10, &bi[bi_offset], ldbi, 4L);
    dlaset_("Full", m, m, &c_b10, &c_b24, &bi[*n + 1 + bi_dim1], ldbi, 4L);
    /*     Form Ci. */
    dlaset_("Full", m, n, &c_b10, &c_b10, &ci[ci_offset], ldci, 4L);
    dlaset_("Full", m, m, &c_b10, &c_b11, &ci[(*n + 1) * ci_dim1 + 1], ldci, 4L);
    /*     Set Di. */
    dlaset_("Full", m, m, &c_b10, &c_b10, &di[di_offset], lddi, 4L);
    return 0;
    /* *** Last line of AG07BD *** */
} /* ag07bd_ */
