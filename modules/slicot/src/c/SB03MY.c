...
EXPORTSYMBOL /* Subroutine */ int sb03my_(
    trana, n, a, lda, c__, ldc, scale, info, trana_len) char* trana;
integer* n;
doublereal* a;
integer* lda;
doublereal* c__;
            ...
            for (k = l; k <= i__2; ++k) {
                ...
                if (l1 == l2 && k1 == k2) {
                    ...
                    vec[0] = c__[k1 + l1 * c_dim1]
                        - (ddot_(&i__3, &a[k1 * a_dim1 + 1], &c__1, &c__[l1 * c_dim1 + 1], &c__1)
                              + ddot_(&i__4, &c__[k1 + c_dim1], ldc, &a[l1 * a_dim1 + 1], &c__1));
                    scaloc = 1.;
                    ...
                    vec[1] = c__[k2 + l1 * c_dim1]
                        - (ddot_(&i__3, &a[k2 * a_dim1 + 1], &c__1, &c__[l1 * c_dim1 + 1], &c__1)
                              + ddot_(&i__4, &c__[k2 + c_dim1], ldc, &a[l1 * a_dim1 + 1], &c__1));
                    d__1 = -a[l1 + l1 * a_dim1];
                    dlaln2_(&c_true, &c__2, &c__1, &smin, &c_b25, &a[k1 + k1 * a_dim1], lda, &c_b25,
                        &c_b25, vec, &c__2, &d__1, &c_b29, x, &c__2, &scaloc, &xnorm, &ierr);
                    if (ierr != 0) {
                        *info = 1;
                    }
                    if (scaloc != 1.) {
                    ...
                    vec[1] = c__[k1 + l2 * c_dim1]
                        - (ddot_(&i__3, &a[k1 * a_dim1 + 1], &c__1, &c__[l2 * c_dim1 + 1], &c__1)
                              + ddot_(&i__4, &c__[k1 + c_dim1], ldc, &a[l2 * a_dim1 + 1], &c__1));
                    d__1 = -a[k1 + k1 * a_dim1];
                    dlaln2_(&c_true, &c__2, &c__1, &smin, &c_b25, &a[l1 + l1 * a_dim1], lda, &c_b25,
                        &c_b25, vec, &c__2, &d__1, &c_b29, x, &c__2, &scaloc, &xnorm, &ierr);
                    if (ierr != 0) {
                        *info = 1;
                    }
                    ...
                    vec[3] = c__[k2 + l2 * c_dim1]
                        - (ddot_(&i__3, &a[k2 * a_dim1 + 1], &c__1, &c__[l2 * c_dim1 + 1], &c__1)
                              + ddot_(&i__4, &c__[k2 + c_dim1], ldc, &a[l2 * a_dim1 + 1], &c__1));
                    if (k1 == l1) {
                        sb03mw_(&c_false, &lupper, &a[k1 + k1 * a_dim1], lda, vec, &c__2, &scaloc,
                            x, &c__2, &xnorm, &ierr);
                        if (lupper) {
                            x[1] = x[2];
                        } else {
                        ...
                        dlasy2_(&c_true, &c_false, &c__1, &c__2, &c__2, &a[k1 + k1 * a_dim1], lda,
        ...
        for (l = *n; l >= 1; --l) {
            ...
            for (k = l; k >= 1; --k) {
                ...
                if (l1 == l2 && k1 == k2) {
                    ...
                    i__2 = *n - l1;
                    vec[0] = c__[k1 + l1 * c_dim1]
                        - (ddot_(&i__1, &a[k1 + mink1n * a_dim1], lda, &c__[mink1n + l1 * c_dim1],
                               &c__1)
                              + ddot_(&i__2, &c__[k1 + minl1n * c_dim1], ldc,
                    ...
                    i__2 = *n - l2;
                    vec[0] = c__[k1 + l1 * c_dim1]
                        - (ddot_(&i__1, &a[k1 + mink2n * a_dim1], lda, &c__[mink2n + l1 * c_dim1],
                               &c__1)
                              + ddot_(&i__2, &c__[k1 + minl2n * c_dim1], ldc,
                                    &a[l1 + minl2n * a_dim1], lda));
                    i__1 = *n - k2;
                    i__2 = *n - l2;
                    vec[1] = c__[k2 + l1 * c_dim1]
                        - (ddot_(&i__1, &a[k2 + mink2n * a_dim1], lda, &c__[mink2n + l1 * c_dim1],
                               &c__1)
                              + ddot_(&i__2, &c__[k2 + minl2n * c_dim1], ldc,
                                    &a[l1 + minl2n * a_dim1], lda));
                    d__1 = -a[l1 + l1 * a_dim1];
                    dlaln2_(&c_false, &c__2, &c__1, &smin, &c_b25, &a[k1 + k1 * a_dim1], lda,
                        &c_b25, &c_b25, vec, &c__2, &d__1, &c_b29, x, &c__2, &scaloc, &xnorm,
                        &ierr);
                    if (ierr != 0) {
                        *info = 1;
                    }
                    ...
                    i__2 = *n - l2;
                    vec[1] = c__[k1 + l2 * c_dim1]
                        - (ddot_(&i__1, &a[k1 + mink1n * a_dim1], lda, &c__[mink1n + l2 * c_dim1],
                               &c__1)
                              + ddot_(&i__2, &c__[k1 + minl2n * c_dim1], ldc,
                                    &a[l2 + minl2n * a_dim1], lda));
                    d__1 = -a[k1 + k1 * a_dim1];
                    dlaln2_(&c_false, &c__2, &c__1, &smin, &c_b25, &a[l1 + l1 * a_dim1], lda,
                        &c_b25, &c_b25, vec, &c__2, &d__1, &c_b29, x, &c__2, &scaloc, &xnorm,
                        &ierr);
                    if (ierr != 0) {
                        *info = 1;
                    ...
                    i__2 = *n - l2;
                    vec[2] = c__[k1 + l2 * c_dim1]
                        - (ddot_(&i__1, &a[k1 + mink2n * a_dim1], lda, &c__[mink2n + l2 * c_dim1],
                               &c__1)
                              + ddot_(&i__2, &c__[k1 + minl2n * c_dim1], ldc,
                                    &a[l2 + minl2n * a_dim1], lda));
                    i__1 = *n - k2;
                    ...
                    i__2 = *n - l2;
                    vec[3] = c__[k2 + l2 * c_dim1]
                        - (ddot_(&i__1, &a[k2 + mink2n * a_dim1], lda, &c__[mink2n + l2 * c_dim1],
                               &c__1)
                              + ddot_(&i__2, &c__[k2 + minl2n * c_dim1], ldc,
                                    &a[l2 + minl2n * a_dim1], lda));
                    if (k1 == l1) {
                        sb03mw_(&c_true, &lupper, &a[k1 + k1 * a_dim1], lda, vec, &c__2, &scaloc, x,
                            &c__2, &xnorm, &ierr);
                        if (lupper) {
                            x[1] = x[2];
                        } else {
                        ...
                        dlasy2_(&c_false, &c_true, &c__1, &c__2, &c__2, &a[k1 + k1 * a_dim1], lda,
                            &a[l1 + l1 * a_dim1], lda, vec, &c__2, &scaloc, x, &c__2, &xnorm,
                            &ierr);
                    }
                    if (ierr != 0) {
