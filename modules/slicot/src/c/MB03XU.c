...
doublereal *csl, *csr, *taul, *taur, *dwork;
{
    ...
    if (*ltra && *ltrb) {
        ...
        for (i__ = 1; i__ <= i__1; ++i__) {
            ...
            /*           Update G(k+i,:). */
            i__2 = *k + *n;
            daxpy_(&i__2, &c_b7, &xg[(i__ + *nb) * xg_dim1 + 1], &c__1, &g[*k + i__ + g_dim1], ldg);
            ...
            /*           Update A(i+1,1:k+n). */
            i__2 = *k + *n;
            daxpy_(&i__2, &c_b7, &ya[(i__ + *nb) * ya_dim1 + 1], &c__1, &a[i__ + 1 + a_dim1], lda);
        ...
        for (i__ = 1; i__ <= i__1; ++i__) {
            ...
            /*           Update B(i,:). */
            i__2 = *k + *n;
            daxpy_(&i__2, &c_b7, &xb[(i__ + *nb) * xb_dim1 + 1], &c__1, &b[i__ + b_dim1], ldb);
            a[i__ + (*k + i__) * a_dim1] = temp;
            q[i__ + i__ * q_dim1] = tauq;
            csl[(i__ << 1) - 1] = c__;
            csl[i__ * 2] = s;
