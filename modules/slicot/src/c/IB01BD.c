...
ftnlen jobck_len;
{
    ...
    static integer lmmnol, minwrk, maxwrk, iaw;
    ...
    *info = 0;
    ...
    if (withk) {
        if (*iwarn == 5) {
            ...
            is = ir + ll;
            jwork = is + nl;
            ma02ad_("Full", n, n, &a[a_offset], lda, &dwork[ia], n, 4L);
            ma02ad_("Full", l, n, &c__[c_offset], ldc, &dwork[ic], n, 4L);
            dlacpy_("Upper", n, n, &q[q_offset], ldq, &dwork[iq], n, 5L);
