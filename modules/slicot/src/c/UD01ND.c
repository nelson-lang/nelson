...
/* Subroutine */ EXPORTSYMBOL int ud01nd_(mp, np, dp, l, nout, p, ldp1, ldp2, text, info, text_len)
...
ftnlen text_len;
{
    ...
    /* Builtin functions */
    integer i_len(), s_wsfe(), e_wsfe(), do_fio();
    /* Local variables */
    static integer i__, j, k, j1, j2, n1, ltext, jj;
