...
/* Subroutine */ int ib01md_(meth, alg, batch, conct, nobr, m, l, nsmp, u, ldu, y, ldy, r__, ldr, iwork, dwork, ldwork, iwarn, info, meth_len, alg_len, batch_len, conct_len)
...
ftnlen conct_len;
{
    ...
    extern /* Subroutine */ int mb04od_(), dgemm_();
    extern logical lsame_();
    extern /* Subroutine */ int ib01my_();
