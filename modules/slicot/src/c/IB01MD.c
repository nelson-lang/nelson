...
/* Subroutine */ EXPORTSYMBOL int ib01md_(meth, alg, batch, conct, nobr, m, l, nsmp, u, ldu, y, ldy, r__, ldr, iwork, dwork, ldwork, iwarn, info, meth_len, alg_len, batch_len, conct_len)
...
ftnlen conct_len;
{
    ...
    integer r_dim1, r_offset, u_dim1, u_offset, y_dim1, y_offset, i__1, i__2, i__3;
    doublereal d__1;
    /* Local variables */
    ...
    static integer nobr2, i__, j;
    static logical chalg;
    extern /* Subroutine */ EXPORTSYMBOL int mb04od_(), dgemm_();
    extern logical lsame_();
    extern /* Subroutine */ EXPORTSYMBOL int ib01my_();
    ...
    static integer nobrm1, ishft2, id, jd, ii;
    ...
    static integer ishftu, nslast, ldrwrk, ishfty, minwrk, maxwrk, ldrwmx, nsmpsm;
    ...
    fqralg = lsame_(alg, "F", 1L, 1L);
    qralg = lsame_(alg, "Q", 1L, 1L);
    chalg = lsame_(alg, "C", 1L, 1L);
    onebch = lsame_(batch, "O", 1L, 1L);
