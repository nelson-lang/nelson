...
EXPORTSYMBOL /* Subroutine */ int mb03id_(compq, compu, n, a, lda, c__, ldc, d__, ldd, b, ldb, f, ldf, q, ldq, u1, ldu1, u2, ldu2, neig, iwork, liwork, dwork, ldwork, info, compq_len, compu_len)
char *compq, *compu;
integer *n;
doublereal *a;
integer *lda;
