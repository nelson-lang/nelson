...
/* Subroutine */ int ab09cd_(dico, equil, ordsel, n, m, p, nr, a, lda, b, ldb, c__, ldc, d__, ldd, hsv, tol1, tol2, iwork, dwork, ldwork, iwarn, info, dico_len, equil_len, ordsel_len)
