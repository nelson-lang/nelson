...
/* Subroutine */ EXPORTSYMBOL int mb03vd_(n, p, ilo, ihi, a, lda1, lda2, tau, ldtau, dwork, info)
integer *n, *p, *ilo, *ihi;
doublereal *a;
integer *lda1, *lda2;
doublereal *tau;
...
integer *info;
{
    ...
    static integer nh;
    extern /* Subroutine */ EXPORTSYMBOL int dlarfg_(), xerbla_();
    /*     SLICOT RELEASE 5.0. */
