...
ftnlen ordsel_len;
{
    ...
    static doublereal sqreps;
    static integer nu1;
    static doublereal wrkopt;
    static integer nra, kav, kaw, kbv, kbw, kcv, kcw, kdv, kdw, kev, kew;
    static doublereal tol;
    static integer nwm, nvp;
    /*     SLICOT RELEASE 5.0. */
    ...
    *iwarn = 0;
    ...
    lefti = lsame_(jobv, "I", 1L, 1L) || lsame_(jobv, "R", 1L, 1L);
    leftw = lsame_(jobv, "V", 1L, 1L) || lsame_(jobv, "C", 1L, 1L) || lefti;
    conjv = lsame_(jobv, "C", 1L, 1L) || lsame_(jobv, "R", 1L, 1L);
    righti = lsame_(jobw, "I", 1L, 1L) || lsame_(jobw, "R", 1L, 1L);
    rightw = lsame_(jobw, "W", 1L, 1L) || lsame_(jobw, "C", 1L, 1L) || righti;
    conjw = lsame_(jobw, "C", 1L, 1L) || lsame_(jobw, "R", 1L, 1L);
    frwght = leftw || rightw;
    ...
    if (leftw) {
        ...
        if (lefti) {
            if (invfr) {
                ...
                dlacpy_("Full", p, nv, &cv[cv_offset], ldcv, &dwork[kcv], &ldcdv, 4L);
                dlacpy_("Full", p, p, &dv[dv_offset], lddv, &dwork[kdv], &ldcdv, 4L);
    ...
    if (rightw) {
        ...
        if (righti) {
            if (invfr) {
                ...
                dlacpy_("Full", m, nw, &cw[cw_offset], ldcw, &dwork[kcw], &ldcdw, 4L);
                dlacpy_("Full", m, m, &dw[dw_offset], lddw, &dwork[kdw], &ldcdw, 4L);
