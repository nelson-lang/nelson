...
EXPORTSYMBOL /* Subroutine */ int ab09gd_(dico, jobcf, fact, jobmr, equil, ordsel, n, m, p, nr, alpha, a, lda, b, ldb, c__, ldc, d__, ldd, nq, hsv, tol1, tol2, tol3, iwork, dwork, ldwork, iwarn, info, dico_len, jobcf_len, fact_len, jobmr_len, equil_len, ordsel_len)
...
ftnlen ordsel_len;
{
    ...
    *iwarn = 0;
    ...
    if (left)
    {
        ...
        dlacpy_("Full", p, m, &d__[d_offset], ldd, &dwork[kd], &maxmp, 4L);
        if (stabd)
        {
            ...
            /*                                  prefer larger. */
            sb08ed_(dico, n, m, p, alpha, &a[a_offset], lda, &dwork[kb], n, &dwork[kc], &maxmp, &dwork[kd], &maxmp, nq, &ndr, &dwork[kbr], n, &dwork[kdr], &maxmp, tol3, &dwork[kw], &lwr, iwarn, info, 1L);
        }
        else
        {
            ...
            /*                                  prefer larger. */
            sb08cd_(dico, n, m, p, &a[a_offset], lda, &dwork[kb], n, &dwork[kc], &maxmp, &dwork[kd], &maxmp, nq, &ndr, &dwork[kbr], n, &dwork[kdr], &maxmp, tol3, &dwork[kw], &lwr, iwarn, info, 1L);
        }
        *iwarn *= 10;
        if (*info != 0)
        {
        ...
        kw = kti + *nq **nq;
        i__1 = *ldwork - kw + 1;
        ab09bx_(dico, jobmr, ordsel, nq, &mp, p, nr, &a[a_offset], lda, &dwork[kb], n, &dwork[kc], &maxmp, &dwork[kd], &maxmp, &hsv[1], &dwork[kt], n, &dwork[kti], n, tol1, tol2, &iwork[1], &dwork[kw], &i__1, &iwarnk, &ierr, 1L, 1L, 1L);
        *iwarn += iwarnk;
        if (ierr != 0)
        {
            *info = 4;
        ...
        dlacpy_("Full", p, m, &dwork[kd], &maxmp, &d__[d_offset], ldd, 4L);
    }
    else
    {
        /*                             -1 */
        ...
        dlacpy_("Full", p, m, &d__[d_offset], ldd, &dwork[kd], &pm, 4L);
        if (stabd)
        {
            ...
            /*                                  prefer larger. */
            sb08fd_(dico, n, m, p, alpha, &a[a_offset], lda, &b[b_offset], ldb, &dwork[kc], &pm, &dwork[kd], &pm, nq, &ndr, &dwork[kcr], &pm, &dwork[kdr], &pm, tol3, &dwork[kw], &lwr, iwarn, info, 1L);
        }
        else
        {
            ...
            /*                                  prefer larger. */
            sb08dd_(dico, n, m, p, &a[a_offset], lda, &b[b_offset], ldb, &dwork[kc], &pm, &dwork[kd], &pm, nq, &ndr, &dwork[kcr], &pm, &dwork[kdr], &pm, tol3, &dwork[kw], &lwr, iwarn, info, 1L);
        }
        *iwarn *= 10;
        if (*info != 0)
        {
        ...
        kw = kti + *nq **nq;
        i__1 = *ldwork - kw + 1;
        ab09bx_(dico, jobmr, ordsel, nq, m, &pm, nr, &a[a_offset], lda, &b[b_offset], ldb, &dwork[kc], &pm, &dwork[kd], &pm, &hsv[1], &dwork[kt], n, &dwork[kti], n, tol1, tol2, &iwork[1], &dwork[kw], &i__1, &iwarnk, &ierr, 1L, 1L, 1L);
        *iwarn += iwarnk;
        if (ierr != 0)
        {
            *info = 4;
        ...
        dlacpy_("Full", p, m, &dwork[kd], &pm, &d__[d_offset], ldd, 4L);
    }
    iwork[1] = nminr;
    dwork[1] = (doublereal) wrkopt;
    return 0;
