...
EXPORTSYMBOL /* Subroutine */ int sb03pd_(job, fact, trana, n, a, lda, u, ldu, c__, ldc, scale, sepd, ferr, wr, wi, iwork, dwork, ldwork, info, job_len, fact_len, trana_len)
char *job, *fact, *trana;
integer *n;
doublereal *a;
integer *lda;
...
ftnlen trana_len;
{
    ...
    extern /* Subroutine */ int sb03mx_(), dcopy_();
    static char notra[1];
