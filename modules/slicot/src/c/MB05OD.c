...
/* Subroutine */ int mb05od_(balanc, n, ndiag, delta, a, lda, mdig, idig, iwork, dwork, ldwork, iwarn, info, balanc_len)
char *balanc;
integer *n, *ndiag;
doublereal *delta, *a;
...
ftnlen balanc_len;
{
    ...
    extern /* Subroutine */ int dgetrf_(), dlacpy_();
