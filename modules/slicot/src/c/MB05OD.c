...
/* Subroutine */ EXPORTSYMBOL int mb05od_(balanc, n, ndiag, delta, a, lda, mdig, idig, iwork, dwork, ldwork, iwarn, info, balanc_len)
char *balanc;
integer *n, *ndiag;
doublereal *delta, *a;
...
ftnlen balanc_len;
{
    ...
    /* Builtin functions */
    double d_lg10(), sqrt(), exp(), log(), pow_di();
    /* Local variables */
    ...
    static doublereal ss, tr, xn;
    extern /* Subroutine */ EXPORTSYMBOL int dgetrf_(), dlacpy_();
    ...
    static integer im1, mpower;
    static doublereal sd2, ovrthr, big, eps, var, tmp1;
    /*     SLICOT RELEASE 5.0. */
    ...
    *(unsigned char *)actbal = *(unsigned char *)balanc;
    ...
    dlacpy_("Full", n, n, &dwork[jwora3], n, &a[a_offset], lda, 4L);
    dgetrs_("No transpose", n, n, &dwork[jwora1], n, &iwork[1], &a[a_offset], lda, &ifail, 12L);
    ...
    mb05oy_(actbal, n, &c__1, n, &a[a_offset], lda, &dwork[jworv1], info, 1L);
    eavgev = exp(avgev);
    emnorm = dlange_("1-norm", n, n, &a[a_offset], lda, &dwork[jwora1], 6L);
