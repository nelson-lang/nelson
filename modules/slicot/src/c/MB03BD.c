...
/* Subroutine */ int mb03bd_(job, defl, compq, qind, k, n, h__, ilo, ihi, s, a, lda1, lda2, q, ldq1, ldq2, alphar, alphai, beta, scal, iwork, liwork, dwork, ldwork, iwarn, info, job_len, defl_len, compq_len)
char *job, *defl, *compq;
