...
EXPORTSYMBOL /* Subroutine */ int mb01ud_(
    side, trans, m, n, alpha, h__, ldh, a, lda, b, ldb, info, side_len, trans_len) char *side,
    *trans;
integer *m, *n;
...
ftnlen trans_len;
{
    ...
    *info = 0;
    ...
    dtrmm_(side, "Upper", trans, "Non-unit", m, n, alpha, &h__[h_offset], ldh, &b[b_offset], ldb,
        1L, 5L, 1L, 8L);
