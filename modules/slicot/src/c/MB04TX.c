...
EXPORTSYMBOL /* Subroutine */ int mb04tx_(updatq, updatz, m, n, nblcks, inuk, imuk, a, lda, e, lde, q, ldq, z__, ldz, mnei)
...
integer *ldz, *mnei;
{
    ...
    /* Local variables */
    static integer minf, ninf, sk1p1, tk1p1, meps, neps, mukp1, k;
    extern /* Subroutine */ int mb04tu_(), drotg_();
    static integer ismuk, isnuk, ca, ce, ra;
    static doublereal sc;
    static integer ip;
    static doublereal ss;
    static integer tp1, cja, cje, rje, muk, nuk, mup, nup, mup1;
    /*     SLICOT RELEASE 5.0. */
