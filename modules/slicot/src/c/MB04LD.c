...
/* Subroutine */ EXPORTSYMBOL int mb04ld_(uplo, n, m, p, l, ldl, a, lda, b, ldb, c__, ldc, tau, dwork, uplo_len)
char *uplo;
integer *n, *m, *p;
doublereal *l;
integer *ldl;
...
ftnlen uplo_len;
{
    ...
    integer a_dim1, a_offset, b_dim1, b_offset, c_dim1, c_offset, l_dim1, l_offset, i__1, i__2;
    doublereal d__1;
    /* Local variables */
