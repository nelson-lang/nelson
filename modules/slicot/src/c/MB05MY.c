...
ftnlen balanc_len;
{
    ...
    integer a_dim1, a_offset, q_dim1, q_offset, r_dim1, r_offset, i__1, i__2, i__3, i__4;
    /* Builtin functions */
    double sqrt();
    /* Local variables */
    static integer ibal, maxb;
    static doublereal anrm;
    static integer ierr, itau, nout, k;
    ...
    *info = 0;
    ...
    /*     (Workspace: need N) */
    ibal = 1;
    dgebal_(balanc, n, &a[a_offset], lda, &ilo, &ihi, &dwork[ibal], &ierr, 1L);
    /*     Reduce to upper Hessenberg form. */
    /*     (Workspace: need 3*N, prefer 2*N+N*NB) */
    itau = ibal + *n;
    jwork = itau + *n;
    i__1 = *ldwork - jwork + 1;
    dgehrd_(n, &ilo, &ihi, &a[a_offset], lda, &dwork[itau], &dwork[jwork], &i__1, &ierr);
    ...
    i__1 = *ldwork - jwork + 1;
    dorghr_(n, &ilo, &ihi, &q[q_offset], ldq, &dwork[itau], &dwork[jwork], &i__1, &ierr);
