...
EXPORTSYMBOL /* Subroutine */ int mb03gd_(n, b, ldb, d__, ldd, macpar, q, ldq, u, ldu, dwork, ldwork, info)
integer *n;
doublereal *b;
integer *ldb;
doublereal *d__;
...
integer *ldwork, *info;
{
    ...
    *info = 0;
    ...
    if (*n == 4)
    {
        ...
        dsyr2k_("Upper", "Transpose", &c__2, &c__2, &c_b6, &u[u_dim1 * 3 + 1], ldu, &b[b_dim1 * 3 + 1], ldb, &c_b7, &q[q_offset], ldq, 5L, 9L);
        ...
        dgemm_("No Transpose", "No Transpose", &c__2, &c__2, &c__2, &c_b7, &u[u_dim1 * 3 + 1], ldu, &u[u_dim1 * 3 + 3], ldu, &c_b14, &u[u_offset], ldu, 12L, 12L);
        /*        Compute H21 = inv( B22' )*Q*inv( B22 ) in U21. */
        mb01ru_("Upper", "Transpose", &c__2, &c__2, &c_b14, &c_b6, &u[u_dim1 + 3], ldu, &u[u_dim1 * 3 + 3], ldu, &q[q_offset], ldq, &dwork[1], &c__4, info, 5L, 9L);
        ...
        dgemm_("No Transpose", "No Transpose", &c__4, &c__2, &c__2, &c_b6, &q[q_offset], ldq, &q[q_dim1 * 3 + 1], ldq, &c_b14, &u[u_offset], ldu, 12L, 12L);
        dgemm_("Transpose", "No Transpose", &c__2, &c__2, &c__2, &c_b7, &q[q_dim1 * 3 + 3], ldq, &q[q_dim1 + 3], ldq, &c_b6, &u[u_dim1 + 3], ldu, 9L, 12L);
        u[u_dim1 + 1] += t;
        u[(u_dim1 << 1) + 2] += t;
        ...
        iwrk2 = itau + 2;
        i__1 = *ldwork - iwrk2 + 1;
        mb04su_(&c__2, &c__2, &u[u_dim1 + 1], ldu, &u[u_dim1 + 3], ldu, &dwork[ics], &dwork[itau], &dwork[iwrk2], &i__1, info);
        i__1 = *ldwork - iwrk2 + 1;
        mb04wu_("No Transpose", "No Transpose", &c__2, &c__2, &c__2, &u[u_dim1 + 1], ldu, &u[u_dim1 + 3], ldu, &dwork[ics], &dwork[itau], &dwork[iwrk2], &i__1, info, 12L, 12L);
        /*        Compute J*U in U. */
        ...
        dgemm_("Transpose", "No Transpose", &c__4, &c__2, &c__2, &c_b6, &u[u_offset], ldu, &b[b_offset], ldb, &c_b14, &q[q_offset], ldq, 9L, 12L);
        dgemm_("Transpose", "No Transpose", &c__4, &c__2, &c__4, &c_b6, &u[u_offset], ldu, &b[b_dim1 * 3 + 1], ldb, &c_b14, &q[q_dim1 * 3 + 1], ldq, 9L, 12L);
        ...
        dorm2r_("Right", "No Transpose", n, &c__2, &c__2, &dwork[ir], &c__2, &dwork[itau], &q[q_dim1 * 3 + 1], ldq, &dwork[iwrk2], info, 5L, 12L);
    }
    else
    {
