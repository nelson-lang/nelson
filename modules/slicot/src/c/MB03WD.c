...
/* Subroutine */ int mb03wd_(job, compz, n, p, ilo, ihi, iloz, ihiz, h__, ldh1, ldh2, z__, ldz1, ldz2, wr, wi, dwork, ldwork, info, job_len, compz_len)
char *job, *compz;
...
ftnlen compz_len;
{
    ...
    extern /* Subroutine */ int mb04py_(), dcopy_();
