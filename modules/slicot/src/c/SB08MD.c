    ...
    L140:
        if (k <= da1 - 2 && stable) {
            ...
            if (stable) {
                ...
                i__1 = (da1 - k) / 2;
                d__1 = -w;
                daxpy_(&i__1, &d__1, &dwork[lphi + k + 2], &c__2, &dwork[lphi + k + 1], &c__2);
                w = dwork[lay + k] / dwork[lphi + k];
                dwork[lay + k] = w;
                i__1 = (da1 - k) / 2;
                d__1 = -w;
                daxpy_(&i__1, &d__1, &dwork[lphi + k + 2], &c__2, &dwork[lay + k + 1], &c__1);
                ++k;
            }
            goto L140;
        }
        ...
        if (stable) {
            ...
            for (k = da1 - 2; k >= 1; --k) {
                ...
                i__1 = (da1 - k) / 2;
                d__1 = -w;
                daxpy_(&i__1, &d__1, &dwork[lay + k + 1], &c__2, &dwork[lay + k], &c__2);
                /* L160: */
            }
            dwork[lay + da1] = xda;
