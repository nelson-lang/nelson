...
/* Subroutine */ int mb03xd_(balanc, job, jobu, jobv, n, a, lda, qg, ldqg, t, ldt, u1, ldu1, u2, ldu2, v1, ldv1, v2, ldv2, wr, wi, ilo, scale, dwork, ldwork, info, balanc_len, job_len, jobu_len, jobv_len)
