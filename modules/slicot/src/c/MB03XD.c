...
EXPORTSYMBOL /* Subroutine */ int mb03xd_(balanc, job, jobu, jobv, n, a, lda, qg, ldqg, t, ldt, u1, ldu1, u2, ldu2, v1, ldv1, v2, ldv2, wr, wi, ilo, scale, dwork, ldwork, info, balanc_len, job_len, jobu_len, jobv_len)
...
ftnlen jobv_len;
{
    ...
    static integer pcsr;
    extern /* Subroutine */ int ma01ad_();
    static integer i__, j, k, l;
    extern doublereal ma02id_();
    extern /* Subroutine */ int mb04dd_(), mb04qb_(), dscal_(), mb04tb_(), dgemm_();
    static integer pbeta;
    static logical lscal;
    extern logical lsame_();
    static char uchar[1], vchar[1];
    extern /* Subroutine */ int mb03xp_();
