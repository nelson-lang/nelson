...
/* Subroutine */ EXPORTSYMBOL int sb03sx_(trana, uplo, lyapun, n, xanorm, t, ldt, u, ldu, r__, ldr, ferr, iwork, dwork, ldwork, info, trana_len, uplo_len, lyapun_len)
...
ftnlen lyapun_len;
{
    ...
    static char uplow[1];
    static integer ij, nn;
    extern /* Subroutine */ EXPORTSYMBOL int dlacon_(), xerbla_();
