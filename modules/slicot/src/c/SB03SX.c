...
EXPORTSYMBOL /* Subroutine */ int sb03sx_(trana, uplo, lyapun, n, xanorm, t, ldt, u, ldu, r__, ldr, ferr, iwork, dwork, ldwork, info, trana_len, uplo_len, lyapun_len)
...
ftnlen lyapun_len;
{
    ...
    extern /* Subroutine */ int dlacon_(), xerbla_();
