    ...
    *info = 0;
    ...
    if (lblk && *n1 == 1) {
        ...
        if (*isham) {
            ...
            /*                      [  0  -A11  ] */
            nd = 4;
            dlacpy_("Full", &c__2, &c__2, &a[*n - 1 + (*n - 1) * a_dim1], lda, d__, &c__4, 4L);
            dlaset_("All", &c__2, &c__2, &c_b21, &c_b21, &d__[2], &c__4, 3L);
            dlacpy_("Upper", &c__2, &c__2, &g[*n - 1 + (*n - 1) * g_dim1], ldg, &d__[8], &c__4, 5L);
            d__[9] = d__[12];
            d__[10] = -d__[0];
            d__[11] = -d__[4];
            d__[14] = -d__[1];
            d__[15] = -d__[5];
            dnorm = dlange_("Max", &nd, &nd, d__, &c__4, &dwork[1], 3L);
        ...
        nd = *n1 + *n2;
        dlacpy_("Full", &nd, &nd, &a[*j1 + *j1 * a_dim1], lda, d__, &c__4, 4L);
        dnorm = dlange_("Max", &nd, &nd, d__, &c__4, &dwork[1], 3L);
        /*        Compute machine-dependent threshold for test for accepting */
        /*        swap. */
        eps = dlamch_("P", 1L);
    ...
    L10:
        ...
        dlarfx_("Left", &c__3, &c__3, v, &tau, d__, &c__4, &dwork[1], 4L);
        ...
        i__1 = *n - *j1 + 1;
        dlarfx_("Left", &c__3, &i__1, v, &tau, &a[*j1 + *j1 * a_dim1], lda, &dwork[1], 4L);
        dlarfx_("Right", &j2, &c__3, v, &tau, &a[*j1 * a_dim1 + 1], lda, &dwork[1], 5L);
        a[j3 + *j1 * a_dim1] = 0.;
        a[j3 + j2 * a_dim1] = 0.;
        a[j3 + j3 * a_dim1] = a11;
    ...
    L20:
        ...
        a33 = a[j3 + j3 * a_dim1];
        /*        Perform swap provisionally on diagonal block in D. */
        dlarfx_("L", &c__3, &c__3, v, &tau, d__, &c__4, &dwork[1], 1L);
        ...
        /*        Accept swap: apply transformation to the entire matrix A. */
        dlarfx_("Right", &j3, &c__3, v, &tau, &a[*j1 * a_dim1 + 1], lda, &dwork[1], 5L);
        i__1 = *n - *j1;
        dlarfx_("Left", &c__3, &i__1, v, &tau, &a[*j1 + j2 * a_dim1], lda, &dwork[1], 4L);
        a[*j1 + *j1 * a_dim1] = a33;
        a[j2 + *j1 * a_dim1] = 0.;
        a[j3 + *j1 * a_dim1] = 0.;
        /*        Apply transformation to G. */
    ...
    L30:
        ...
        v2[0] = 1.;
        /*        Perform swap provisionally on diagonal block in D. */
        dlarfx_("L", &c__3, &c__4, v1, &tau1, d__, &c__4, &dwork[1], 1L);
        dlarfx_("R", &c__4, &c__3, v1, &tau1, d__, &c__4, &dwork[1], 1L);
        dlarfx_("L", &c__3, &c__4, v2, &tau2, &d__[1], &c__4, &dwork[1], 1L);
        ...
        /*        Accept swap: apply transformation to the entire matrix A. */
        i__1 = *n - *j1 + 1;
        dlarfx_("L", &c__3, &i__1, v1, &tau1, &a[*j1 + *j1 * a_dim1], lda, &dwork[1], 1L);
        dlarfx_("R", &j4, &c__3, v1, &tau1, &a[*j1 * a_dim1 + 1], lda, &dwork[1], 1L);
        i__1 = *n - *j1 + 1;
        dlarfx_("L", &c__3, &i__1, v2, &tau2, &a[j2 + *j1 * a_dim1], lda, &dwork[1], 1L);
        dlarfx_("R", &j4, &c__3, v2, &tau2, &a[j2 * a_dim1 + 1], lda, &dwork[1], 1L);
        a[j3 + *j1 * a_dim1] = 0.;
        a[j3 + j2 * a_dim1] = 0.;
        a[j4 + *j1 * a_dim1] = 0.;
        a[j4 + j2 * a_dim1] = 0.;
