...
EXPORTSYMBOL /* Subroutine */ int mb02hd_(triu, k, l, m, ml, n, nu, p, s, tc, ldtc, tr, ldtr, rb, ldrb, dwork, ldwork, info, triu_len)
char *triu;
...
ftnlen triu_len;
{
    ...
    extern /* Subroutine */ int dgemm_(), mb02cu_(), mb02cv_();
