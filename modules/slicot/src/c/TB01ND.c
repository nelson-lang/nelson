...
/* Subroutine */ EXPORTSYMBOL int tb01nd_(jobu, uplo, n, p, a, lda, c__, ldc, u, ldu, dwork, info, jobu_len, uplo_len)
char *jobu, *uplo;
integer *n, *p;
doublereal *a;
integer *lda;
...
ftnlen uplo_len;
{
    ...
    integer a_dim1, a_offset, c_dim1, c_offset, u_dim1, u_offset, i__1, i__2, i__3;
    /* Local variables */
    static integer j;
    static logical ljoba, ljobi;
    extern logical lsame_();
    static logical luplo;
    static integer n1, p1, ii, nj;
