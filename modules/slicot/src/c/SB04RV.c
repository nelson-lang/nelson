...
EXPORTSYMBOL /* Subroutine */ int sb04rv_(abschr, ul, n, m, c__, ldc, indx, ab, ldab, ba, ldba, d__, dwork, abschr_len, ul_len)
char *abschr, *ul;
integer *n, *m;
doublereal *c__;
integer *ldc, *indx;
...
ftnlen ul_len;
{
    ...
    if (lsame_(abschr, "B", 1L, 1L))
    {
        ...
        if (lsame_(ul, "U", 1L, 1L))
        {
            ...
            {
                i__1 = *indx - 1;
                dgemv_("N", n, &i__1, &c_b9, &c__[c_offset], ldc, &ab[*indx * ab_dim1 + 1], &c__1, &c_b11, &dwork[1], &c__1, 1L);
                i__1 = *indx - 1;
                dgemv_("N", n, &i__1, &c_b9, &c__[c_offset], ldc, &ab[(*indx + 1) * ab_dim1 + 1], &c__1, &c_b11, &dwork[*n + 1], &c__1, 1L);
                dgemv_("N", n, n, &c_b19, &ba[ba_offset], ldba, &dwork[1], &c__1, &c_b9, &d__[1], &c__2, 1L);
                dgemv_("N", n, n, &c_b19, &ba[ba_offset], ldba, &dwork[*n + 1], &c__1, &c_b9, &d__[2], &c__2, 1L);
            }
        }
        else
        {
            ...
            {
                i__1 = *m - *indx - 1;
                dgemv_("N", n, &i__1, &c_b9, &c__[(*indx + 2) * c_dim1 + 1], ldc, &ab[*indx + 2 + *indx * ab_dim1], &c__1, &c_b11, &dwork[1], &c__1, 1L);
                i__1 = *m - *indx - 1;
                dgemv_("N", n, &i__1, &c_b9, &c__[(*indx + 2) * c_dim1 + 1], ldc, &ab[*indx + 2 + (*indx + 1) * ab_dim1], &c__1, &c_b11, &dwork[*n + 1], &c__1, 1L);
                dgemv_("N", n, n, &c_b19, &ba[ba_offset], ldba, &dwork[1], &c__1, &c_b9, &d__[1], &c__2, 1L);
                dgemv_("N", n, n, &c_b19, &ba[ba_offset], ldba, &dwork[*n + 1], &c__1, &c_b9, &d__[2], &c__2, 1L);
            }
        }
    ...
    else
    {
        ...
        if (lsame_(ul, "U", 1L, 1L))
        {
            ...
            {
                i__1 = *n - *indx - 1;
                dgemv_("T", &i__1, m, &c_b9, &c__[*indx + 2 + c_dim1], ldc, &ab[*indx + (*indx + 2) * ab_dim1], ldab, &c_b11, &dwork[1], &c__1, 1L);
                i__1 = *n - *indx - 1;
                dgemv_("T", &i__1, m, &c_b9, &c__[*indx + 2 + c_dim1], ldc, &ab[*indx + 1 + (*indx + 2) * ab_dim1], ldab, &c_b11, &dwork[*m + 1], &c__1, 1L);
                dgemv_("T", m, m, &c_b19, &ba[ba_offset], ldba, &dwork[1], &c__1, &c_b9, &d__[1], &c__2, 1L);
                dgemv_("T", m, m, &c_b19, &ba[ba_offset], ldba, &dwork[*m + 1], &c__1, &c_b9, &d__[2], &c__2, 1L);
            }
        }
        else
        {
            ...
            {
                i__1 = *indx - 1;
                dgemv_("T", &i__1, m, &c_b9, &c__[c_offset], ldc, &ab[*indx + ab_dim1], ldab, &c_b11, &dwork[1], &c__1, 1L);
                i__1 = *indx - 1;
                dgemv_("T", &i__1, m, &c_b9, &c__[c_offset], ldc, &ab[*indx + 1 + ab_dim1], ldab, &c_b11, &dwork[*m + 1], &c__1, 1L);
                dgemv_("T", m, m, &c_b19, &ba[ba_offset], ldba, &dwork[1], &c__1, &c_b9, &d__[1], &c__2, 1L);
                dgemv_("T", m, m, &c_b19, &ba[ba_offset], ldba, &dwork[*m + 1], &c__1, &c_b9, &d__[2], &c__2, 1L);
            }
        }
