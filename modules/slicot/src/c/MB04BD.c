...
/* Subroutine */ int mb04bd_(job, compq1, compq2, n, a, lda, de, ldde, c1, ldc1, vw, ldvw, q1, ldq1, q2, ldq2, b, ldb, f, ldf, c2, ldc2, alphar, alphai, beta, iwork, liwork, dwork, ldwork, info, job_len, compq1_len, compq2_len)
