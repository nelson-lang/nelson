...
/* Subroutine */ EXPORTSYMBOL int mb04bd_(job, compq1, compq2, n, a, lda, de, ldde, c1, ldc1, vw, ldvw, q1, ldq1, q2, ldq2, b, ldb, f, ldf, c2, ldc2, alphar, alphai, beta, iwork, liwork, dwork, ldwork, info, job_len, compq1_len, compq2_len)
...
ftnlen compq2_len;
{
    ...
    static logical ltri;
    static integer iwrk;
    extern /* Subroutine */ EXPORTSYMBOL int dsyr2_(), ma02ad_(), mb03bd_();
    static integer i__, j, k, m;
    extern /* Subroutine */ EXPORTSYMBOL int mb01ld_(), mb01md_(), mb01nd_(), dlarf_(), dgemm_();
    ...
    extern /* Subroutine */ EXPORTSYMBOL int dlacpy_(), dlartg_(), dlaset_(), xerbla_();
