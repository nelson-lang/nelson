...
/* Subroutine */ int ib01qd_(jobx0, job, n, m, l, nsmp, a, lda, c__, ldc, u, ldu, y, ldy, x0, b, ldb, d__, ldd, tol, iwork, dwork, ldwork, iwarn, info, jobx0_len, job_len)
char *jobx0, *job;
integer *n, *m, *l, *nsmp;
doublereal *a;
integer *lda;
...
ftnlen job_len;
{
    ...
    extern /* Subroutine */ int mb04od_(), mb01td_(), mb02ud_();
    extern logical lsame_();
    extern /* Subroutine */ int dgemv_();
    static doublereal rcond;
    extern /* Subroutine */ int mb04oy_();
    ...
    extern /* Subroutine */ int dlaset_(), xerbla_(), dgelss_();
