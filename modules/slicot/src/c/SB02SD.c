...
/* Subroutine */ int sb02sd_(job, fact, trana, uplo, lyapun, n, a, lda, t, ldt, u, ldu, g, ldg, q, ldq, x, ldx, sepd, rcond, ferr, iwork, dwork, ldwork, info, job_len, fact_len, trana_len, uplo_len, lyapun_len)
