...
EXPORTSYMBOL /* Subroutine */ int sb02sd_(job, fact, trana, uplo, lyapun, n, a, lda, t, ldt, u, ldu, g, ldg, q, ldq, x, ldx, sepd, rcond, ferr, iwork, dwork, ldwork, info, job_len, fact_len, trana_len, uplo_len, lyapun_len)
...
ftnlen lyapun_len;
{
    ...
    extern /* Subroutine */ int dgees_(), dgemm_(), mb01ud_();
    extern logical lsame_();
    static doublereal denom;
    extern /* Subroutine */ int mb01ru_(), dgesv_(), mb01rx_(), mb01ry_();
    static doublereal anorm;
    extern /* Subroutine */ int sb03mx_(), dcopy_(), dswap_();
    static doublereal gnorm;
    extern /* Subroutine */ int sb03sx_();
    static logical bwork[1];
    extern /* Subroutine */ int daxpy_(), sb03sy_();
    static logical lower;
    extern /* Subroutine */ int dsymm_();
