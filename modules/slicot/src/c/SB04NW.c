...
/* Subroutine */ EXPORTSYMBOL int sb04nw_(abschr, ul, n, m, c__, ldc, indx, ab, ldab, d__, abschr_len, ul_len)
char *abschr, *ul;
integer *n, *m;
doublereal *c__;
integer *ldc, *indx;
...
ftnlen ul_len;
{
    ...
    if (lsame_(abschr, "B", 1L, 1L))
    {
        ...
        if (lsame_(ul, "U", 1L, 1L))
        {
            ...
            {
                i__1 = *indx - 1;
                dgemv_("N", n, &i__1, &c_b7, &c__[c_offset], ldc, &ab[*indx * ab_dim1 + 1], &c__1, &c_b9, &d__[1], &c__1, 1L);
            }
        }
        else
        {
            ...
            {
                i__1 = *m - *indx;
                dgemv_("N", n, &i__1, &c_b7, &c__[(*indx + 1) * c_dim1 + 1], ldc, &ab[*indx + 1 + *indx * ab_dim1], &c__1, &c_b9, &d__[1], &c__1, 1L);
            }
        }
    }
    else
    {
        ...
        if (lsame_(ul, "U", 1L, 1L))
        {
            ...
            {
                i__1 = *n - *indx;
                dgemv_("T", &i__1, m, &c_b7, &c__[*indx + 1 + c_dim1], ldc, &ab[*indx + (*indx + 1) * ab_dim1], ldab, &c_b9, &d__[1], &c__1, 1L);
            }
        }
        else
        {
            ...
            {
                i__1 = *indx - 1;
                dgemv_("T", &i__1, m, &c_b7, &c__[c_offset], ldc, &ab[*indx + ab_dim1], ldab, &c_b9, &d__[1], &c__1, 1L);
            }
        }
    }
    return 0;
