...
/* Subroutine */ EXPORTSYMBOL int sg02ad_(dico, jobb, fact, uplo, jobl, scal, sort, acc, n, m, p, a, lda, e, lde, b, ldb, q, ldq, r__, ldr, l, ldl, rcondu, x, ldx, alfar, alfai, beta, s, lds, t, ldt, u, ldu, tol, iwork, dwork, ldwork, bwork, iwarn, info, dico_len, jobb_len, fact_len, uplo_len, jobl_len, scal_len, sort_len, acc_len)
...
ftnlen acc_len;
{
    ...
    extern /* Subroutine */ EXPORTSYMBOL int dgemm_(), dgges_();
    extern logical lsame_();
    static logical ljobl;
    static char equed[1];
    static logical discr;
    extern /* Subroutine */ EXPORTSYMBOL int dscal_(), mb01sd_(), mb02pd_(), mb02vd_();
    extern logical sb02ou_(), sb02ov_(), sb02ow_();
    extern /* Subroutine */ EXPORTSYMBOL int dcopy_(), dswap_(), sb02oy_(), daxpy_();
    ...
    static integer iwb, iwc, iwf, ldw, nnm;
    ...
    if (refine)
    {
        ...
        if (! lsame_(equed, "N", 1L, 1L))
        {
            ...
            if (colequ)
            {
                ...
                mb01sd_("Column scaling", &nn, n, &u[u_offset], ldu, &dwork[iwr], &dwork[iwc], 14L);
            }
        }
        pivotu = dwork[iw];
        if (info1 > 0)
