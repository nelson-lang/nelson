...
/* Subroutine */ int sg02ad_(dico, jobb, fact, uplo, jobl, scal, sort, acc, n, m, p, a, lda, e, lde, b, ldb, q, ldq, r__, ldr, l, ldl, rcondu, x, ldx, alfar, alfai, beta, s, lds, t, ldt, u, ldu, tol, iwork, dwork, ldwork, bwork, iwarn, info, dico_len, jobb_len, fact_len, uplo_len, jobl_len, scal_len, sort_len, acc_len)
...
ftnlen acc_len;
{
    ...
    extern /* Subroutine */ int dgemm_(), dgges_();
    extern logical lsame_();
    static logical ljobl;
    static char equed[1];
    static logical discr;
    extern /* Subroutine */ int dscal_(), mb01sd_(), mb02pd_(), mb02vd_();
    extern logical sb02ou_(), sb02ov_(), sb02ow_();
    extern /* Subroutine */ int dcopy_(), dswap_(), sb02oy_(), daxpy_();
