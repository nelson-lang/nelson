...
ftnlen equil_len;
{
    ...
    *info = 0;
    ...
    ljobo = ljobir || lsame_(job, "O", 1L, 1L);
    /*     Decode SYSTYP. */
    lsysr = lsame_(systyp, "R", 1L, 1L);
    lsyss = lsysr || lsame_(systyp, "S", 1L, 1L);
    ...
    *nr = *n;
    if (fincon) {
        ...
        if (lspace) {
            ...
            dlacpy_("Full", &nc, m, &b[b_offset], ldb, &dwork[kwb], &n1, 4L);
            dlacpy_("Full", p, &nc, &c__[c_offset], ldc, &dwork[kwc], &p1, 4L);
        }
        ...
        if (*nr < nc || !lspace) {
            ...
            dlacpy_("Full", &nc, m, &dwork[kwb], &n1, &b[b_offset], ldb, 4L);
    ...
    if (finobs) {
        ...
        if (lspace) {
            ...
            dlacpy_("Full", &nc, &nc, &a[a_offset], lda, &dwork[kwa], &n1, 4L);
            dlacpy_("Full", &nc, &nc, &e[e_offset], lde, &dwork[kwe], &n1, 4L);
            dlacpy_("Full", &nc, p, &b[b_offset], ldb, &dwork[kwc], &n1, 4L);
            dlacpy_("Full", m, &nc, &c__[c_offset], ldc, &dwork[kwb], &m1, 4L);
        }
        ...
        if (*nr < nc || !lspace) {
            ...
            dlacpy_("Full", &nc, &nc, &dwork[kwa], &n1, &a[a_offset], lda, 4L);
            dlacpy_("Full", &nc, &nc, &dwork[kwe], &n1, &e[e_offset], lde, 4L);
            dlacpy_("Full", &nc, p, &dwork[kwc], &n1, &b[b_offset], ldb, 4L);
