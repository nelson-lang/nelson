...
EXPORTSYMBOL /* Subroutine */ int sb03mu_(ltranl, ltranr, isgn, n1, n2, tl, ldtl, tr, ldtr, b, ldb, scale, x, ldx, xnorm, info)
...
L20:
    /* Computing MAX */
    /* Computing MAX */
    d__7 = (d__1 = tr[tr_dim1 + 1], abs(d__1)), d__8 = (d__2 = tr[(tr_dim1 << 1) + 1], abs(d__2)), d__7 = max(d__7,d__8), d__8 = (d__3 = tr[tr_dim1 + 2], abs(d__3)), d__7 = max(d__7,d__8), d__8 = (d__4 = tr[(tr_dim1 << 1) + 2], abs(d__4));
...
L30:
    /* Computing MAX */
    /* Computing MAX */
    d__7 = (d__1 = tl[tl_dim1 + 1], abs(d__1)), d__8 = (d__2 = tl[(tl_dim1 << 1) + 1], abs(d__2)), d__7 = max(d__7,d__8), d__8 = (d__3 = tl[tl_dim1 + 2], abs(d__3)), d__7 = max(d__7,d__8), d__8 = (d__4 = tl[(tl_dim1 << 1) + 2], abs(d__4));
...
L50:
    ...
    smin = max(d__5,d__6);
    /* Computing MAX */
    d__5 = (d__1 = tl[tl_dim1 + 1], abs(d__1)), d__6 = (d__2 = tl[(tl_dim1 << 1) + 1], abs(d__2)), d__5 = max(d__5,d__6), d__6 = (d__3 = tl[tl_dim1 + 2], abs(d__3)), d__5 = max(d__5,d__6), d__6 = (d__4 = tl[(tl_dim1 << 1) + 2], abs(d__4));
