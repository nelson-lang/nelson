...
ftnlen trans_len;
{
    ...
    m2 -= m2_offset;
    /* Function Body */
    istrns = lsame_(trans, "T", 1L, 1L);
    iscont = lsame_(dico, "C", 1L, 1L);
    ...
    *scale = 1.;
    ...
    qi[3] = ci;
    /*     A := Q * A */
    dgemm_("N", "N", &c__2, &c__2, &c__2, &c_b14, qr, &c__2, aa, &c__2, &c_b8, ar, &c__2, 1L, 1L);
    dgemm_("N", "N", &c__2, &c__2, &c__2, &c_b14, qi, &c__2, aa, &c__2, &c_b8, ai, &c__2, 1L, 1L);
    /*     E := Q * E */
    dgemm_("N", "N", &c__2, &c__2, &c__2, &c_b14, qr, &c__2, ee, &c__2, &c_b8, er, &c__2, 1L, 1L);
    dgemm_("N", "N", &c__2, &c__2, &c__2, &c_b14, qi, &c__2, ee, &c__2, &c_b8, ei, &c__2, 1L, 1L);
    ...
    zi[3] = -ci;
    /*     E := E * Z */
    dgemv_("T", &c__2, &c__2, &c_b14, zr, &c__2, er, &c__2, &c_b8, tr, &c__2, 1L);
    dgemv_("T", &c__2, &c__2, &c_b60, zi, &c__2, ei, &c__2, &c_b14, tr, &c__2, 1L);
    dgemv_("T", &c__2, &c__2, &c_b14, zi, &c__2, er, &c__2, &c_b8, ti, &c__2, 1L);
    dgemv_("T", &c__2, &c__2, &c_b14, zr, &c__2, ei, &c__2, &c_b14, ti, &c__2, 1L);
    ...
    zi[1] = xr * yi + xi * yr;
    /*     A := A * Z */
    dgemm_("N", "N", &c__2, &c__2, &c__2, &c_b14, ar, &c__2, zr, &c__2, &c_b8, tr, &c__2, 1L, 1L);
    dgemm_("N", "N", &c__2, &c__2, &c__2, &c_b60, ai, &c__2, zi, &c__2, &c_b14, tr, &c__2, 1L, 1L);
    dgemm_("N", "N", &c__2, &c__2, &c__2, &c_b14, ar, &c__2, zi, &c__2, &c_b8, ti, &c__2, 1L, 1L);
    dgemm_("N", "N", &c__2, &c__2, &c__2, &c_b14, ai, &c__2, zr, &c__2, &c_b14, ti, &c__2, 1L, 1L);
    dcopy_(&c__4, tr, &c__1, ar, &c__1);
    dcopy_(&c__4, ti, &c__1, ai, &c__1);
    /*     End of QZ-step. */
    /*     B := B * Z */
    dgemm_("N", "N", &c__2, &c__2, &c__2, &c_b14, bb, &c__2, zr, &c__2, &c_b8, br, &c__2, 1L, 1L);
    dgemm_("N", "N", &c__2, &c__2, &c__2, &c_b14, bb, &c__2, zi, &c__2, &c_b8, bi, &c__2, 1L, 1L);
    ...
    qbi[1] = -si;
    qbi[3] = ci;
    dgemv_("N", &c__2, &c__2, &c_b14, qbr, &c__2, &br[2], &c__1, &c_b8, tr, &c__1, 1L);
    dgemv_("N", &c__2, &c__2, &c_b60, qbi, &c__2, &bi[2], &c__1, &c_b14, tr, &c__1, 1L);
    dgemv_("N", &c__2, &c__2, &c_b14, qbi, &c__2, &br[2], &c__1, &c_b8, ti, &c__1, 1L);
    dgemv_("N", &c__2, &c__2, &c_b14, qbr, &c__2, &bi[2], &c__1, &c_b14, ti, &c__1, 1L);
    ...
    dgemm_("N", "N", &c__2, &c__2, &c__2, &c_b14, ur, &c__2, qr, &c__2, &c_b8, zr, &c__2, 1L, 1L);
    dgemm_("N", "N", &c__2, &c__2, &c__2, &c_b60, ui, &c__2, qi, &c__2, &c_b14, zr, &c__2, 1L, 1L);
    dgemm_("N", "N", &c__2, &c__2, &c__2, &c_b14, ur, &c__2, qi, &c__2, &c_b8, zi, &c__2, 1L, 1L);
    dgemm_("N", "N", &c__2, &c__2, &c__2, &c_b14, ui, &c__2, qr, &c__2, &c_b14, zi, &c__2, 1L, 1L);
