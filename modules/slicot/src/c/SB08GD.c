...
EXPORTSYMBOL /* Subroutine */ int sb08gd_(n, m, p, a, lda, b, ldb, c__, ldc, d__, ldd, br, ldbr, dr, lddr, iwork, dwork, info)
integer *n, *m, *p;
doublereal *a;
integer *lda;
doublereal *b;
...
integer *info;
{
    ...
    extern /* Subroutine */ int dgecon_(), dgetrf_(), xerbla_(), dgetrs_();
