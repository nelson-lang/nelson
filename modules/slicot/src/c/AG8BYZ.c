...
EXPORTSYMBOL /* Subroutine */ int ag8byz_(first, n, m, p, svlmax, abcd, ldabcd, e, lde, nr, pr, ninfz, dinfz, nkronl, infz, kronl, tol, iwork, dwork, zwork, lzwork, info)
logical *first;
integer *n, *m, *p;
doublereal *svlmax;
doublecomplex *abcd;
...
integer *lzwork, *info;
{
    ...
    extern /* Subroutine */ int zlarfg_(), zlaset_(), zlartg_(), zlapmt_();
