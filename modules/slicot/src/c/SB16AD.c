...
ftnlen ordsel_len;
{
    ...
    *iwarn = 0;
    ...
    bta = lsame_(jobmr, "B", 1L, 1L) || lsame_(jobmr, "F", 1L, 1L);
    spa = lsame_(jobmr, "S", 1L, 1L) || lsame_(jobmr, "P", 1L, 1L);
    bal = lsame_(jobmr, "B", 1L, 1L) || lsame_(jobmr, "S", 1L, 1L);
    fixord = lsame_(ordsel, "F", 1L, 1L);
    istab = lsame_(weight, "I", 1L, 1L);
    ostab = lsame_(weight, "O", 1L, 1L);
    perf = lsame_(weight, "P", 1L, 1L);
    leftw = ostab || perf;
    rightw = istab || perf;
    frwght = leftw || rightw;
    lw = 1;
