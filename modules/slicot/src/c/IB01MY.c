...
/* Subroutine */ int ib01my_(meth, batch, conct, nobr, m, l, nsmp, u, ldu, y, ldy, r__, ldr, iwork, dwork, ldwork, iwarn, info, meth_len, batch_len, conct_len)
...
ftnlen conct_len;
{
    ...
    extern /* Subroutine */ int ma02fd_(), mb04id_(), dscal_(), mb04od_(), dlarf_(), dgemm_();
