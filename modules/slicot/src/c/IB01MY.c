...
/* Subroutine */ EXPORTSYMBOL int ib01my_(meth, batch, conct, nobr, m, l, nsmp, u, ldu, y, ldy, r__, ldr, iwork, dwork, ldwork, iwarn, info, meth_len, batch_len, conct_len)
...
ftnlen conct_len;
{
    ...
    integer r_dim1, r_offset, u_dim1, u_offset, y_dim1, y_offset, i__1, i__2, i__3, i__4;
    doublereal d__1;
    /* Builtin functions */
    double sqrt();
    /* Local variables */
    ...
    extern /* Subroutine */ EXPORTSYMBOL int ma02fd_(), mb04id_(), dscal_(), mb04od_(), dlarf_(), dgemm_();
    ...
    static integer ldrwrk, minwrk, maxwrk, nsmpsm, icj, ing, ipg, jds;
    ...
    *info = 0;
    ...
    if (last)
    {
        ...
        for (i__ = 1; i__ <= i__1; ++i__)
        {
            ...
            dcopy_(&nr, &dwork[ipg + imax - 1], &nrg, &dwork[ing + imax - 1], &nrg);
