...
integer *ldz, *info;
{
    ...
    *info = 0;
    ...
    dlaset_("All", &c__4, &c__4, &c_b5, &c_b5, li, &c__4, 3L);
    dlaset_("All", &c__4, &c__4, &c_b5, &c_b5, ir, &c__4, 3L);
    dlacpy_("Full", &m, &m, &a[a_offset], lda, s, &c__4, 4L);
    dlacpy_("Full", &m, &m, &b[b_offset], ldb, t, &c__4, 4L);
    /*     Compute threshold for testing acceptance of swapping. */
    eps = dlamch_("P", 1L);
    smlnum = dlamch_("S", 1L) / eps;
    dscale = 0.;
    dsum = 1.;
    dlacpy_("Full", &m, &m, s, &c__4, dwork, &m, 4L);
    i__1 = m * m;
    dlassq_(&i__1, dwork, &c__1, &dscale, &dsum);
    dlacpy_("Full", &m, &m, t, &c__4, dwork, &m, 4L);
    i__1 = m * m;
    dlassq_(&i__1, dwork, &c__1, &dscale, &dsum);
    ...
    if (m == 2) {
        ...
        /*        Update A and B. */
        dlacpy_("All", &m, &m, s, &c__4, &a[a_offset], lda, 3L);
        dlacpy_("All", &m, &m, t, &c__4, &b[b_offset], ldb, 3L);
        ...
        dlacpy_("All", &m, &m, li, &c__4, licop, &c__4, 3L);
        ...
        dlaset_("All", n1, n2, &c_b5, &c_b5, &s[*n2], &c__4, 3L);
        /*        Copy (S,T) to (A,B). */
        dlacpy_("All", &m, &m, s, &c__4, &a[a_offset], lda, 3L);
        dlacpy_("All", &m, &m, t, &c__4, &b[b_offset], ldb, 3L);
        dlaset_("All", &c__4, &c__4, &c_b5, &c_b5, t, &c__4, 3L);
