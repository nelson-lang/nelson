...
/* Subroutine */ int mb04yd_(jobu, jobv, m, n, rank, theta, q, e, u, ldu, v, ldv, inul, tol, reltol, dwork, ldwork, iwarn, info, jobu_len, jobv_len)
char *jobu, *jobv;
integer *m, *n, *rank;
...
ftnlen jobv_len;
{
    ...
    extern /* Subroutine */ int mb03md_(), dscal_();
    static doublereal x;
    static integer iascl;
    static doublereal sigma;
    extern logical lsame_();
    extern /* Subroutine */ int mb02ny_();
    static doublereal shift, sigmn;
    static integer maxit;
    extern /* Subroutine */ int mb04yw_();
