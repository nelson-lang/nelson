...
/* Subroutine */ EXPORTSYMBOL int mb04yd_(jobu, jobv, m, n, rank, theta, q, e, u, ldu, v, ldv, inul, tol, reltol, dwork, ldwork, iwarn, info, jobu_len, jobv_len)
char *jobu, *jobv;
integer *m, *n, *rank;
...
ftnlen jobv_len;
{
    ...
    static logical qrit;
    static integer info1, i__, j, k, p, r__;
    extern integer mb03nd_();
    extern /* Subroutine */ EXPORTSYMBOL int mb03md_(), dscal_();
    static doublereal x;
    static integer iascl;
    static doublereal sigma;
    extern logical lsame_();
    extern /* Subroutine */ EXPORTSYMBOL int mb02ny_();
    static doublereal shift, sigmn;
    static integer maxit;
    extern /* Subroutine */ EXPORTSYMBOL int mb04yw_();
    ...
    static doublereal tolabs, thresh, pivmin, tolrel, smlnum, eps;
    /*     SLICOT RELEASE 5.0. */
