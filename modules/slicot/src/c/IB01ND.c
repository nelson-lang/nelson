...
/* Subroutine */ int ib01nd_(meth, jobd, nobr, m, l, r__, ldr, sv, tol, iwork, dwork, ldwork, iwarn, info, meth_len, jobd_len)
char *meth, *jobd;
integer *nobr, *m, *l;
doublereal *r__;
integer *ldr;
...
ftnlen jobd_len;
{
    ...
    extern /* Subroutine */ int mb04id_(), mb03od_(), mb04od_(), mb03ud_();
    static logical jobdm;
    extern logical lsame_();
    extern /* Subroutine */ int mb04iy_();
