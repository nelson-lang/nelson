...
/* Subroutine */ EXPORTSYMBOL int ib01nd_(meth, jobd, nobr, m, l, r__, ldr, sv, tol, iwork, dwork, ldwork, iwarn, info, meth_len, jobd_len)
char *meth, *jobd;
integer *nobr, *m, *l;
doublereal *r__;
integer *ldr;
...
ftnlen jobd_len;
{
    ...
    extern /* Subroutine */ EXPORTSYMBOL int mb04id_(), mb03od_(), mb04od_(), mb03ud_();
    static logical jobdm;
    extern logical lsame_();
    extern /* Subroutine */ EXPORTSYMBOL int mb04iy_();
    ...
    *info = 0;
    ...
    else
    {
        ...
        if (*m > 0)
        {
            ...
            else
            {
                ...
                for (i__ = 1; i__ <= i__1; ++i__)
                {
                    ...
                    i__2 = mnobr - i__;
                    dcopy_(&i__2, dum, &c__0, &r__[i__ + 1 + i__ * r_dim1], &c__1);
                    iwork[i__] = 0;
                    /* L20: */
                }
                iwork[mnobr] = 0;
        ...
        if (rcond2 <= max(toll,thresh))
        {
            ...
            i__1 = lmnobr - 1;
            i__2 = lmnobr - 1;
            dlaset_("Lower", &i__1, &i__2, &c_b50, &c_b50, &r__[nr2 * r_dim1 + 2], ldr, 5L);
