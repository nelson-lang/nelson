...
C     parts (if there are any) are allocated on the top. The submatrices
C     A11, A22, B11, B22 and D12 are upper triangular. If D21 is 2-by-2,
C     then all other blocks are nonsingular and the product
C
C        -1        -1    -1        -1
