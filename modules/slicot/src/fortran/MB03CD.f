...
C     Spec(X,Y) denotes the spectrum of the matrix pencil (X,Y).
C
...
C             = 5: reordering of aAB - bD in the LAPACK routine DTGSEN
C                  failed because the transformed matrix pencil aAB - bD
