...
{
#endif
extern int mc01td_ ( const char *DICO, int *DP,const double *P, int *STABLE, int *NZ, double *DWORK, int *IWARN, int *INFO);
#ifdef __cplusplus
}
#endif
//=============================================================================
...
//=============================================================================
ArrayOfVector Nelson::SlicotGateway::slicot_mc01tdBuiltin(Evaluator* eval, int nLhs, const ArrayOfVector& argIn)
{
    ...
    // LOCAL VARIABLES
    ArrayOf DWORK = ArrayOf::doubleMatrix2dConstructor(1 , 2 * (int)P.getDimensions().getElementCount() + 2);
    ...
    try
    {
        mc01td_ ( DICO_ptr, DP_output_ptr, P_ptr, STABLE_output_ptr, NZ_output_ptr, DWORK_ptr, IWARN_output_ptr, INFO_output_ptr);
    }
