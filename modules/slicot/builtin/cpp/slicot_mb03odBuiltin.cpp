...
{
#endif
extern int mb03od_ ( const char *JOBQR, int *M, int *N, double *A, int *LDA, int *JPVT, double *RCOND, double *SVLMAX, double *TAU, int *RANK, double *SVAL, double *DWORK, int *LDWORK, int *INFO);
#ifdef __cplusplus
}
#endif
//=============================================================================
...
//=============================================================================
ArrayOfVector Nelson::SlicotGateway::slicot_mb03odBuiltin(Evaluator* eval, int nLhs, const ArrayOfVector& argIn)
{
    ...
    ArrayOf DWORK = ArrayOf::doubleMatrix2dConstructor(1 , 3 * (int)A.getDimensions().getColumns() + 1);
    ...
    Dimensions dimsA_expected(std::max(1, (int)A.getDimensions().getRows()), (int)A.getDimensions().getColumns());
    ...
    {
        Error(eval, _("Input argument #3: wrong size.") + " " + dimsJPVT_expected.toString() + " " + "expected" + ".");
    }
    ...
    try
    {
        mb03od_ ( JOBQR_ptr, M_ptr, N_ptr, A_output_ptr, LDA_ptr, JPVT_output_ptr, RCOND_ptr, SVLMAX_ptr, TAU_output_ptr, RANK_output_ptr, SVAL_output_ptr, DWORK_ptr, LDWORK_ptr, INFO_output_ptr);
    }
    catch (std::runtime_error &e)
    {
        e.what();
        Error(eval, "mb03od function fails.");
    }
