...
{
#endif
extern int mb03pd_ ( const char *JOBRQ, int *M, int *N, double *A, int *LDA, int *JPVT, double *RCOND, double *SVLMAX, double *TAU, int *RANK, double *SVAL, double *DWORK, int *INFO);
#ifdef __cplusplus
}
#endif
//=============================================================================
...
//=============================================================================
ArrayOfVector Nelson::SlicotGateway::slicot_mb03pdBuiltin(Evaluator* eval, int nLhs, const ArrayOfVector& argIn)
{
    ...
    try
    {
        mb03pd_ ( JOBRQ_ptr, M_ptr, N_ptr, A_output_ptr, LDA_ptr, JPVT_output_ptr, RCOND_ptr, SVLMAX_ptr, TAU_output_ptr, RANK_output_ptr, SVAL_output_ptr, DWORK_ptr, INFO_output_ptr);
    }
    catch (std::runtime_error &e)
    {
        e.what();
        Error(eval, "mb03pd function fails.");
    }
