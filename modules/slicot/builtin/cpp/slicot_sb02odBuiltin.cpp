...
ArrayOfVector Nelson::SlicotGateway::slicot_sb02odBuiltin(Evaluator* eval, int nLhs, const ArrayOfVector& argIn)
{
    ...
    ArrayOf S_output = ArrayOf::doubleMatrix2dConstructor((indexType)(JOBB.getContentAsCString().compare("B") == 0) ? std::max(1, 2 * (int)A.getDimensions().getRows()  + (int)B.getDimensions().getColumns()) : std::max(1, 2 * (int)A.getDimensions().getRows()), (indexType)(JOBB.getContentAsCString().compare("B") == 0) ? std::max(1, 2 * (int)A.getDimensions().getRows()  + (int)B.getDimensions().getColumns()) : std::max(1, 2 * (int)A.getDimensions().getRows()));
    double *S_output_ptr = (double*)S_output.getDataPointer();
    ArrayOf T_output = ArrayOf::doubleMatrix2dConstructor((indexType)(JOBB.getContentAsCString().compare("B") == 0) ? std::max(1, 2 * (int)A.getDimensions().getRows() + (int)B.getDimensions().getColumns()) : (DICO.getContentAsCString().compare("D") == 0) ? std::max(1, 2 * (int)A.getDimensions().getRows()) : 1, (indexType)2 * (int)A.getDimensions().getRows());
