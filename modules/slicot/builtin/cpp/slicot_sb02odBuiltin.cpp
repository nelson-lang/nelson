...
Nelson::SlicotGateway::slicot_sb02odBuiltin(int nLhs, const ArrayOfVector& argIn)
{
    ...
    if (!dimsTOL.isScalar()) {
        raiseError(L"Nelson:slicot:ERROR_SLICOT_INPUT_ARGUMENT_13_SCALAR_EXPECTED",
            ERROR_SLICOT_INPUT_ARGUMENT_13_SCALAR_EXPECTED);
    }
    ...
    try {
        ...
        raiseError(L"Nelson:slicot:ERROR_SLICOT_SB02OD_FUNCTION_FAILS",
            ERROR_SLICOT_SB02OD_FUNCTION_FAILS);
    }
