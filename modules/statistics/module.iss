...
Source: {#RootPath}modules\{#MODULE_NAME}\functions\@tdigest\*.m; DestDir: {app}\modules\{#MODULE_NAME}\functions\@tdigest\;Components: {#COMPONENT_STATISTICS};
;==============================================================================
Source: {#RootPath}modules\{#MODULE_NAME}\help\*.nhz; DestDir: {app}\modules\{#MODULE_NAME}\help\; Flags: recursesubdirs;Components: {#COMPONENT_STATISTICS} and {#COMPONENT_HELP_FILES};
;==============================================================================
