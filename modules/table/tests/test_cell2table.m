...
T = cell2table(C);
P = properties(T);
REF_P = {'C1'; 'C2'; 'C3'; 'C4'; 'Properties'; 'Row'; 'Variable' };
...
P = properties(T);
REF_P = {'Calories'; 'Food'; 'Price'; 'NutritionGrade'; 'Properties'; 'Row'; 'Variable' };
assert_isequal(P, REF_P);
...
T = cell2table(D);
P = properties(T);
REF_P = {'D1'; 'D2'; 'Properties'; 'Row'; 'Variable' };
assert_isequal(P, REF_P);
...
T = cell2table(C);
P = properties(T);
REF_P = {'C1'; 'C2'; 'Properties'; 'Row'; 'Variable' };
assert_isequal(P, REF_P);
