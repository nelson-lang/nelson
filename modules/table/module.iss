...
;==============================================================================
;Source: {#RootPath}bin\{#BinPath}\libnlsTable.dll; DestDir: {app}\bin\{#BinPath}\;
;Source: {#RootPath}bin\{#BinPath}\libnlsTable_builtin.dll; DestDir: {app}\bin\{#BinPath}\;
;==============================================================================
...
Source: {#RootPath}modules\{#MODULE_NAME}\functions\@table\*.m; DestDir: {app}\modules\{#MODULE_NAME}\functions\@table\;
Source: {#RootPath}modules\{#MODULE_NAME}\functions\@table\private\*.m; DestDir: {app}\modules\{#MODULE_NAME}\functions\@table\private\;
Source: {#RootPath}modules\{#MODULE_NAME}\functions\@vartype\*.m; DestDir: {app}\modules\{#MODULE_NAME}\functions\@vartype\;
;==============================================================================
