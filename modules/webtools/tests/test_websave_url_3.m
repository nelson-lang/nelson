...
% LICENCE_BLOCK_END
%=============================================================================
% Replace fragile single-attempt websave with retries and better handling
o = weboptions('RequestMethod', 'get', 'ArrayFormat', 'json', 'Timeout', 30);
filename = fullfile(tempdir(), 'test_websave_args_3.json');
M = [1 2 3; 4 5 6];
