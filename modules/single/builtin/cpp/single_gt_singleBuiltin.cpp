...
//=============================================================================
ArrayOfVector Nelson::SingleGateway::single_gt_singleBuiltin(Evaluator* eval, int nLhs, const ArrayOfVector& argIn)
{
    if (argIn.size() != 2)
    {
    ...
    {
        bool bSuccess = false;
        res = OverloadBinaryOperator(eval, A, B, "gt", bSuccess, "scomplex_gt_scomplex");
        if (!bSuccess)
        {
