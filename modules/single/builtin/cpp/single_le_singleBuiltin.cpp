...
//=============================================================================
ArrayOfVector Nelson::SingleGateway::single_le_singleBuiltin(Evaluator* eval, int nLhs, const ArrayOfVector& argIn)
{
    if (argIn.size() != 2)
    {
    ...
    {
        bool bSuccess = false;
        res = OverloadBinaryOperator(eval, A, B, "le", bSuccess, "scomplex_le_scomplex");
        if (!bSuccess)
        {
