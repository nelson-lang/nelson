...
//=============================================================================
ArrayOfVector Nelson::SingleGateway::single_ne_singleBuiltin(Evaluator* eval, int nLhs, const ArrayOfVector& argIn)
{
    if (argIn.size() != 2)
    {
    ...
    {
        bool bSuccess = false;
        res = OverloadBinaryOperator(eval, A, B, "ne", bSuccess, "scomplex_ne_scomplex");
        if (!bSuccess)
        {
