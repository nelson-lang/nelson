...
namespace Nelson {
    ...
    //=============================================================================
    void DateVector(double dateSerial, double &Y, double &M, double &D, double &H, double &MN, double &S, bool rf)
    {
        double ts = 0.;
        ...
        else
        {
            ...
            {
                y = y - 1.;
                dateSerial = dateSerial - (365.0*y + ceil(0.25*y) - ceil(0.01*y) + ceil(0.0025*y));
            }
            else
            {
                dateSerial = ts;
