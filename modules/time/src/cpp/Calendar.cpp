...
#define NBR_WEEK_IN_A_MONTH_MAX 6
    ...
    //=============================================================================
    std::wstring Calendar::getAsFormatedText()
    {
        boost::gregorian::date d1 { (boost::gregorian::gregorian_calendar::year_type)(unsigned short)y, (boost::gregorian::gregorian_calendar::month_type)m, 1 };
    ...
    //=============================================================================
    ArrayOf Calendar::get()
    {
        boost::gregorian::date d1 { (boost::gregorian::gregorian_calendar::year_type)(unsigned short)y, (boost::gregorian::gregorian_calendar::month_type)m, 1 };
        boost::gregorian::date d2 { d1.end_of_month() };
        boost::gregorian::date_period month_period(d1, d2);
        double *Month = (double*)ArrayOf::allocateArrayOf(NLS_DOUBLE, NBR_DAY_IN_A_WEEK * NBR_WEEK_IN_A_MONTH_MAX);
        double v = 1;
        uint8 firstdate = (uint8)(d1.day_of_week().as_number());
        uint8 lastdate = (uint8)(month_period.length().days() + firstdate);
    ...
    //=============================================================================
    wstringVector Calendar::getNameOfDays()
    {
        wstringVector names;
    ...
    //=============================================================================
    std::wstring Calendar::getMonthName()
    {
    ...
    //=============================================================================
    uint64 Calendar::getYear()
    {
        return this->y;
    }
    //=============================================================================
    uint8 Calendar::getMonth()
    {
        return this->m;
    }
    //=============================================================================
