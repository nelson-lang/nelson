...
//=============================================================================
static indexType
numel(boost::container::vector<double> d)
{
    indexType res = 0;
    for (indexType k = 0; k < d.size(); k++) {
        if (k == 0) {
            res = (indexType)d[k];
        } else {
            res = res * (indexType)d[k];
		}
    }
    return res;
}
...
//=============================================================================
void hdf5Create(std::wstring filename, std::wstring dataSetName,
    ...
    bool shuffle, std::wstring textEncoding)
{
