...
Source: {#RootPath}modules\{#MODULE_NAME}\tests\*.nh5; DestDir: {app}\modules\{#MODULE_NAME}\tests\; Flags: recursesubdirs;Components: {#COMPONENT_UNIT_TESTS};
Source: {#RootPath}modules\{#MODULE_NAME}\tests\h5\*.h5; DestDir: {app}\modules\{#MODULE_NAME}\tests\h5\;Components: {#COMPONENT_UNIT_TESTS};
;==============================================================================
