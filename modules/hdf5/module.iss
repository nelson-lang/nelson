...
Source: {#RootPath}modules\{#MODULE_NAME}\tests\*.nh5; DestDir: {app}\modules\{#MODULE_NAME}\tests\; Flags: recursesubdirs
Source: {#RootPath}modules\{#MODULE_NAME}\tests\h5\*.h5; DestDir: {app}\modules\{#MODULE_NAME}\tests\h5\;
;==============================================================================
