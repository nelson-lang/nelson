...
namespace Nelson {
    //=============================================================================
    static boost::container::vector<std::wstring> splitEnvironmentPath(std::wstring envPaths)
    {
    ...
    //=============================================================================
    std::wstring concateEnvironmentPath(boost::container::vector<std::wstring> listPath)
    {
        std::wstring res = L"";
    ...
    InputIterator localfind(InputIterator first, InputIterator last, const T& val)
    {
        while (first != last)
        {
            if (*first == val)
    ...
    //=============================================================================
    bool AddPathToEnvironmentVariable(std::wstring envVar, std::wstring pathToAdd)
    {
        std::wstring env;
#ifdef _MSC_VER
