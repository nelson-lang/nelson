...
static const nlsGateway gateway[] = {
    ...
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_AUDIOPLAYER_CATEGORY_STR, "display"),
        (ptrBuiltin)Nelson::AudioGateway::audioplayer_displayBuiltin, 0, 2,
        CPP_BUILTIN_WITH_EVALUATOR },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_AUDIOPLAYER_CATEGORY_STR, "disp"),
        (ptrBuiltin)Nelson::AudioGateway::audioplayer_displayBuiltin, 0, 1,
        CPP_BUILTIN_WITH_EVALUATOR },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_AUDIOPLAYER_CATEGORY_STR, "delete"),
        (ptrBuiltin)Nelson::AudioGateway::audioplayer_deleteBuiltin, 0, 1 },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_AUDIOPLAYER_CATEGORY_STR, "isvalid"),
        (ptrBuiltin)Nelson::AudioGateway::audioplayer_isvalidBuiltin, 1, 1,
        CPP_BUILTIN_WITH_EVALUATOR },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_AUDIOPLAYER_CATEGORY_STR, "fieldnames"),
        (ptrBuiltin)Nelson::AudioGateway::audioplayer_fieldnamesBuiltin, 1, 1 },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_AUDIOPLAYER_CATEGORY_STR, "properties"),
        (ptrBuiltin)Nelson::AudioGateway::audioplayer_propertiesBuiltin, 1, 1 },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_AUDIOPLAYER_CATEGORY_STR, "get"),
        (ptrBuiltin)Nelson::AudioGateway::audioplayer_getBuiltin, 1, 2 },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_AUDIOPLAYER_CATEGORY_STR, "set"),
        (ptrBuiltin)Nelson::AudioGateway::audioplayer_setBuiltin, 0, 3 },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_AUDIOPLAYER_CATEGORY_STR, "play"),
        (ptrBuiltin)Nelson::AudioGateway::audioplayer_playBuiltin, 0, -1,
        CPP_BUILTIN_WITH_EVALUATOR },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_AUDIOPLAYER_CATEGORY_STR, "playblocking"),
        (ptrBuiltin)Nelson::AudioGateway::audioplayer_playblockingBuiltin, 0, -1,
        CPP_BUILTIN_WITH_EVALUATOR },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_AUDIOPLAYER_CATEGORY_STR, "pause"),
        (ptrBuiltin)Nelson::AudioGateway::audioplayer_pauseBuiltin, 0, 1 },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_AUDIOPLAYER_CATEGORY_STR, "resume"),
        (ptrBuiltin)Nelson::AudioGateway::audioplayer_resumeBuiltin, 0, 1 },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_AUDIOPLAYER_CATEGORY_STR, "stop"),
        (ptrBuiltin)Nelson::AudioGateway::audioplayer_stopBuiltin, 0, 1 },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_AUDIOPLAYER_CATEGORY_STR, "used"),
        (ptrBuiltin)Nelson::AudioGateway::audioplayer_usedBuiltin, 1, 0 },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_AUDIOPLAYER_CATEGORY_STR, "isprop"),
        (ptrBuiltin)Nelson::AudioGateway::audioplayer_ispropBuiltin, 1, 2 },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_AUDIOPLAYER_CATEGORY_STR, "ismethod"),
        (ptrBuiltin)Nelson::AudioGateway::audioplayer_ismethodBuiltin, 1, 2 },
