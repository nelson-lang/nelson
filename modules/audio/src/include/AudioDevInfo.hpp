...
namespace Nelson {
    ...
    NLSAUDIO_IMPEXP ArrayOf AudioDevInfoDefault(std::wstring &errorMessage);
    ...
    NLSAUDIO_IMPEXP void clearAudioDevicesInfo();
    NLSAUDIO_IMPEXP void retrieveAudioDevicesInfo();
}
//=============================================================================
