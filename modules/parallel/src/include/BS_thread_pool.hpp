...
/**
 * @brief Explicit casts of the flushing stream manipulators, to enable using them with
 * synced_stream, e.g. sync_out.print(BS::flush).
 */
// std::ostream& (&endl)(std::ostream&) = static_cast<std::ostream& (&)(std::ostream&)>(std::endl);
// std::ostream& (&flush)(std::ostream&) = static_cast<std::ostream&
// (&)(std::ostream&)>(std::flush);
...
public:
     ...
     * executed will keep running until they are finished. Set to false again to resume retrieving
     * tasks.
     */
