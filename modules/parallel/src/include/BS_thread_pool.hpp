...
public:
     ...
     * index_after_last, no blocks will be submitted.
     ...
     * loop function returns a value, the multi_future object can be used to obtain the values
