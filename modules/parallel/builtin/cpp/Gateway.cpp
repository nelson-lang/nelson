...
static const nlsGateway gateway[] = {
    ...
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_BACKGROUNDPOOL_CATEGORY_STR, "disp"),
        (ptrBuiltin)Nelson::ParallelGateway::backgroundPool_dispBuiltin, 0, 1,
        CPP_BUILTIN_WITH_EVALUATOR },
    ...
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_FEVALQUEUE_CATEGORY_STR, "disp"),
        (ptrBuiltin)Nelson::ParallelGateway::FevalQueue_dispBuiltin, 0, 1,
        CPP_BUILTIN_WITH_EVALUATOR },
    ...
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_FEVALFUTURE_CATEGORY_STR, "disp"),
        (ptrBuiltin)Nelson::ParallelGateway::Future_dispBuiltin, 0, 1, CPP_BUILTIN_WITH_EVALUATOR },
