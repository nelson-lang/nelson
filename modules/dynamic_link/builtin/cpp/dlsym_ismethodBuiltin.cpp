...
//=============================================================================
ArrayOfVector Nelson::DynamicLinkGateway::dlsym_ismethodBuiltin(Evaluator* eval, int nLhs, const ArrayOfVector& argIn)
{
    if (argIn.size() != 2)
    {
    ...
    ArrayOf res = ArrayOf::logicalConstructor(objDlsym->ismethod(propertyName));
