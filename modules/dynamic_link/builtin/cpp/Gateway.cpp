...
static const nlsGateway gateway[] = {
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_DLSYM_CATEGORY_STR, "display"),
    ...
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_DLSYM_CATEGORY_STR, "get"),
        (ptrBuiltin)Nelson::DynamicLinkGateway::dlsym_getBuiltin, 1, 2 },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_DLSYM_CATEGORY_STR, "isprop"),
        (ptrBuiltin)Nelson::DynamicLinkGateway::dlsym_ispropBuiltin, 1, 2 },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_DLSYM_CATEGORY_STR, "ismethod"),
    ...
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_DLLIB_CATEGORY_STR, "isprop"),
    ...
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_DLLIB_CATEGORY_STR, "display"),
