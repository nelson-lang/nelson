...
static const nlsGateway gateway[] = {
    { OVERLOAD_METHOD_NAME(DLSYM_CATEGORY_STR, "display"),
        (ptrBuiltin)Nelson::DynamicLinkGateway::dlsym_displayBuiltin, 0, 2,
        CPP_BUILTIN_WITH_EVALUATOR },
    { OVERLOAD_METHOD_NAME(DLSYM_CATEGORY_STR, "disp"),
        (ptrBuiltin)Nelson::DynamicLinkGateway::dlsym_displayBuiltin, 0, 1,
        CPP_BUILTIN_WITH_EVALUATOR },
    { OVERLOAD_METHOD_NAME(DLSYM_CATEGORY_STR, "isvalid"),
    ...
    { OVERLOAD_METHOD_NAME(DLSYM_CATEGORY_STR, "get"),
        (ptrBuiltin)Nelson::DynamicLinkGateway::dlsym_getBuiltin, 1, 2 },
    { OVERLOAD_METHOD_NAME(DLSYM_CATEGORY_STR, "isprop"),
        (ptrBuiltin)Nelson::DynamicLinkGateway::dlsym_ispropBuiltin, 1, 2 },
    { OVERLOAD_METHOD_NAME(DLSYM_CATEGORY_STR, "ismethod"),
        (ptrBuiltin)Nelson::DynamicLinkGateway::dlsym_ismethodBuiltin, 1, 2 },
    { OVERLOAD_METHOD_NAME(DLSYM_CATEGORY_STR, "fieldnames"),
        (ptrBuiltin)Nelson::DynamicLinkGateway::dlsym_fieldnamesBuiltin, 1, 1 },
    { OVERLOAD_METHOD_NAME(DLSYM_CATEGORY_STR, "used"),
        (ptrBuiltin)Nelson::DynamicLinkGateway::dlsym_usedBuiltin, 1, 0 },
    { OVERLOAD_METHOD_NAME(DLSYM_CATEGORY_STR, "delete"),
        (ptrBuiltin)Nelson::DynamicLinkGateway::dlsym_deleteBuiltin, 0, 1 },
    { OVERLOAD_METHOD_NAME(DLLIB_CATEGORY_STR, "get"),
        (ptrBuiltin)Nelson::DynamicLinkGateway::dllib_getBuiltin, 1, 2 },
    { OVERLOAD_METHOD_NAME(DLLIB_CATEGORY_STR, "isprop"),
        (ptrBuiltin)Nelson::DynamicLinkGateway::dllib_ispropBuiltin, 1, 2 },
    { OVERLOAD_METHOD_NAME(DLLIB_CATEGORY_STR, "ismethod"),
        (ptrBuiltin)Nelson::DynamicLinkGateway::dllib_ismethodBuiltin, 1, 2 },
    { OVERLOAD_METHOD_NAME(DLLIB_CATEGORY_STR, "used"),
        (ptrBuiltin)Nelson::DynamicLinkGateway::dllib_usedBuiltin, 1, 0 },
    { OVERLOAD_METHOD_NAME(DLLIB_CATEGORY_STR, "delete"),
        (ptrBuiltin)Nelson::DynamicLinkGateway::dlcloseBuiltin, 0, 1 },
    { OVERLOAD_METHOD_NAME(DLLIB_CATEGORY_STR, "fieldnames"),
        (ptrBuiltin)Nelson::DynamicLinkGateway::dllib_fieldnamesBuiltin, 1, 1 },
    { OVERLOAD_METHOD_NAME(DLLIB_CATEGORY_STR, "display"),
        (ptrBuiltin)Nelson::DynamicLinkGateway::dllib_displayBuiltin, 0, 2,
        CPP_BUILTIN_WITH_EVALUATOR },
    { OVERLOAD_METHOD_NAME(DLLIB_CATEGORY_STR, "disp"),
        (ptrBuiltin)Nelson::DynamicLinkGateway::dllib_displayBuiltin, 0, 1,
        CPP_BUILTIN_WITH_EVALUATOR },
    { OVERLOAD_METHOD_NAME(DLLIB_CATEGORY_STR, "isvalid"),
