...
//=============================================================================
namespace Nelson {
    void RemoveGateway(Evaluator* eval, std::wstring dynlibname)
    {
        ...
        if (nlsModuleHandleDynamicLibrary)
        {
            ...
            PROC_RemoveGateway RemoveGatewayPtr = reinterpret_cast<PROC_RemoveGateway>(get_function(nlsModuleHandleDynamicLibrary, REMOVEGATEWAY_ENTRY));
        ...
        {
            boost::filesystem::current_path(currentdirbackup);
            Error(eval, _W("Module not loaded: library not loaded."));
        }
    }
    //=============================================================================
}
