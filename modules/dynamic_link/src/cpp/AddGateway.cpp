...
//=============================================================================
namespace Nelson {
    void AddGateway(Evaluator* eval, std::wstring dynlibname)
    {
        ...
        else
        {
            ...
            if (nlsModuleHandleDynamicLibrary)
            {
                ...
                PROC_AddGateway AddGatewayPtr = reinterpret_cast<PROC_AddGateway>(get_function(nlsModuleHandleDynamicLibrary, GATEWAY_ENTRY));
