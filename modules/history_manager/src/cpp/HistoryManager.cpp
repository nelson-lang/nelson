...
#define DEFAULT_SAVEAFTERNCOMMANDS 0
    ...
    //=============================================================================
    void HistoryManager::setSaveEnabled(bool bSave)
    {
        bSaveEnabled = bSave;
    }
    //=============================================================================
    bool HistoryManager::getSaveEnabled()
    {
        return bSaveEnabled;
    }
    //=============================================================================
    void HistoryManager::setRemoveExit(bool bRemove)
    {
        bRemoveExit = bRemove;
    }
    //=============================================================================
    bool HistoryManager::getRemoveExit()
    {
        return bRemoveExit;
    }
    //=============================================================================
    void HistoryManager::setAllowDuplicatedLines(bool bAllow)
    {
        bAllowDuplicatedLines = bAllow;
    }
    //=============================================================================
    bool HistoryManager::getAllowDuplicatedLines(void)
    {
        return bAllowDuplicatedLines;
    }
    //=============================================================================
    void HistoryManager::setSaveAfterNCommands(size_t nLines)
    {
        saveAfterNCommands = nLines;
    }
    //=============================================================================
    size_t HistoryManager::getSaveAfterNCommands(void)
    {
        return saveAfterNCommands;
    }
    //=============================================================================
    void HistoryManager::setLastNCommandsSize(size_t newsize)
    {
        if (newsize == 0)
        {
            saveLastNCommands = DEFAULT_SAVELASTNCOMMANDS;
    ...
    //=============================================================================
    size_t HistoryManager::getLastNCommandsSize(void)
    {
        return saveLastNCommands;
    }
    //=============================================================================
    bool HistoryManager::appendHeader()
    {
        std::wstring pre = L"%% -- ";
        std::wstring post = L" -- %%";
#ifdef __GNUC__
    ...
    //=============================================================================
    bool HistoryManager::appendLine(std::wstring line)
    {
        wstringVector strs;
    ...
    //=============================================================================
    bool HistoryManager::appendLines(wstringVector lines)
    {
        for (size_t k = 0; k < lines.size(); k++)
        {
            if ((lines[k] != L"\n") && (lines[k] != L""))
    ...
    //=============================================================================
    bool HistoryManager::remove(size_t pos)
    {
        if (commands.size() > 0)
        {
    ...
    //=============================================================================
    bool HistoryManager::remove(size_t firstpos, size_t lastpos)
    {
        if (commands.size() > 0)
        {
    ...
    //=============================================================================
    size_t HistoryManager::getCurrentSize()
    {
        return commands.size();
    }
    //=============================================================================
    std::wstring HistoryManager::getFirstLine(void)
    {
        std::wstring line = L"";
        if (!commands.empty())
        {
    ...
    //=============================================================================
    std::wstring HistoryManager::getLastLine(void)
    {
        std::wstring line = L"";
        if (!commands.empty())
        {
    ...
    //=============================================================================
    wstringVector HistoryManager::get()
    {
        wstringVector res = commands;
        return res;
    }
    //=============================================================================
    std::wstring HistoryManager::get(size_t pos)
    {
        if (commands.size() > 0)
        {
            return commands[pos];
    ...
    //=============================================================================
    wstringVector HistoryManager::get(size_t firstpos, size_t lastpos)
    {
        wstringVector res;
        if (commands.size() > 0)
        {
    ...
    //=============================================================================
    std::wstring HistoryManager::getPreviousLine(void)
    {
        std::wstring line = L"";
    ...
    //=============================================================================
    std::wstring HistoryManager::getNextLine(void)
    {
        std::wstring line = L"";
        if (token == L"")
        {
    ...
    //=============================================================================
    bool HistoryManager::loadFromFile(std::wstring filename)
    {
        commands.clear();
    ...
    //=============================================================================
    bool HistoryManager::setFilename(std::wstring filename)
    {
        this->filename = filename;
        return true;
    }
    //=============================================================================
    std::wstring HistoryManager::getFilename()
    {
        return this->filename;
    }
    //=============================================================================
    bool HistoryManager::clear(bool bWithHeader)
    {
        commands.clear();
        token = L"";
        token_position = 0;
    ...
    //=============================================================================
    size_t HistoryManager::getNumberOfLines(void)
    {
        return commands.size();
    }
    //=============================================================================
    std::wstring HistoryManager::getNthLine(size_t N)
    {
        std::wstring res = L"";
        if (N < commands.size())
        {
    ...
    //=============================================================================
    bool HistoryManager::setToken(std::wstring token)
    {
        this->token = token;
        tokens_found.clear();
        if (token != L"")
    ...
    //=============================================================================
    bool HistoryManager::copyPreviousFile(std::wstring filename)
    {
    ...
    //=============================================================================
    bool HistoryManager::detectExit(std::wstring line)
    {
    ...
    //=============================================================================
    bool HistoryManager::saveToFile(std::wstring filename)
    {
        if (bSaveEnabled)
        {
