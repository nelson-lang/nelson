...
static const nlsGateway gateway[] = {
    ...
    { "QObject_properties", (void*)Nelson::QmlEngineGateway::QObject_propertiesBuiltin, 1, 1,
        CPP_BUILTIN_WITH_EVALUATOR },
    { "qml_loadfile", (void*)Nelson::QmlEngineGateway::qml_loadfileBuiltin, 1, 1, CPP_BUILTIN },
    { "qml_loadstring", (void*)Nelson::QmlEngineGateway::qml_loadstringBuiltin, 1, 1, CPP_BUILTIN },
    { "qml_evaluatestring", (void*)Nelson::QmlEngineGateway::qml_evaluatestringBuiltin, 1, 1,
        CPP_BUILTIN },
    { "qml_evaluatefile", (void*)Nelson::QmlEngineGateway::qml_evaluatefileBuiltin, 1, 1, CPP_BUILTIN },
    { "qml_clearcomponentcache", (void*)Nelson::QmlEngineGateway::qml_clearcomponentcacheBuiltin, 0, 0,
        CPP_BUILTIN },
    ...
    { "qml_pluginpathlist", (void*)Nelson::QmlEngineGateway::qml_pluginpathlistBuiltin, 1, 0,
        CPP_BUILTIN },
    { "qml_offlinestoragepath", (void*)Nelson::QmlEngineGateway::qml_offlinestoragepathBuiltin, 1, 0,
        CPP_BUILTIN },
    { "qml_setofflinestoragepath", (void*)Nelson::QmlEngineGateway::qml_setofflinestoragepathBuiltin, 0, 1,
        CPP_BUILTIN },
    { "qml_addimportpath", (void*)Nelson::QmlEngineGateway::qml_addimportpathBuiltin, 0, 1, CPP_BUILTIN },
    { "qml_addpluginpath", (void*)Nelson::QmlEngineGateway::qml_addpluginpathBuiltin, 0, 1, CPP_BUILTIN },
    { "qml_createqquickview", (void*)Nelson::QmlEngineGateway::qml_createqquickviewBuiltin, 1, 1,
        CPP_BUILTIN },
    { "QObject_undefine", (void*)Nelson::QmlEngineGateway::QObject_undefineBuiltin, 0, 2, CPP_BUILTIN },
    { "QObject_delete", (void*)Nelson::QmlEngineGateway::QObject_deleteBuiltin, 0, 1, CPP_BUILTIN },
    { "QObject_disp", (void*)Nelson::QmlEngineGateway::QObject_dispBuiltin, 0, 1,
        CPP_BUILTIN_WITH_EVALUATOR },
    { "QObject_get", (void*)Nelson::QmlEngineGateway::QObject_getBuiltin, 1, 2, CPP_BUILTIN },
    { "QObject_set", (void*)Nelson::QmlEngineGateway::QObject_setBuiltin, 1, 3, CPP_BUILTIN },
    { "QObject_fieldnames", (void*)Nelson::QmlEngineGateway::QObject_fieldnamesBuiltin, 1, 1,
        CPP_BUILTIN },
    { "QObject_methods", (void*)Nelson::QmlEngineGateway::QObject_methodsBuiltin, 1, 1, CPP_BUILTIN },
    { "QObject_invoke", (void*)Nelson::QmlEngineGateway::QObject_invokeBuiltin, -1, -2, CPP_BUILTIN },
    { "QObject_isprop", (void*)Nelson::QmlEngineGateway::QObject_ispropBuiltin, 1, 2, CPP_BUILTIN },
    { "QObject_ismethod", (void*)Nelson::QmlEngineGateway::QObject_ismethodBuiltin, 1, 2, CPP_BUILTIN },
    { "QObject_methodsignature", (void*)Nelson::QmlEngineGateway::QObject_methodsignatureBuiltin, 1, 2,
        CPP_BUILTIN },
    ...
    { "QObject_iswindowtype", (void*)Nelson::QmlEngineGateway::QObject_iswindowtypeBuiltin, 1, 1,
        CPP_BUILTIN },
    { "QObject_classname", (void*)Nelson::QmlEngineGateway::QObject_classnameBuiltin, 1, 1, CPP_BUILTIN },
    { "QObject_root", (void*)Nelson::QmlEngineGateway::QObject_rootBuiltin, 1, 0, CPP_BUILTIN },
    { "QObject_findchildren", (void*)Nelson::QmlEngineGateway::QObject_findchildrenBuiltin, 1, 2,
        CPP_BUILTIN },
    { "QObject_used", (void*)Nelson::QmlEngineGateway::QObject_usedBuiltin, 1, 0, CPP_BUILTIN },
};
//=============================================================================
static bool
