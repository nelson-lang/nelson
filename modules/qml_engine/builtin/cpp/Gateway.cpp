...
static const nlsGateway gateway[] = {
    ...
    { "qml_createqquickview", (ptrBuiltin)Nelson::QmlEngineGateway::qml_createqquickviewBuiltin, 1,
        1 },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_QOBJECT_CATEGORY_STR, "isvalid"),
        (ptrBuiltin)Nelson::QmlEngineGateway::QObject_isvalidBuiltin, 1, 1,
        CPP_BUILTIN_WITH_EVALUATOR },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_QOBJECT_CATEGORY_STR, "properties"),
        (ptrBuiltin)Nelson::QmlEngineGateway::QObject_propertiesBuiltin, 1, 1,
        CPP_BUILTIN_WITH_EVALUATOR },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_QOBJECT_CATEGORY_STR, "undefine"),
        (ptrBuiltin)Nelson::QmlEngineGateway::QObject_undefineBuiltin, 0, 2 },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_QOBJECT_CATEGORY_STR, "delete"),
        (ptrBuiltin)Nelson::QmlEngineGateway::QObject_deleteBuiltin, 0, 1 },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_QOBJECT_CATEGORY_STR, "display"),
    ...
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_QOBJECT_CATEGORY_STR, "set"),
        (ptrBuiltin)Nelson::QmlEngineGateway::QObject_setBuiltin, 1, 3 },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_QOBJECT_CATEGORY_STR, "fieldnames"),
        (ptrBuiltin)Nelson::QmlEngineGateway::QObject_fieldnamesBuiltin, 1, 1 },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_QOBJECT_CATEGORY_STR, "methods"),
        (ptrBuiltin)Nelson::QmlEngineGateway::QObject_methodsBuiltin, 1, 1 },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_QOBJECT_CATEGORY_STR, "invoke"),
        (ptrBuiltin)Nelson::QmlEngineGateway::QObject_invokeBuiltin, -1, -2 },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_QOBJECT_CATEGORY_STR, "isprop"),
        (ptrBuiltin)Nelson::QmlEngineGateway::QObject_ispropBuiltin, 1, 2 },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_QOBJECT_CATEGORY_STR, "ismethod"),
        (ptrBuiltin)Nelson::QmlEngineGateway::QObject_ismethodBuiltin, 1, 2 },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_QOBJECT_CATEGORY_STR, "methodsignature"),
        (ptrBuiltin)Nelson::QmlEngineGateway::QObject_methodsignatureBuiltin, 1, 2 },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_QOBJECT_CATEGORY_STR, "iswidgettype"),
        (ptrBuiltin)Nelson::QmlEngineGateway::QObject_iswidgettypeBuiltin, 1, 1 },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_QOBJECT_CATEGORY_STR, "iswindowtype"),
        (ptrBuiltin)Nelson::QmlEngineGateway::QObject_iswindowtypeBuiltin, 1, 1 },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_QOBJECT_CATEGORY_STR, "classname"),
        (ptrBuiltin)Nelson::QmlEngineGateway::QObject_classnameBuiltin, 1, 1 },
    { OVERLOAD_METHOD_NAME(NLS_HANDLE_QOBJECT_CATEGORY_STR, "root"),
