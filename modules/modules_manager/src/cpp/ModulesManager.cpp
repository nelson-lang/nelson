...
#define MODULETAB 4096
    ...
    //=============================================================================
    wstringVector ModulesManager::getModulesPathList(bool bReverse)
    {
    ...
    //=============================================================================
    wstringVector ModulesManager::getModulesList(bool bReverse)
    {
        wstringVector retlist;
        if (bReverse)
        {
    ...
    //=============================================================================
    void ModulesManager::insertModule(const std::wstring& modulename, const std::wstring& path)
    {
    ...
    //=============================================================================
    bool ModulesManager::deleteModule(const std::wstring& modulename)
    {
    ...
    //=============================================================================
    bool ModulesManager::findModule(const std::wstring& modulename, std::wstring& path)
    {
        auto it = std::find_if(modulesMap.begin(), modulesMap.end(),
                               [&modulename](std::pair<std::wstring, std::wstring> const& elem)
        {
    ...
    //=============================================================================
    boost::container::vector<module> GetModules(bool bReverse)
    {
    ...
    //=============================================================================
    wstringVector GetModulesName(bool bReverse)
    {
        return ModulesManager::Instance().getModulesList(bReverse);
    }
    //=============================================================================
    wstringVector GetModulesPath(bool bReverse)
    {
