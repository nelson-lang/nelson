...
Source: {#RootPath}modules\{#MODULE_NAME}\tests\xml_linkchecker\*.xml; DestDir: {app}\modules\{#MODULE_NAME}\tests\xml_linkchecker; Flags: recursesubdirs;Components: {#COMPONENT_HELP_TOOLS} and {#COMPONENT_TESTS_MANAGER} and {#COMPONENT_UNIT_TESTS};
