...
char*
cmark_render(cmark_node* root, int options, int width,
        ...
        cmark_renderer* renderer, cmark_node* node, cmark_event_type ev_type, int options))
{
    ...
    cmark_renderer renderer = { options, mem, &buf, &pref, 0, width, 0, 0, true, true, false, false,
        NULL, outc, S_cr, S_blankline, S_out };
