...
namespace Nelson {
    //=============================================================================
    QtHelpProject::QtHelpProject(std::wstring destdirectory, std::wstring mainTitle, std::wstring name_space, std::wstring virtualfolder)
    {
    ...
    //=============================================================================
    std::wstring QtHelpProject::getFilename()
    {
        return this->filenameDestination;
    }
    //=============================================================================
    void QtHelpProject::assembleContent()
    {
        this->utf8stream = this->utf8stream + "<?xml version = \"1.0\" encoding = \"UTF-8\"?>" + std::string("\n");
        this->utf8stream = this->utf8stream + "<QtHelpProject version = \"1.0\">" + std::string("\n");
        this->utf8stream = this->utf8stream + "<namespace>" + wstring_to_utf8(this->name_space) + "</namespace>" + std::string("\n");
        this->utf8stream = this->utf8stream + "<virtualFolder>" + wstring_to_utf8(this->virtualfolder) + "</virtualFolder>" + std::string("\n");
        this->utf8stream = this->utf8stream + "<customFilter name = \"" + wstring_to_utf8(this->mainTitle) + "\">" + std::string("\n");
        this->utf8stream = this->utf8stream + "<filterAttribute>" + wstring_to_utf8(this->mainTitle) + "</filterAttribute>" + std::string("\n");
        ...
        {
            this->utf8stream = this->utf8stream + "<section title = \"" + wstring_to_utf8(this->mainTitle) + "\" ref = \"" + "index.html" + "\">" + std::string("\n");
            for (size_t k = 0; k < this->sectionsName.size(); k++)
            {
                bool bSuccess;
                std::wstring relativepath = RelativePath(this->destdirectory, this->sectionsUrl[k], bSuccess);
                this->utf8stream = this->utf8stream + "\t<section title = \"" + wstring_to_utf8(this->sectionsName[k]) + "\" ref = \"" + wstring_to_utf8(relativepath) + "\"/>" + std::string("\n");
            }
        ...
        {
            bool bSuccess;
            std::wstring relativepath = RelativePath(this->destdirectory, this->sectionsUrl[0], bSuccess);
            this->utf8stream = this->utf8stream + "<section title = \"" + wstring_to_utf8(this->sectionsName[0]) + "\" ref = \"" + wstring_to_utf8(relativepath) + "\"/>" + std::string("\n");
        }
        this->utf8stream = this->utf8stream + "</toc>" + std::string("\n");
        this->utf8stream = this->utf8stream + "<keywords>" + std::string("\n");
        for (size_t k = 0; k < this->keywordsName.size(); k++)
        {
            this->utf8stream = this->utf8stream + "<keyword name = \"" + wstring_to_utf8(this->keywordsName[k]) + "\" id = \"" + wstring_to_utf8(this->mainTitle) + "::" + wstring_to_utf8(this->keywordsName[k]) +"\" ref = \"" + wstring_to_utf8(this->keywordsUrl[k]) + "\"/>" + std::string("\n");
        }
        this->utf8stream = this->utf8stream + "</keywords>" + std::string("\n");
    ...
    //=============================================================================
    std::string QtHelpProject::uuid_module()
    {
    ...
    //=============================================================================
    void QtHelpProject::appendSection(std::wstring sectionName, std::wstring sectionUrl, wstringVector names, wstringVector urls)
    {
