...
namespace Nelson {
    ...
    //=============================================================================
    std::wstring XmlDocDirectory::getLastError()
    {
        if (this->xmlDocFiles)
        {
    ...
    //=============================================================================
    std::wstring XmlDocDirectory::getGeneratedChapterFilename()
    {
        if (this->xmlDocFiles)
        {
    ...
    //=============================================================================
    std::wstring XmlDocDirectory::getChapterTitle()
    {
        if (this->xmlDocFiles)
        {
    ...
    //=============================================================================
    void XmlDocDirectory::getIndex(wstringVector &names, wstringVector &urls, wstringVector &descriptions)
    {
        if (this->xmlDocFiles)
        {
    ...
    //=============================================================================
    void XmlDocDirectory::setUpSection(std::wstring sectionName, std::wstring sectionUrl)
    {
        this->sectionUpName = sectionName;
        this->sectionUpUrl = sectionUrl;
    }
    //=============================================================================
    std::wstring XmlDocDirectory::getModuleName()
    {
        if (this->xmlDocFiles)
        {
