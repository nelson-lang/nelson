...
namespace Nelson {
    ...
    //=============================================================================
    void XmlDocParamInput::append(std::wstring name, std::wstring description)
    {
    ...
    //=============================================================================
    std::wstring XmlDocParamInput::getItemType()
    {
        return utf8_to_wstring(PARAM_INPUT_TAG);
    }
    //=============================================================================
    bool XmlDocParamInput::writeAsHtml(std::string &utf8stream)
    {
    ...
    //=============================================================================
    bool XmlDocParamInput::writeAsMarkdown(std::string &utf8stream)
    {
