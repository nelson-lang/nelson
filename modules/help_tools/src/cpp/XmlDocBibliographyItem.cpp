...
namespace Nelson {
    ...
    //=============================================================================
    XmlDocBibliographyItem::~XmlDocBibliographyItem()
    {
        this->_bibliography = L"";
    }
    //=============================================================================
    std::wstring XmlDocBibliographyItem::getItemType()
    {
        return utf8_to_wstring(BIBLIOGRAPHY_TAG);
    }
    //=============================================================================
    bool XmlDocBibliographyItem::writeAsHtml(std::string &utf8stream)
    {
    ...
    //=============================================================================
    bool XmlDocBibliographyItem::writeAsMarkdown(std::string &utf8stream)
    {
        if (!this->_bibliography.empty())
        {
