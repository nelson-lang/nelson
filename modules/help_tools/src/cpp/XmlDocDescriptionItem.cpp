...
namespace Nelson {
    ...
    //=============================================================================
    void XmlDocDescriptionItem::setValue(std::wstring value)
    {
        this->_description = value;
    }
    //=============================================================================
    std::wstring XmlDocDescriptionItem::getValue()
    {
        return this->_description;
    }
    //=============================================================================
    std::wstring XmlDocDescriptionItem::getItemType()
    {
        return utf8_to_wstring(DESCRIPTION_TAG);
    }
    //=============================================================================
    bool XmlDocDescriptionItem::writeAsHtml(std::string &utf8stream)
    {
    ...
    //=============================================================================
    void XmlDocDescriptionItem::replaceImageTag()
    {
        // extract path
    ...
    //=============================================================================
    void XmlDocDescriptionItem::searchImageTag()
    {
        if (this->haveImages)
        {
            this->imagesTag.clear();
    ...
    //=============================================================================
    void XmlDocDescriptionItem::setDirectories(std::wstring srcDirectory, std::wstring destDirectory)
    {
