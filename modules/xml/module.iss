...
;==============================================================================
; xml libraries
Source: {#RootPath}bin\{#BinPath}\libnlXml.dll; DestDir: {app}\bin\{#BinPath}\;Components: {#COMPONENT_HELP_TOOLS};
Source: {#RootPath}bin\{#BinPath}\libnlsXml_builtin.dll; DestDir: {app}\bin\{#BinPath}\;Components: {#COMPONENT_HELP_TOOLS};
;==============================================================================
