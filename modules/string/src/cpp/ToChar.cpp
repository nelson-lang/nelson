...
namespace Nelson {
//=============================================================================
static ArrayOf ArrayOfDoubleToChar(const ArrayOf &A) {
...
//=============================================================================
ArrayOf ToChar(const ArrayOf &A, const ArrayOf &B, bool &needToOverload) {
  ArrayOf res;
...
//=============================================================================
ArrayOf ToChar(const ArrayOf &A, bool &needToOverload) {
  ArrayOf res;
...
//=============================================================================
static std::wstring ToChar(wstringVector V,
                           boost::container::vector<Dimensions> dimsVector,
                           Dimensions &dims) {
  std::wstring res;
  size_t lenMax = 0;
