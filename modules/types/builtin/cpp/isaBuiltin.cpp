...
//=============================================================================
ArrayOfVector Nelson::TypeGateway::isaBuiltin(Evaluator* eval, int nLhs, const ArrayOfVector& argIn)
{
    ...
    {
        bool bRes = (param1.getDataClass() == NLS_DOUBLE ||
                     param1.getDataClass() == NLS_DCOMPLEX ||
                     param1.getDataClass() == NLS_SINGLE ||
                     param1.getDataClass() == NLS_SCOMPLEX);
        retval.push_back(ArrayOf::logicalConstructor(bRes));
    }
    else if (classnameExpected == L"integer")
    {
        bool bRes = (param1.getDataClass() == NLS_UINT8 ||
                     param1.getDataClass() == NLS_INT8 ||
                     param1.getDataClass() == NLS_UINT16 ||
                     param1.getDataClass() == NLS_INT16 ||
                     param1.getDataClass() == NLS_UINT32 ||
                     param1.getDataClass() == NLS_INT32 ||
                     param1.getDataClass() == NLS_UINT64 ||
                     param1.getDataClass() == NLS_INT64);
        retval.push_back(ArrayOf::logicalConstructor(bRes));
    }
    else
    {
