...
namespace Nelson {
    //=============================================================================
    const bool ArrayOf::isStruct() const
    {
        return (this->getDataClass() == NLS_STRUCT_ARRAY);
    }
    //=============================================================================
    const bool ArrayOf::isClassStruct() const
    {
        if (this->isStruct())
        {
    ...
    //=============================================================================
    stringVector ArrayOf::getFieldNames() const
    {
        if (dp)
        {
    ...
    //=============================================================================
    std::string ArrayOf::getStructType() const
    {
    ...
    //=============================================================================
    void ArrayOf::setStructType(std::wstring structname)
    {
        ArrayOf::setStructType(wstring_to_utf8(structname));
    }
    //=============================================================================
    void ArrayOf::setStructType(std::string structname)
    {
    ...
    //=============================================================================
    ArrayOf ArrayOf::getField(std::string fieldName)
    {
    ...
    //=============================================================================
    ArrayOfVector ArrayOf::getFieldAsList(std::string fieldName)
    {
        if (!isStruct())
        {
    ...
    */
    void ArrayOf::setField(std::string fieldName, ArrayOf& data)
    {
        if (isEmpty())
        {
    ...
    * Set the contents of a field in a structure.
    */
    void ArrayOf::setFieldAsList(std::string fieldName, ArrayOfVector& data)
    {
        if (isSparse())
        {
    ...
    */
    indexType ArrayOf::insertFieldName(std::string fieldName)
    {
        if (isSparse())
        {
    ...
    */
    int64 ArrayOf::getFieldIndexFromList(std::string fName, const stringVector& fieldNames)
    {
    ...
    */
    int64 ArrayOf::getFieldIndex(std::string fName)
    {
    ...
    //=============================================================================
    ArrayOf ArrayOf::emptyStructConstructor(wstringVector fNames, Dimensions dim)
    {
        stringVector fs;
