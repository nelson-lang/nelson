...
- Improved integration with stdio in `fmt::print`, enabling direct writes
  ...
  performance improvements ranging from tens of percent to [2x](https://stackoverflow.com/a/78457454/471164) and eliminates dynamic memory
  ...
  For example, it gives ~24% improvement on a [simple benchmark](https://isocpp.org/files/papers/P3107R5.html#perf) compiled with Apple clang
...
The change log for versions 0.8.0 - 7.1.3 is available [here](doc/ChangeLog-old.md).
