...
//=============================================================================
void* Eigen_EyeSparseMatrixConstructor(Class dclass, indexType rows, indexType cols) throw(Exception)
{
    switch (dclass)
    {
        case NLS_LOGICAL:
...
//=============================================================================
void* Eigen_LogicalSparseMatrixConstructor(indexType rows, indexType cols, bool bMotif) throw(Exception)
{
...
//=============================================================================
template <class T> void Eigen_DeleteSparseMatrix(void ** cp)
{
...
//=============================================================================
void Eigen_DeleteSparseMatrix(Class dclass, indexType rows, indexType cols, void ** cp) throw(Exception)
{
    switch (dclass)
    {
        case NLS_LOGICAL:
...
//=============================================================================
template <class T>void* Eigen_MakeDenseArrayOf(indexType rows, indexType cols, const void* cp)
{
    Eigen::SparseMatrix<T, 0, signedIndexType> *spMat = (Eigen::SparseMatrix<T, 0, signedIndexType> *)cp;
    T *pMat = nullptr;
    if (rows * cols)
...
//=============================================================================
void* Eigen_MakeDenseArrayOf(Class dclass, indexType rows, indexType cols, const void* cp) throw(Exception)
{
    switch (dclass)
    {
        case NLS_LOGICAL:
        ...
        case NLS_DCOMPLEX:
        {
            ...
            if (rows * cols)
            {
                ...
                Eigen::Map<Eigen::Matrix<doublecomplex, Eigen::Dynamic, Eigen::Dynamic>> matA((doublecomplex*)pzMat, rows, cols);
                matA = spMat->toDense();
            }
            return pMat;
        }
...
//=============================================================================
template <class T>void* Eigen_MakeSparseArrayOf(indexType rows, indexType cols, const void* cp)
{
...
void* Eigen_MakeSparseArrayOf(Class dclass, indexType rows, indexType cols, const void* cp) throw(Exception)
{
    switch (dclass)
    {
        ...
        case NLS_DCOMPLEX:
        {
            ...
            Eigen::Map<Eigen::Matrix<doublecomplex, Eigen::Dynamic, Eigen::Dynamic>> matA(Az, rows, cols);
...
//=============================================================================
template <class T>indexType Eigen_CountNonzeros(const void *cp)
{
    Eigen::SparseMatrix<T, 0, signedIndexType> *spMat = (Eigen::SparseMatrix<T, 0, signedIndexType> *)cp;
    ...
    switch (dclass)
    {
        ...
        case NLS_DOUBLE:
        {
            ...
            for (ArrayOfMatrix::iterator i = m.begin(); i != m.end(); ++i)
            {
                for (ArrayOfVector::iterator j = i->begin(); j != i->end(); ++j)
                {
                    Eigen::SparseMatrix<double, 0, signedIndexType> *src = (Eigen::SparseMatrix<double, 0, signedIndexType> *)(j->getDataPointer());
                    //                    spMat->block(X, Y, j->getDimensions().getRows(), j->getDimensions().getColumns()) = src->block(0, 0, src->rows(), src->cols());
                    // TO DO
                    // A = sparse(1)
                    // B=[A;A]
                }
...
//=============================================================================
template <class T>void *Eigen_GetSparseVectorSubsetsInternal(indexType rows, indexType cols, const void* src, const indexType* indx, indexType irows, indexType icols)
{
    Eigen::SparseMatrix<T, 0, signedIndexType> *spMatsrc = (Eigen::SparseMatrix<T, 0, signedIndexType> *)src;
...
//=============================================================================
void* Eigen_GetSparseVectorSubsets(Class dclass, indexType rows, indexType cols, const void* src, const indexType* indx, indexType irows, indexType icols) throw(Exception)
{
    void *spMat = nullptr;
    ...
    switch (dclass)
    {
        ...
        case NLS_DCOMPLEX:
        {
            Eigen::SparseMatrix<doublecomplex, 0, signedIndexType> *spMatsrc = (Eigen::SparseMatrix<doublecomplex, 0, signedIndexType> *)src;
...
//=============================================================================
void* Eigen_GetSparseNDimSubsets(Class dclass, indexType rows, indexType cols, const void* src,
...
//=============================================================================
template <class T>void* Eigen_CopyResizeSparseMatrix(const void* src, indexType rows, indexType cols, indexType maxrow, indexType maxcol)
{
    Eigen::SparseMatrix<T, 0, signedIndexType> *spMat = (Eigen::SparseMatrix<T, 0, signedIndexType> *)src;
    Eigen::SparseMatrix<T, 0, signedIndexType> *copiedpMat = nullptr;
    try
    {
        if (spMat == nullptr)
...
//=============================================================================
void* Eigen_CopyResizeSparseMatrix(Class dclass, const void* src, indexType rows, indexType cols,
...
//=============================================================================
void* Eigen_SetSparseVectorSubsets(Class dclass, indexType &rows, indexType &cols,
                                   ...
                                   int advance) throw(Exception)
{
    ...
    spMat = Eigen_SetSparseNDimSubsets(dclass, rows, cols, src, rowvect, irows * icols, colvect, irows * icols, data, advance);
    delete [] rowvect;
    delete [] colvect;
    return spMat;
}
//=============================================================================
template <class T>void* Eigen_SetSparseNDimSubsetsInternal(indexType &rows, indexType &cols,
        const void* res,
        const indexType* rindx, indexType irows,
...
{
    T *dData = (T*)data;
    Eigen::SparseMatrix<T, 0, signedIndexType> *spMat = (Eigen::SparseMatrix<T, 0, signedIndexType> *)res;
    spMat->uncompress();
    if (irows == icols)
    {
...
//=============================================================================
void* Eigen_SetSparseNDimSubsets(Class dclass, indexType &rows, indexType &cols,
                                 const void* src,
                                 const indexType* rindx, indexType irows,
                                 const indexType* cindx, indexType icols,
                                 const void* data, int advance) throw(Exception)
{
    ...
    switch (dclass)
    {
        case NLS_LOGICAL:
        {
            return Eigen_SetSparseNDimSubsetsInternal<logical>(rows, cols, res,
                    rindx, irows,
                    cindx, icols,
                    data);
        }
        ...
        case NLS_DOUBLE:
        {
            return Eigen_SetSparseNDimSubsetsInternal<double>(rows, cols, res,
                    rindx, irows,
                    cindx, icols,
                    data);
        }
        ...
        case NLS_DCOMPLEX:
        {
            return Eigen_SetSparseNDimSubsetsInternal<doublecomplex>(rows, cols, res,
                    rindx, irows,
                    cindx, icols,
                    data);
        }
...
//=============================================================================
void *Eigen_CreateSparseScalarElement(double v) throw(Exception)
{
...
//=============================================================================
void *Eigen_CreateSparseScalarElement(doublecomplex v) throw(Exception)
{
...
//=============================================================================
void *Eigen_CreateSparseScalarElement(logical v) throw(Exception)
{
...
//=============================================================================
template <class T>void* Eigen_GetSparseScalarElement(indexType rows, indexType cols,
        const void* src, indexType rindx, indexType cindx) throw(Exception)
{
    Eigen::SparseMatrix<T, 0, signedIndexType> *spMat = (Eigen::SparseMatrix<T, 0, signedIndexType> *)src;
...
//=============================================================================
void* Eigen_GetSparseScalarElement(Class dclass, indexType rows, indexType cols,
                                   const void* src, indexType rindx, indexType cindx) throw(Exception)
{
    switch (dclass)
    {
...
//=============================================================================
template <class T>void* Eigen_SparseToIJV(const void* cp, indexType* &I, indexType* &J, int &nnz)
{
    Eigen::SparseMatrix<T, 0, signedIndexType> *spMat = (Eigen::SparseMatrix<T, 0, signedIndexType> *)cp;
    T *pV = nullptr;
    if (spMat)
    {
        ...
        {
            for (typename Eigen::SparseMatrix<T, 0, signedIndexType>::InnerIterator it(*spMat, k); it; ++it)
            {
                I[q] = it.row() + 1;
                J[q] = it.col() + 1;
                pV[q] = it.value();
...
//=============================================================================
void* Eigen_SparseToIJV(Class dclass, indexType rows, indexType cols, const void* cp,
    ...
    switch (dclass)
    {
        ...
        case NLS_DCOMPLEX:
        {
            ...
            if (spMat)
            {
                ...
                for (indexType k = 0; k < (indexType)spMat->outerSize(); ++k)
                {
                    for (Eigen::SparseMatrix<doublecomplex, 0, signedIndexType>::InnerIterator it(*spMat, k); it; ++it)
                    {
                        I[q] = it.row() + 1;
                        J[q] = it.col() + 1;
                        pV[l] = it.value().real();
...
//=============================================================================
template<class InputIterator, class T> InputIterator tripletfind(InputIterator first, InputIterator last, const T& val)
{
    while (first != last)
    {
        if ( (*first).col() == val.col() &&
                (*first).row() == val.row() )
        {
            return first;
        }
...
//=============================================================================
template <class T>void* Eigen_makeSparseFromIJVInternal(indexType rows, indexType cols, indexType nnz,
        indexType* I, indexType *J, const void* cp, bool bScalarV)
{
    typedef Eigen::Triplet<T, signedIndexType> Triplet;
    std::vector<Triplet> tripletList;
    ...
    for (indexType k = 0; k < nnz; k++)
    {
        ...
        typename std::vector<Triplet>::iterator it = tripletfind(tripletList.begin(), tripletList.end(), tr);
...
//=============================================================================
void* Eigen_makeSparseFromIJVLogical(indexType rows, indexType cols, indexType nnz,
                                     indexType* I, indexType *J, const void* cp, bool bScalarV)
{
...
//=============================================================================
void* Eigen_makeSparseFromIJVComplex(indexType rows, indexType cols, indexType nnz,
                                     indexType* I, indexType *J, const void* cp, bool bScalarV)
{
    typedef Eigen::Triplet<doublecomplex, signedIndexType> T;
    std::vector<T> tripletList;
...
//=============================================================================
void* Eigen_makeSparseFromIJV(Class dclass, indexType rows, indexType cols, indexType nnz,
...
//=============================================================================
void* Eigen_DeleteSparseMatrixCols(Class dclass, indexType rows, indexType cols, const void* cp, bool *dmap) throw(Exception)
{
    void *spMat = nullptr;
...
//=============================================================================
void* Eigen_DeleteSparseMatrixRows(Class dclass, indexType rows, indexType cols, const void* cp, bool *dmap) throw(Exception)
{
    void *spMat = nullptr;
...
//=============================================================================
void* Eigen_DeleteSparseMatrixVectorSubset(Class dclass, indexType &rows, indexType &cols, const void *cp, const indexType *todel, indexType delete_len) throw(Exception)
{
    void *spMat = nullptr;
...
//=============================================================================
void* Eigen_TypeConvertSparse(Class dclass, indexType rows, indexType cols, const void *cp, Class oclass) throw(Exception)
{
    switch (oclass)
    {
        case NLS_LOGICAL:
        {
            Eigen::SparseMatrix<logical, 0, signedIndexType> *spMat = (Eigen::SparseMatrix<logical, 0, signedIndexType> *)cp;
            switch (dclass)
            {
                case NLS_LOGICAL:
                {
                ...
                case NLS_DOUBLE:
                {
                    ...
                    try
                    {
                        spMatdest = new Eigen::SparseMatrix<double, 0, signedIndexType>(spMat->cast<double>());
                    }
                    catch (std::bad_alloc &e)
                    {
                        e.what();
                ...
                case NLS_DCOMPLEX:
                {
                    ...
                    try
                    {
                        spMatdest = new Eigen::SparseMatrix<doublecomplex, 0, signedIndexType>(spMat->cast<doublecomplex>());
                    }
                    catch (std::bad_alloc &e)
                    {
                        e.what();
        ...
        case NLS_DOUBLE:
        {
            Eigen::SparseMatrix<double, 0, signedIndexType> *spMat = (Eigen::SparseMatrix<double, 0, signedIndexType> *)cp;
            switch (dclass)
            {
                case NLS_LOGICAL:
                {
                    ...
                    for (indexType k = 0; k < (indexType)spMat->outerSize(); ++k)
                    {
                        for (Eigen::SparseMatrix<double, 0, signedIndexType>::InnerIterator it(*spMat, k); it; ++it)
                        {
...
//=============================================================================
template <class T>void* Eigen_ReshapeSparseMatrix(indexType rows, indexType cols, indexType newrows, indexType newcols, const void* cp)
{
    ...
    else
    {
        if (cp)
        {
            ...
            delete[] pI;
            delete[] pJ;
            Eigen::SparseMatrix<T, 0, signedIndexType> *reshapedMat = new Eigen::SparseMatrix<T, 0, signedIndexType>(newrows, newcols);
            if (reshapedMat)
            {
...
//=============================================================================
void* Eigen_ReshapeSparseMatrix(Class dclass, indexType rows, indexType cols,
