...
//=============================================================================
static bool isQuery(const std::wstring &state) { return state == L"query"; }
//=============================================================================
static bool isState(const std::wstring &state) {
  if (state == L"aserror") {
    return true;
  }
  if (state == L"off") {
...
//=============================================================================
static WARNING_STATE stringToState(const std::wstring &str) {
  if (str == L"aserror") {
...
//=============================================================================
static std::wstring stateToString(WARNING_STATE state) {
...
//=============================================================================
static std::wstring formatWarningIDStateLine(std::wstring ID,
                                             WARNING_STATE state) {
  std::wstring line;
  line = L"   ";
...
//=============================================================================
static void displayWarningStates(Evaluator *eval) {
  ...
  if (io) {
    ...
    for (size_t k = 0; k < list.IDs.size(); k++) {
      if (list.states[k] != WARNING_STATE::ENABLED) {
        io->outputMessage(
            formatWarningIDStateLine(list.IDs[k], list.states[k]));
      }
    }
    io->outputMessage(L"\n");
  }
...
//=============================================================================
static ArrayOfVector warningStruct(WARNING_IDS_STATES list) {
...
//=============================================================================
static ArrayOfVector warningBuiltinNoRhs(Evaluator *eval, int nLhs,
...
//=============================================================================
static ArrayOfVector warningBuiltinOneRhs(Evaluator *eval, int nLhs,
                                          const ArrayOfVector &argIn) {
  ArrayOfVector retval;
  if (argIn[0].isStruct()) {
...
//=============================================================================
static ArrayOfVector warningBuiltinTwoRhs(Evaluator *eval, int nLhs,
                                          const ArrayOfVector &argIn) {
  ArrayOfVector retval;
...
//=============================================================================
ArrayOfVector
Nelson::ErrorManagerGateway::warningBuiltin(Evaluator *eval, int nLhs,
                                            const ArrayOfVector &argIn) {
  ArrayOfVector retval;
  switch (argIn.size()) {
  case 0: {
