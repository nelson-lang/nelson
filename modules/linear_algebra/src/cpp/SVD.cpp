...
namespace Nelson {
	...
	//=============================================================================
	static void SVD_double(ArrayOf A, ArrayOf &s)
	{
		char JOBU = 'N';
		char JOBVT = 'N';
		...
		int info = LAPACKE_dgesvd(LAPACK_COL_MAJOR, JOBU, JOBVT, m, n, (double*)A.getDataPointer(), lda, ds, u, ldu, vt, ldvt, superb);
		if (info > 0)
		{
	...
	//=============================================================================
	static void SVD_doublecomplex(ArrayOf A, ArrayOf &s)
	{
		char JOBU = 'N';
		char JOBVT = 'N';
		Dimensions dimsA = A.getDimensions();
		...
		int info = LAPACKE_zgesvd(LAPACK_COL_MAJOR, JOBU, JOBVT, m, n, Rz, lda, ds, uz, ldu, vtz, ldvt, superb);
		if (info > 0)
		{
	...
	//=============================================================================
	static void SVD_single(ArrayOf A, ArrayOf &s)
	{
		char JOBU = 'N';
		char JOBVT = 'N';
		Dimensions dimsA = A.getDimensions();
		...
		int info = LAPACKE_sgesvd(LAPACK_COL_MAJOR, JOBU, JOBVT, m, n, (single*)A.getDataPointer(), lda, ds, u, ldu, vt, ldvt, superb);
		if (info > 0)
		{
	...
	//=============================================================================
	static void SVD_singlecomplex(ArrayOf A, ArrayOf &s)
	{
		char JOBU = 'N';
		char JOBVT = 'N';
		Dimensions dimsA = A.getDimensions();
		...
		int info = LAPACKE_cgesvd(LAPACK_COL_MAJOR, JOBU, JOBVT, m, n, Rz, lda, ds, uz, ldu, vtz, ldvt, superb);
		if (info > 0)
		{
	...
	//=============================================================================
 	static void SVD_doublecomplex(ArrayOf A, SVD_FLAG flag, ArrayOf &U, ArrayOf &S, ArrayOf &V, bool withV)
	{
		Dimensions dimsA = A.getDimensions();
		int m = (int)dimsA.getRows();
		int n = (int)dimsA.getColumns();
	...
	//=============================================================================
	static void SVD_single(ArrayOf A, SVD_FLAG flag, ArrayOf &U, ArrayOf &S, ArrayOf &V, bool withV)
	{
		Dimensions dimsA = A.getDimensions();
		int m = (int)dimsA.getRows();
		int n = (int)dimsA.getColumns();
	...
	//=============================================================================
	static void SVD_double(ArrayOf A, SVD_FLAG flag, ArrayOf &U, ArrayOf &S, ArrayOf &V, bool withV)
	{
		Dimensions dimsA = A.getDimensions();
		int m = (int)dimsA.getRows();
		int n = (int)dimsA.getColumns();
	...
	//=============================================================================
	static void SVD_singlecomplex(ArrayOf A, SVD_FLAG flag, ArrayOf &U, ArrayOf &S, ArrayOf &V, bool withV)
	{
		Dimensions dimsA = A.getDimensions();
		int m = (int)dimsA.getRows();
		int n = (int)dimsA.getColumns();
	...
	//=============================================================================
	static void SVD(ArrayOf A, SVD_FLAG flag, ArrayOf &U, ArrayOf &S, ArrayOf &V, bool withV)
	{
	...
	//=============================================================================
	void SVD(ArrayOf A, SVD_FLAG flag, ArrayOf &U, ArrayOf &S, ArrayOf &V)
    {
		SVD(A, flag, U, S, V, true);
	}
    //=============================================================================
	void SVD(ArrayOf A, SVD_FLAG flag, ArrayOf &U, ArrayOf &S)
	{
		ArrayOf V;
