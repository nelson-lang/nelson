...
namespace Nelson {
    //=============================================================================
    static ArrayOf InverseDouble(ArrayOf A, double rcond)
    {
        ArrayOf res(A);
        ...
        Eigen::Map<Eigen::MatrixXd> matR((double*)res.getDataPointer(), (Eigen::Index)res.getDimensions().getRows(), (Eigen::Index)res.getDimensions().getColumns());
        if (matA.hasNaN())
        {
    ...
    //=============================================================================
    static ArrayOf InverseDoubleComplex(ArrayOf A, double rcond)
    {
        ArrayOf res(A);
        res.ensureSingleOwner();
        ...
        Eigen::Map<Eigen::MatrixXcd> matR(Rz, (Eigen::Index)res.getDimensions().getRows(), (Eigen::Index)res.getDimensions().getColumns());
        if (matA.hasNaN())
        {
    ...
    //=============================================================================
    static ArrayOf InverseSingle(ArrayOf A, single rcond)
    {
        ArrayOf res(A);
        res.ensureSingleOwner();
        ...
        Eigen::Map<Eigen::MatrixXf> matR((single*)res.getDataPointer(), (Eigen::Index)res.getDimensions().getRows(), (Eigen::Index)res.getDimensions().getColumns());
        if (matA.hasNaN())
        {
    ...
    //=============================================================================
    static ArrayOf InverseSingleComplex(ArrayOf A, single rcond)
    {
        ArrayOf res(A);
        res.ensureSingleOwner();
        ...
        Eigen::Map<Eigen::MatrixXcf> matR(Rz, (Eigen::Index)res.getDimensions().getRows(), (Eigen::Index)res.getDimensions().getColumns());
        if (matA.hasNaN())
        {
