...
namespace Nelson {
    //=============================================================================
    static ArrayOf ReciprocalConditionNumber_Double(const ArrayOf A)
    {
        ArrayOf rcond;
        ...
        else
        {
            ...
            else
            {
                ...
                int lda = m;
                normA = LAPACKE_dlange(LAPACK_COL_MAJOR, norm, m, n, (const double*)R.getDataPointer(), lda);
                int info = 0;
                ...
                double res = 0.;
                LAPACK_dgecon(&norm, &n, (const double*)R.getDataPointer(), &lda, &normA, &res, work, iwork, &info);
                delete[] iwork;
                iwork = nullptr;
                delete[] work;
                work = nullptr;
    ...
    static ArrayOf ReciprocalConditionNumber_Single(ArrayOf A)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                int n = (int)A.getDimensions().getColumns();
                int lda = m;
                normA = LAPACKE_slange(LAPACK_COL_MAJOR, norm, m, n, (const single*)R.getDataPointer(), lda);
                int info = 0;
                int *ipiv = new_with_exception<int>(std::min(m, n));
                ...
                int *iwork = new_with_exception<int>(n);
                single res = 0.;
                LAPACK_sgecon(&norm, &n, (single*)R.getDataPointer(), &lda, &normA, &res, work, iwork, &info);
                delete[] iwork;
                iwork = nullptr;
                delete[] work;
                work = nullptr;
