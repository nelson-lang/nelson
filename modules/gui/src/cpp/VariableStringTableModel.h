...
namespace Nelson {
//=============================================================================
class VariableStringTableModel : public VariableAbstractTableModel
{
    Q_OBJECT

public:
    explicit VariableStringTableModel(
        const QString& name, ArrayOf array, Evaluator* evaluator, QObject* parent = nullptr);
    ~VariableStringTableModel() override = default;
    ...
    bool
    replaceSelectedWithMissing(const QModelIndexList& selectedIndexes);
