...
//=============================================================================
bool
VariableDoubleTableModel::expandDisplayOptimized(int row, int col)
{
...
//=============================================================================
void
VariableDoubleTableModel::resizeEditDataOptimized(int oldRows, int oldCols)
{
...
//=============================================================================
bool
VariableDoubleTableModel::resizeArrayOptimized(int row, int col)
{
    if (row < m_rows && col < m_cols) {
...
//=============================================================================
bool
VariableDoubleTableModel::pasteData(int startRow, int startCol, const QString& text)
{
    if (text.isEmpty()) {
        return false;
    }
...
//=============================================================================
bool
VariableDoubleTableModel::setArrayValue(int row, int col, double realpart, double imagpart)
{
    if (m_array.getDataClass() == NLS_DOUBLE) {
...
//=============================================================================
bool
VariableDoubleTableModel::setArrayValue(int row, int col, double value)
{
    double* data = (double*)(m_array.getDataPointer());
    if (!data) {
...
//=============================================================================
bool
VariableDoubleTableModel::parseNumericValue(const QString& text, double& value) const
{
...
//=============================================================================
QString
VariableDoubleTableModel::getVariableClassAsString() const
{
...
//=============================================================================
QString
VariableDoubleTableModel::getVariableDimensionsAsString() const
{
