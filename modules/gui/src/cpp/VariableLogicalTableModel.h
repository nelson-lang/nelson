...
namespace Nelson {
//=============================================================================
class VariableLogicalTableModel : public VariableAbstractTableModel
{
    Q_OBJECT

public:
    explicit VariableLogicalTableModel(
        const QString& name, ArrayOf array, Evaluator* evaluator, QObject* parent = nullptr);
    ~VariableLogicalTableModel() override = default;
...
private:
    ...
    QString
    formatDisplayValue(logical value) const;
