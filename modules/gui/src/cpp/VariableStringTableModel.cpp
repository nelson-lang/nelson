...
//=============================================================================
bool
VariableStringTableModel::expandDisplayOptimized(int row, int col)
{
...
//=============================================================================
void
VariableStringTableModel::resizeEditDataOptimized(int oldRows, int oldCols)
{
...
//=============================================================================
bool
VariableStringTableModel::resizeArrayOptimized(int row, int col)
{
    if (row < m_rows && col < m_cols) {
...
//=============================================================================
bool
VariableStringTableModel::pasteData(int startRow, int startCol, const QString& text)
{
    if (text.isEmpty()) {
        return false;
    }
...
VariableStringTableModel::setArrayMissingValue(int row, int col)
{
    ...
    data[idx] = ArrayOf::doubleConstructor(0.0);
    return true;
}
//=============================================================================
...
VariableStringTableModel::insertRowAt(int row)
{
    ...
    try {
        ...
        for (int c = 0; c < cols; ++c) {
            ...
            dst[row + c * newRows] = ArrayOf::characterArrayConstructor("");
...
VariableStringTableModel::insertColumnAt(int col)
{
    ...
    try {
        ...
        for (int r = 0; r < rows; ++r)
            dst[r + col * rows] = ArrayOf::characterArrayConstructor("");
...
//=============================================================================
QString
VariableStringTableModel::getVariableClassAsString() const
{
...
//=============================================================================
QString
VariableStringTableModel::getVariableDimensionsAsString() const
{
