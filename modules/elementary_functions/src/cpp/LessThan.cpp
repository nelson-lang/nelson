...
namespace Nelson {
    ...
    template <class T>
    void lessthanfuncreal(indexType N, logical* C, const T*A, int stride1, const T*B,
                          int stride2)
    {
        indexType m, p;
        m = 0;
    ...
    template <class T>
    void lessthanfunccomplex(indexType N, logical* C, const T*A, int stride1,
    ...
    ArrayOf LessThan(ArrayOf A, ArrayOf B)
    {
