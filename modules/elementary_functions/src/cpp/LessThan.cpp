...
namespace Nelson {
	//=============================================================================
    template <class T>
    void lessThanReal(indexType N, logical* C, const T*A, int stride1, const T*B,
                          int stride2)
    {
        indexType m = 0, p = 0;
...
#pragma omp parallel for
	...
	//=============================================================================
    template <class T>
    void lessThanComplex(indexType N, logical* C, const T*A, int stride1,
...
#pragma omp parallel for
	...
	//=============================================================================
    ArrayOf LessThan(ArrayOf &A, ArrayOf &B, bool mustRaiseError, bool &bSuccess)
    {
		VectorCheck(A, B, "<");
		...
		case NLS_INT64:
		{
			lessThanReal<int64>(Clen, (logical*)Cp,
		...
		case NLS_SINGLE:
		{
			lessThanReal<single>(Clen, (logical*)Cp,
		...
		case NLS_DOUBLE:
		{
			lessThanReal<double>(Clen, (logical*)Cp,
		...
		case NLS_SCOMPLEX:
		{
			lessThanComplex<single>(Clen, (logical*)Cp,
				(single*)A.getDataPointer(), Astride,
				(single*)B.getDataPointer(), Bstride);
		}
		break;
		case NLS_DCOMPLEX:
		{
			lessThanComplex<double>(Clen, (logical*)Cp,
				(double*)A.getDataPointer(), Astride,
				(double*)B.getDataPointer(), Bstride);
		}
		break;
