...
//=============================================================================
logical
realComparatorLessThan(const ArrayOf& A, const ArrayOf& B, indexType idxA, indexType idxB)
{
...
//=============================================================================
logical
complexComparatorLessThan(const ArrayOf& A, const ArrayOf& B, indexType idxA, indexType idxB)
{
    switch (A.getDataClass()) {
    case NLS_SCOMPLEX: {
        single* ptrA = (single*)A.getDataPointer();
...
//=============================================================================
logical
stringArrayComparatorLessThan(const ArrayOf& A, const ArrayOf& B, indexType idxA, indexType idxB)
{
