...
//=============================================================================
logical
realComparatorGreaterEquals(const ArrayOf& A, const ArrayOf& B, indexType idxA, indexType idxB)
{
...
//=============================================================================
logical
complexComparatorGreaterEquals(const ArrayOf& A, const ArrayOf& B, indexType idxA, indexType idxB)
{
    switch (A.getDataClass()) {
    case NLS_SCOMPLEX: {
        single* ptrA = (single*)A.getDataPointer();
