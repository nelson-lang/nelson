...
namespace Nelson {
//=============================================================================
static void boolean_vector_and(logical *C, const logical *A, indexType NA,
                               const logical *B, indexType NB) {
  indexType m = 0;
...
//=============================================================================
static void boolean_and(indexType N, logical *C, const logical *A, int Astride,
...
//=============================================================================
ArrayOf And(ArrayOf A, ArrayOf B) {
  int Astride, Bstride;
  indexType Clen = 0;
  Dimensions Cdim;
  BoolVectorCheck(A, B, "&");
  ...
  if (Astride == 0 && Bstride == 0) {
    if (A.isRowVector() && B.isColumnVector()) {
      boolean_vector_and((logical *)Cp, (const logical *)A.getDataPointer(),
                         ...
                         (const logical *)B.getDataPointer(),
    ...
    boolean_and(Clen, (logical *)Cp, (const logical *)A.getDataPointer(),
                Astride, (const logical *)B.getDataPointer(), Bstride);
  }
