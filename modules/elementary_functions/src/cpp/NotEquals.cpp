...
//=============================================================================
logical
realComparatorNotEquals(const ArrayOf& A, const ArrayOf& B, indexType idxA, indexType idxB)
{
...
//=============================================================================
logical
complexComparatorNotEquals(const ArrayOf& A, const ArrayOf& B, indexType idxA, indexType idxB)
{
    switch (A.getDataClass()) {
    case NLS_SCOMPLEX: {
        single* ptrA = (single*)A.getDataPointer();
...
//=============================================================================
logical
stringArrayComparatorNotEquals(const ArrayOf& A, const ArrayOf& B, indexType idxA, indexType idxB)
{
