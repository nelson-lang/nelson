...
template <class T>
void
equalsReal(indexType N, logical* C, const T* A, int stride1, const T* B, int stride2)
{
...
template <class T>
void
equalsComplex(indexType N, logical* C, const T* A, int stride1, const T* B, int stride2)
{
    if ((stride1 == 1) && (stride2 == 1)) {
#if defined(__NLS_WITH_OPENMP)
#pragma omp parallel for
...
Equals(ArrayOf& A, ArrayOf& B, bool& needToOverload)
{
    ...
    case NLS_LOGICAL: {
        equalsReal<logical>(Clen, (logical*)Cp, (logical*)A.getDataPointer(), Astride,
            (logical*)B.getDataPointer(), Bstride);
    } break;
    case NLS_UINT8: {
        equalsReal<uint8>(Clen, (logical*)Cp, (uint8*)A.getDataPointer(), Astride,
            (uint8*)B.getDataPointer(), Bstride);
    } break;
    case NLS_INT8: {
        equalsReal<int8>(Clen, (logical*)Cp, (int8*)A.getDataPointer(), Astride,
            (int8*)B.getDataPointer(), Bstride);
    } break;
    case NLS_UINT16: {
        equalsReal<uint16>(Clen, (logical*)Cp, (uint16*)A.getDataPointer(), Astride,
            (uint16*)B.getDataPointer(), Bstride);
    } break;
    case NLS_INT16: {
        equalsReal<int16>(Clen, (logical*)Cp, (int16*)A.getDataPointer(), Astride,
            (int16*)B.getDataPointer(), Bstride);
    } break;
    case NLS_UINT32: {
        equalsReal<uint32>(Clen, (logical*)Cp, (uint32*)A.getDataPointer(), Astride,
            (uint32*)B.getDataPointer(), Bstride);
    } break;
    case NLS_INT32: {
        equalsReal<int32>(Clen, (logical*)Cp, (int32*)A.getDataPointer(), Astride,
            (int32*)B.getDataPointer(), Bstride);
    } break;
    case NLS_UINT64: {
        equalsReal<uint64>(Clen, (logical*)Cp, (uint64*)A.getDataPointer(), Astride,
            (uint64*)B.getDataPointer(), Bstride);
    } break;
    case NLS_INT64: {
        equalsReal<int64>(Clen, (logical*)Cp, (int64*)A.getDataPointer(), Astride,
    ...
    case NLS_CHAR: {
        equalsReal<charType>(Clen, (logical*)Cp, (charType*)A.getDataPointer(), Astride,
