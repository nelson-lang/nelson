...
//=============================================================================
logical
realComparatorEquals(const ArrayOf& A, const ArrayOf& B, indexType idxA, indexType idxB)
{
...
//=============================================================================
logical
complexComparatorEquals(const ArrayOf& A, const ArrayOf& B, indexType idxA, indexType idxB)
{
    switch (A.getDataClass()) {
    case NLS_SCOMPLEX:{
        single* ptrA = (single*)A.getDataPointer();
...
//=============================================================================
logical
stringArrayComparatorEquals(const ArrayOf& A, const ArrayOf& B, indexType idxA, indexType idxB)
{
