...
//=============================================================================
void
power_zi(double* p, double* a, int b) /* p = a**b  */
{
    int n;
    unsigned long u;
    double t;
...
//=============================================================================
void
power_zz(double* c, double* a, double* b)
{
...
//=============================================================================
void
cicpower(int n, float* c, float* a, int stride1, int* b, int stride2)
{
    int m, p;
    double z1[2];
    double z3[2];
...
//=============================================================================
void
cfcpower(int n, float* c, float* a, int stride1, float* b, int stride2)
{
    int m, p;
    double z1[2];
    double z2[2];
...
//=============================================================================
void
cccpower(int n, float* c, float* a, int stride1, float* b, int stride2)
{
    int m, p;
    double z1[2];
    double z2[2];
...
//=============================================================================
void
fifpower(int n, float* c, float* a, int stride1, int* b, int stride2)
{
    int m, p;
    m = 0;
    p = 0;
...
//=============================================================================
void
fffpower(int n, float* c, float* a, int stride1, float* b, int stride2)
{
    int m, p;
    m = 0;
    p = 0;
