...
//=============================================================================
ArrayOfVector Nelson::ElementaryFunctionsGateway::reshapeBuiltin(Evaluator* eval, int nLhs, const ArrayOfVector& argIn)
{
    ...
    if (!bSuccess)
    {
        ...
        {
            Error(eval, _W("Undefined function 'reshape' for input arguments of type 'function_handle'."));
        }
