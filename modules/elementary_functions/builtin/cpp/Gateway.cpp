...
static const nlsGateway gateway[] = {
    ...
    { "reshape", (ptrBuiltin)Nelson::ElementaryFunctionsGateway::reshapeBuiltin, 1, -1,
        CPP_BUILTIN_WITH_EVALUATOR },
    { "real", (ptrBuiltin)Nelson::ElementaryFunctionsGateway::realBuiltin, 1, 1, CPP_BUILTIN },
    ...
    { OVERLOAD_FUNCTION_NAME(NLS_LOGICAL_STR, "isequal"),
        (ptrBuiltin)Nelson::ElementaryFunctionsGateway::isequalBuiltin, 1, -1, CPP_BUILTIN },
    ...
    { OVERLOAD_FUNCTION_NAME(NLS_STRING_ARRAY_STR, "isequal"),
        (ptrBuiltin)Nelson::ElementaryFunctionsGateway::isequalBuiltin, 1, -1,
        CPP_BUILTIN_WITH_EVALUATOR },
    ...
    { OVERLOAD_FUNCTION_NAME(NLS_CELL_ARRAY_STR, "isequaln"),
        (ptrBuiltin)Nelson::ElementaryFunctionsGateway::isequalnBuiltin, 1, -1,
        CPP_BUILTIN_WITH_EVALUATOR },
    { OVERLOAD_FUNCTION_NAME(NLS_STRUCT_ARRAY_STR, "isequaln"),
        (ptrBuiltin)Nelson::ElementaryFunctionsGateway::isequalnBuiltin, 1, -1,
        CPP_BUILTIN_WITH_EVALUATOR },
    { OVERLOAD_FUNCTION_NAME(NLS_LOGICAL_STR, "isequaln"),
        (ptrBuiltin)Nelson::ElementaryFunctionsGateway::isequalnBuiltin, 1, -1, CPP_BUILTIN },
    ...
    { OVERLOAD_FUNCTION_NAME(NLS_CELL_ARRAY_STR, "isequalto"),
        (ptrBuiltin)Nelson::ElementaryFunctionsGateway::isequaltoBuiltin, 1, -1,
        CPP_BUILTIN_WITH_EVALUATOR },
    { OVERLOAD_FUNCTION_NAME(NLS_STRUCT_ARRAY_STR, "isequalto"),
        (ptrBuiltin)Nelson::ElementaryFunctionsGateway::isequaltoBuiltin, 1, -1,
        CPP_BUILTIN_WITH_EVALUATOR },
    { OVERLOAD_FUNCTION_NAME(NLS_LOGICAL_STR, "isequalto"),
        (ptrBuiltin)Nelson::ElementaryFunctionsGateway::isequaltoBuiltin, 1, -1, CPP_BUILTIN },
