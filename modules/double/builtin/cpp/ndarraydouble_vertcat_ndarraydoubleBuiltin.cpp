...
//=============================================================================
ArrayOfVector Nelson::DoubleGateway::ndarraydouble_vertcat_ndarraydoubleBuiltin(Evaluator* eval, int nLhs, const ArrayOfVector& argIn)
{
    ...
    retval.push_back(VertCatNdArrayDouble(A, B));
    return retval;
}
//=============================================================================
