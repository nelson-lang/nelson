...
//=============================================================================
ArrayOfVector Nelson::DoubleGateway::double_gt_doubleBuiltin(Evaluator* eval, int nLhs, const ArrayOfVector& argIn)
{
    if (argIn.size() != 2)
    {
    ...
    {
        bool bSuccess = false;
        res = OverloadBinaryOperator(eval, A, B, "gt", bSuccess, "dcomplex_gt_dcomplex");
        if (!bSuccess)
        {
