...
extern "C"
{
    ...
    inline static void
    gen_rand_array_c1o2(dsfmt_t* dsfmt, w128_t* array, ptrdiff_t size);
    inline static void
    gen_rand_array_c0o1(dsfmt_t* dsfmt, w128_t* array, ptrdiff_t size);
    inline static void
    gen_rand_array_o0c1(dsfmt_t* dsfmt, w128_t* array, ptrdiff_t size);
    inline static void
    gen_rand_array_o0o1(dsfmt_t* dsfmt, w128_t* array, ptrdiff_t size);
    inline static int
    idxof(int i);
    static void
...
#pragma warning(disable : 981)
    ...
    dsfmt_chk_init_by_array(dsfmt_t* dsfmt, uint32_t init_key[], int key_length, int mexp)
    {
        ...
        r = ini_func1(
            psfmt32[idxof(0)] ^ psfmt32[idxof(mid % size)] ^ psfmt32[idxof((size - 1) % size)]);
