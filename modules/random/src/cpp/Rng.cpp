...
namespace Nelson {
    //=============================================================================
    std::wstring RngGetType(Evaluator *eval)
    {
    ...
    //=============================================================================
    void RngSetSeed(Evaluator *eval, double seed)
    {
        if (eval->RandomEngine == nullptr)
        {
            Error(eval, _W("random engine not initialized."));
    ...
    //=============================================================================
    ArrayOf RngGetSeed(Evaluator *eval)
    {
        if (eval->RandomEngine == nullptr)
        {
            Error(eval, _W("random engine not initialized."));
    ...
    //=============================================================================
    ArrayOf RngGetState(Evaluator *eval)
    {
        if (eval->RandomEngine == nullptr)
        {
            Error(eval, _W("random engine not initialized."));
    ...
    //=============================================================================
    void RngSetDefault(Evaluator *eval)
    {
    ...
    //=============================================================================
    void RngShuffle(Evaluator *eval)
    {
        if (eval->RandomEngine == nullptr)
        {
            Error(eval, _W("random engine not initialized."));
    ...
    //=============================================================================
    bool RngSetEngine(Evaluator *eval, double seed, std::wstring engineName)
    {
        if (eval->RandomEngine == nullptr)
        {
            Error(eval, _W("random engine not initialized."));
    ...
    //=============================================================================
    bool RngSetState(Evaluator *eval, ArrayOf st)
    {
        RandomInterface *randEngine = (RandomInterface *)eval->RandomEngine;
        RNG_TYPE rngtype = getRngType(randEngine->getGeneratorName());
            ...
            case RNG_TWISTER:
            {
                if (stClass == NLS_UINT32)
                {
                    if (st.isVector())
                    {
                        ...
                        {
                            std::wstring msg = _W("dimensions of state must be") + L" " + std::to_wstring(randEngine->getStateSize()) + std::wstring(L"x1.");
                            Error(eval, msg);
                        }
                    }
                    else
