...
// rng(s) implemented
//=============================================================================
static ArrayOf backupCurrentRng(Evaluator* eval);
static ArrayOfVector splitRngStruct(Evaluator* eval, ArrayOf structRng);
//=============================================================================
ArrayOfVector Nelson::RandomGateway::rngBuiltin(Evaluator* eval, int nLhs, const ArrayOfVector& argIn)
{
...
static ArrayOf backupCurrentRng(Evaluator* eval)
{
    ArrayOf typeOfRng = ArrayOf::stringConstructor(RngGetType(eval));
...
static ArrayOfVector splitRngStruct(Evaluator* eval, ArrayOf structRng)
{
    ...
    Error(eval, _W("Must contain generator settings captured previously."));
    return elements;
}
//=============================================================================
