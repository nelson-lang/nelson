...
;==============================================================================
Source: {#RootPath}bin\{#BinPath}\libnlsSio_client.dll; DestDir: {app}\bin\{#BinPath}\;
Source: {#RootPath}bin\{#BinPath}\libnlsSio_client_builtin.dll; DestDir: {app}\bin\{#BinPath}\;
;==============================================================================
