...
//=============================================================================
namespace Nelson {
    size_t setRecursionStacksize(size_t sizerstack)
    {
    ...
    size_t getRecursionStacksize()
    {
        ...
        if (bFirstCall)
        {
            ...
            RtlImageNtHeaderProcPointer = (RtlImageNtHeaderProc)GetProcAddress(hModule, "RtlImageNtHeader");
