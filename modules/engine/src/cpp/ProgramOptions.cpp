...
#define PREFIX_SHORTOPTION_WINDOWS_STR L"/"
    //=============================================================================
    Option::Option(std::wstring fullOption, std::wstring shortOption, std::wstring description, bool bMultiple, bool bWithFieldValue)
    {
    ...
    //=============================================================================
    std::wstring Option::getFullOption()
    {
        return _fullOption;
    }
    //=============================================================================
    std::wstring Option::getShortOption()
    {
        return _shortOption;
    }
    //=============================================================================
    std::wstring Option::getDescription()
    {
        return _description;
    }
    //=============================================================================
    std::wstring Option::getFullDescription()
    {
        ...
        {
            fulldescription = PREFIX_FULLOPTION_STR + _fullOption + L", " + PREFIX_SHORTOPTION_STR + _shortOption + L": " + _description;
        }
        return fulldescription;
    }
    //=============================================================================
    bool Option::isMultiple()
    {
        return _bMultiple;
    }
    //=============================================================================
    bool Option::withFieldValue()
    {
        return _bWithFieldValue;
    }
    //=============================================================================
    bool Option::isSameFieldname(std::wstring name)
    {
    ...
    //=============================================================================
    bool ProgramOptions::parseOption(Option op, bool &bFind)
    {
        size_t nbElements = 0;
        if (!op.withFieldValue())
        {
    ...
    //=============================================================================
    bool ProgramOptions::haveOptionsHelp()
    {
        if (_isvalid)
        {
            return _ishelp;
    ...
    //=============================================================================
    bool ProgramOptions::haveVersion()
    {
        if (_isvalid)
        {
            return _isversion;
    ...
    //=============================================================================
    bool ProgramOptions::haveFileToExecute()
    {
        if (_isvalid)
        {
            return !_file.empty();
    ...
    //=============================================================================
    bool ProgramOptions::haveCommandToExecute()
    {
        if (_isvalid)
        {
    ...
    //=============================================================================
    bool ProgramOptions::haveLanguage()
    {
        if (_isvalid)
        {
            return !_lang.empty();
    ...
    //=============================================================================
    bool ProgramOptions::haveNoStartup()
    {
        if (_isvalid)
        {
            return _startup;
    ...
    //=============================================================================
    bool ProgramOptions::haveNoUserStartup()
    {
        if (_isvalid)
        {
            return _userstartup;
    ...
    //=============================================================================
    bool ProgramOptions::haveQuietMode()
    {
        if (_isvalid)
        {
            return _quietmode;
    ...
    //=============================================================================
    bool ProgramOptions::haveTimeout()
    {
        if (_isvalid)
        {
            return (_timeout > 0);
    ...
    //=============================================================================
    std::wstring ProgramOptions::getErrorMessage()
    {
        return _error;
    }
    //=============================================================================
    std::wstring ProgramOptions::getFileToExecute()
    {
        return _file;
    }
    //=============================================================================
    std::wstring ProgramOptions::getCommandToExecute()
    {
        return _command;
    }
    //=============================================================================
    std::wstring ProgramOptions::getOptionsHelp()
    {
        return _options;
    }
    //=============================================================================
    std::wstring ProgramOptions::getLanguage()
    {
        return _lang;
    }
    //=============================================================================
