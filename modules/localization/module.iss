...
;==============================================================================
Source: {#RootPath}bin\{#BinPath}\libnlsLocalization.dll; DestDir: {app}\bin\{#BinPath}\;
Source: {#RootPath}bin\{#BinPath}\libnlsLocalization_builtin.dll; DestDir: {app}\bin\{#BinPath}\;
;==============================================================================
