...
#define DIR_SEPARATOR_OTHERS L'/'
	//=============================================================================
	static bool IsDirectory(std::wstring str)
	{
	...
	//=============================================================================
	static void splitpath(std::wstring &prefix, std::wstring &path, std::wstring &fname)
	{
		...
		{
#ifdef _MSC_VER
			if ((prefix[k] == DIR_SEPARATOR_OTHERS) || (prefix[k] == DIR_SEPARATOR_WINDOWS)) lastslash_pos = k;
#else
			if (prefix[k] == DIR_SEPARATOR_OTHERS) lastslash_pos = k;
#endif
		}
