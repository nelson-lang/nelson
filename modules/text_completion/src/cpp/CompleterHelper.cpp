...
namespace Nelson {
    //=============================================================================
    static size_t searchMatchingPrefixAndSuffix(std::wstring line, std::wstring toFind)
    {
        ...
        do
        {
            ...
            wchar_t* pointerOnLine = (wchar_t*)(line.c_str() + lineLength - wcslen(pointerToFindCopy) - 1);
    ...
    //=============================================================================
    std::wstring completerLine(std::wstring currentLine,
                               ...
                               bool stringToAddIsPath)
    {
        ...
        if ((currentLine[lengthCurrentLine - 1] == L'/') || (currentLine[lengthCurrentLine - 1] == L'\\'))
        {
