...
#define TEMP_VAR_NAME L"__eval_tmp_"
    ...
    //=============================================================================
    static int getScopeValue(SCOPE_LEVEL scope)
    {
        switch (scope)
        {
    ...
    //=============================================================================
    static ArrayOfVector EvaluateCommand(Evaluator *eval, int nLhs, std::wstring command, std::wstring catchCommand, SCOPE_LEVEL scope)
    {
