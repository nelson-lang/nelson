...
//=============================================================================
void LineManager::usesColors()
{
    bUsesColors = true;
}
//=============================================================================
std::wstring LineManager::getCurrentLine(void)
{
...
//=============================================================================
std::wstring LineManager::getLineBeforeCaret(void)
{
    boost::container::vector<wchar_t>::iterator itend = current_line_buffer.begin() + max_pos;
    std::wstring line(current_line_buffer.begin(), itend);
...
//=============================================================================
std::wstring LineManager::getLineAfterCaret(void)
{
...
//=============================================================================
void LineManager::moveBeginningLine(void)
{
    while (cur_pos > 0)
    {
        cur_pos -= 1;
...
//=============================================================================
void LineManager::moveEndLine(void)
{
...
//=============================================================================
void LineManager::moveBackSingleChar(void)
{
    if (cur_pos > 0)
    {
        cur_pos -= 1;
...
//=============================================================================
void LineManager::moveForwardSingleChar(void)
{
    if (cur_pos < max_pos)
    {
...
//=============================================================================
void LineManager::moveBackSingleWord(void)
{
...
//=============================================================================
void LineManager::moveForwardSingleWord(void)
{
...
//=============================================================================
void LineManager::killCurrentPositionToEndLine(void)
{
...
//=============================================================================
void LineManager::deletePreviousChar(void)
{
    if (cur_pos > 0)
    {
        cur_pos -= 1;
...
//=============================================================================
void LineManager::deleteCurrentChar(void)
{
    if (max_pos == 0)
    {
        doBeep();
...
//=============================================================================
void LineManager::moveBackHistory(void)
{
...
//=============================================================================
void LineManager::moveForwardHistory(void)
{
    if (current_line_buffer.size() == 0)
    {
        current_line_buffer.push_back(L'\0');
...
//=============================================================================
void LineManager::redrawLine(void)
{
...
//=============================================================================
void LineManager::killLastWord(void)
{
...
//=============================================================================
void LineManager::clearCurrentLine(bool withPrompt)
{
    current_line_buffer.clear();
    current_line_buffer.push_back(L'\0');
    moveBeginningLine();
...
//=============================================================================
void LineManager::setCurrentPrompt(std::wstring prompt)
{
    currentPrompt = prompt;
}
//=============================================================================
void LineManager::doBeep()
{
    MessageBeep(MB_OK);
}
//=============================================================================
int LineManager::putCharacter(wchar_t wch, outputStyle eAsStyle)
{
    std::wstring wchs = L"";
    wchs.push_back(wch);
...
//=============================================================================
int LineManager::printCharacters(std::wstring buffer, outputStyle eAsStyle)
{
    DWORD n = 0;
    int background = 0;
    int foreground = 0;
...
//=============================================================================
void LineManager::displayPrompt(void)
{
    /* check position */
...
//=============================================================================
void LineManager::refreshLine(void)
{
...
//=============================================================================
void LineManager::copyLine(std::wstring line)
{
    if (line.size() > 0)
    {
        printCharacters(line, LineManager::STANDARD_INPUT);
...
//=============================================================================
void LineManager::addCharacterCurrentLine(wchar_t ch)
{
    for (size_t i = max_pos; i > cur_pos; i--)
    {
        if (i >= current_line_buffer.size())
...
//=============================================================================
void LineManager::backSpace(void)
{
    CONSOLE_SCREEN_BUFFER_INFO csbi;
    ::GetConsoleScreenBufferInfo(GetStdHandle(STD_OUTPUT_HANDLE), &csbi);
    int X = csbi.dwCursorPosition.X;
