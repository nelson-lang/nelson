...
namespace {
    ...
    public:
        IOModeGuard(Terminal& terminal_) : _terminal(terminal_) { }
        ~IOModeGuard(void)
        {
            try {
...
Replxx::ReplxxImpl::ReplxxImpl(
    std::istream& in_, std::ostream& out_, int in_fd_, int out_fd_, int err_fd_)
    : _utf8Buffer()
    , _data()
    , _pos(0)
    , _display()
    ...
    , _err_fd(err_fd_)
{
    ...
    _namedActions[action_names::INSERT_CHARACTER]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::INSERT_CHARACTER, _1);
    _namedActions[action_names::NEW_LINE]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::NEW_LINE, _1);
    _namedActions[action_names::MOVE_CURSOR_TO_BEGINING_OF_LINE]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::MOVE_CURSOR_TO_BEGINING_OF_LINE, _1);
    _namedActions[action_names::MOVE_CURSOR_TO_END_OF_LINE]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::MOVE_CURSOR_TO_END_OF_LINE, _1);
    _namedActions[action_names::MOVE_CURSOR_LEFT]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::MOVE_CURSOR_LEFT, _1);
    _namedActions[action_names::MOVE_CURSOR_RIGHT]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::MOVE_CURSOR_RIGHT, _1);
    _namedActions[action_names::MOVE_CURSOR_ONE_WORD_LEFT]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::MOVE_CURSOR_ONE_WORD_LEFT, _1);
    _namedActions[action_names::MOVE_CURSOR_ONE_WORD_RIGHT]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::MOVE_CURSOR_ONE_WORD_RIGHT, _1);
    _namedActions[action_names::MOVE_CURSOR_ONE_SUBWORD_LEFT]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::MOVE_CURSOR_ONE_SUBWORD_LEFT, _1);
    _namedActions[action_names::MOVE_CURSOR_ONE_SUBWORD_RIGHT]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::MOVE_CURSOR_ONE_SUBWORD_RIGHT, _1);
    _namedActions[action_names::KILL_TO_WHITESPACE_ON_LEFT]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::KILL_TO_WHITESPACE_ON_LEFT, _1);
    _namedActions[action_names::KILL_TO_END_OF_WORD]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::KILL_TO_END_OF_WORD, _1);
    _namedActions[action_names::KILL_TO_BEGINING_OF_WORD]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::KILL_TO_BEGINING_OF_WORD, _1);
    _namedActions[action_names::KILL_TO_END_OF_SUBWORD]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::KILL_TO_END_OF_SUBWORD, _1);
    _namedActions[action_names::KILL_TO_BEGINING_OF_SUBWORD]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::KILL_TO_BEGINING_OF_SUBWORD, _1);
    _namedActions[action_names::KILL_TO_BEGINING_OF_LINE]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::KILL_TO_BEGINING_OF_LINE, _1);
    _namedActions[action_names::KILL_TO_END_OF_LINE]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::KILL_TO_END_OF_LINE, _1);
    _namedActions[action_names::YANK]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::YANK, _1);
    _namedActions[action_names::YANK_CYCLE]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::YANK_CYCLE, _1);
    _namedActions[action_names::YANK_LAST_ARG]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::YANK_LAST_ARG, _1);
    _namedActions[action_names::CAPITALIZE_WORD]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::CAPITALIZE_WORD, _1);
    _namedActions[action_names::LOWERCASE_WORD]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::LOWERCASE_WORD, _1);
    _namedActions[action_names::UPPERCASE_WORD]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::UPPERCASE_WORD, _1);
    _namedActions[action_names::CAPITALIZE_SUBWORD]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::CAPITALIZE_SUBWORD, _1);
    _namedActions[action_names::LOWERCASE_SUBWORD]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::LOWERCASE_SUBWORD, _1);
    _namedActions[action_names::UPPERCASE_SUBWORD]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::UPPERCASE_SUBWORD, _1);
    _namedActions[action_names::TRANSPOSE_CHARACTERS]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::TRANSPOSE_CHARACTERS, _1);
    _namedActions[action_names::ABORT_LINE]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::ABORT_LINE, _1);
    _namedActions[action_names::SEND_EOF]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::SEND_EOF, _1);
    _namedActions[action_names::TOGGLE_OVERWRITE_MODE]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::TOGGLE_OVERWRITE_MODE, _1);
    _namedActions[action_names::DELETE_CHARACTER_UNDER_CURSOR]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::DELETE_CHARACTER_UNDER_CURSOR, _1);
    _namedActions[action_names::DELETE_CHARACTER_LEFT_OF_CURSOR]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::DELETE_CHARACTER_LEFT_OF_CURSOR, _1);
    _namedActions[action_names::COMMIT_LINE]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::COMMIT_LINE, _1);
    _namedActions[action_names::CLEAR_SCREEN]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::CLEAR_SCREEN, _1);
    _namedActions[action_names::COMPLETE_NEXT]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::COMPLETE_NEXT, _1);
    _namedActions[action_names::COMPLETE_PREVIOUS]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::COMPLETE_PREVIOUS, _1);
    _namedActions[action_names::LINE_NEXT]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::LINE_NEXT, _1);
    _namedActions[action_names::LINE_PREVIOUS]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::LINE_PREVIOUS, _1);
    _namedActions[action_names::HISTORY_NEXT]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::HISTORY_NEXT, _1);
    _namedActions[action_names::HISTORY_PREVIOUS]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::HISTORY_PREVIOUS, _1);
    _namedActions[action_names::HISTORY_LAST]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::HISTORY_LAST, _1);
    _namedActions[action_names::HISTORY_FIRST]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::HISTORY_FIRST, _1);
    _namedActions[action_names::HISTORY_RESTORE]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::HISTORY_RESTORE, _1);
    _namedActions[action_names::HISTORY_RESTORE_CURRENT]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::HISTORY_RESTORE_CURRENT, _1);
    _namedActions[action_names::HINT_PREVIOUS]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::HINT_PREVIOUS, _1);
    _namedActions[action_names::HINT_NEXT]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::HINT_NEXT, _1);
#ifndef _WIN32
    _namedActions[action_names::VERBATIM_INSERT]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::VERBATIM_INSERT, _1);
    _namedActions[action_names::SUSPEND]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::SUSPEND, _1);
#else
    _namedActions[action_names::VERBATIM_INSERT] = _namedActions[action_names::SUSPEND]
        = Replxx::key_press_handler_t();
#endif
    _namedActions[action_names::COMPLETE_LINE]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::COMPLETE_LINE, _1);
    _namedActions[action_names::HISTORY_INCREMENTAL_SEARCH]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::HISTORY_INCREMENTAL_SEARCH, _1);
    _namedActions[action_names::HISTORY_SEEDED_INCREMENTAL_SEARCH] = std::bind(
        &ReplxxImpl::invoke, this, Replxx::ACTION::HISTORY_SEEDED_INCREMENTAL_SEARCH, _1);
    _namedActions[action_names::HISTORY_COMMON_PREFIX_SEARCH]
        = std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::HISTORY_COMMON_PREFIX_SEARCH, _1);

    bind_key(
        Replxx::KEY::control('A'), _namedActions.at(action_names::MOVE_CURSOR_TO_BEGINING_OF_LINE));
    bind_key(
        Replxx::KEY::HOME + 0, _namedActions.at(action_names::MOVE_CURSOR_TO_BEGINING_OF_LINE));
    ...
    bind_key(Replxx::KEY::control(Replxx::KEY::LEFT),
        _namedActions.at(action_names::MOVE_CURSOR_ONE_WORD_LEFT));
    bind_key(Replxx::KEY::meta(Replxx::KEY::LEFT),
        _namedActions.at(
            action_names::MOVE_CURSOR_ONE_WORD_LEFT)); // Emacs allows Meta, readline don't
    ...
    bind_key(Replxx::KEY::control(Replxx::KEY::RIGHT),
        _namedActions.at(action_names::MOVE_CURSOR_ONE_WORD_RIGHT));
    bind_key(Replxx::KEY::meta(Replxx::KEY::RIGHT),
        _namedActions.at(
            action_names::MOVE_CURSOR_ONE_WORD_RIGHT)); // Emacs allows Meta, readline don't
    bind_key(Replxx::KEY::meta(Replxx::KEY::BACKSPACE),
        _namedActions.at(action_names::KILL_TO_WHITESPACE_ON_LEFT));
    ...
    bind_key(
        Replxx::KEY::DELETE + 0, _namedActions.at(action_names::DELETE_CHARACTER_UNDER_CURSOR));
    bind_key(Replxx::KEY::BACKSPACE + 0,
        _namedActions.at(action_names::DELETE_CHARACTER_LEFT_OF_CURSOR));
    ...
    bind_key(
        Replxx::KEY::meta('r'), _namedActions.at(action_names::HISTORY_SEEDED_INCREMENTAL_SEARCH));
    ...
    bind_key(Replxx::KEY::meta('N'), _namedActions.at(action_names::HISTORY_COMMON_PREFIX_SEARCH));
    bind_key(Replxx::KEY::PASTE_START,
        std::bind(&ReplxxImpl::invoke, this, Replxx::ACTION::BRACKETED_PASTE, _1));
}
...
Replxx::ReplxxImpl::invoke(Replxx::ACTION action_, char32_t code)
{
    switch (action_) {
    case (Replxx::ACTION::INSERT_CHARACTER):
        return (action(RESET_KILL_ACTION | HISTORY_RECALL_MOST_RECENT,
            &Replxx::ReplxxImpl::insert_character, code));
    case (Replxx::ACTION::NEW_LINE):
        return (action(
            RESET_KILL_ACTION | HISTORY_RECALL_MOST_RECENT, &Replxx::ReplxxImpl::new_line, code));
    case (Replxx::ACTION::DELETE_CHARACTER_UNDER_CURSOR):
        return (action(RESET_KILL_ACTION | HISTORY_RECALL_MOST_RECENT,
            &Replxx::ReplxxImpl::delete_character, code));
    case (Replxx::ACTION::DELETE_CHARACTER_LEFT_OF_CURSOR):
        return (action(RESET_KILL_ACTION | HISTORY_RECALL_MOST_RECENT,
            &Replxx::ReplxxImpl::backspace_character, code));
    case (Replxx::ACTION::KILL_TO_END_OF_LINE):
        return (action(WANT_REFRESH | SET_KILL_ACTION | HISTORY_RECALL_MOST_RECENT,
            &Replxx::ReplxxImpl::kill_to_end_of_line, code));
    case (Replxx::ACTION::KILL_TO_BEGINING_OF_LINE):
        return (action(SET_KILL_ACTION | HISTORY_RECALL_MOST_RECENT,
            &Replxx::ReplxxImpl::kill_to_begining_of_line, code));
    case (Replxx::ACTION::KILL_TO_END_OF_WORD):
        return (action(SET_KILL_ACTION | HISTORY_RECALL_MOST_RECENT,
            &Replxx::ReplxxImpl::kill_word_to_right<false>, code));
    case (Replxx::ACTION::KILL_TO_BEGINING_OF_WORD):
        return (action(SET_KILL_ACTION | HISTORY_RECALL_MOST_RECENT,
            &Replxx::ReplxxImpl::kill_word_to_left<false>, code));
    case (Replxx::ACTION::KILL_TO_END_OF_SUBWORD):
        return (action(SET_KILL_ACTION | HISTORY_RECALL_MOST_RECENT,
            &Replxx::ReplxxImpl::kill_word_to_right<true>, code));
    case (Replxx::ACTION::KILL_TO_BEGINING_OF_SUBWORD):
        return (action(SET_KILL_ACTION | HISTORY_RECALL_MOST_RECENT,
            &Replxx::ReplxxImpl::kill_word_to_left<true>, code));
    case (Replxx::ACTION::KILL_TO_WHITESPACE_ON_LEFT):
        return (action(SET_KILL_ACTION | HISTORY_RECALL_MOST_RECENT,
            &Replxx::ReplxxImpl::kill_to_whitespace_to_left, code));
    ...
    case (Replxx::ACTION::YANK_LAST_ARG):
        return (action(HISTORY_RECALL_MOST_RECENT | DONT_RESET_HIST_YANK_INDEX,
            &Replxx::ReplxxImpl::yank_last_arg, code));
    case (Replxx::ACTION::MOVE_CURSOR_TO_BEGINING_OF_LINE):
        return (action(
            MOVE_CURSOR | RESET_KILL_ACTION, &Replxx::ReplxxImpl::go_to_begining_of_line, code));
    case (Replxx::ACTION::MOVE_CURSOR_TO_END_OF_LINE):
        return (
            action(MOVE_CURSOR | RESET_KILL_ACTION, &Replxx::ReplxxImpl::go_to_end_of_line, code));
    case (Replxx::ACTION::MOVE_CURSOR_ONE_WORD_LEFT):
        return (action(
            MOVE_CURSOR | RESET_KILL_ACTION, &Replxx::ReplxxImpl::move_one_word_left<false>, code));
    case (Replxx::ACTION::MOVE_CURSOR_ONE_WORD_RIGHT):
        return (action(MOVE_CURSOR | RESET_KILL_ACTION,
            &Replxx::ReplxxImpl::move_one_word_right<false>, code));
    case (Replxx::ACTION::MOVE_CURSOR_ONE_SUBWORD_LEFT):
        return (action(
            MOVE_CURSOR | RESET_KILL_ACTION, &Replxx::ReplxxImpl::move_one_word_left<true>, code));
    case (Replxx::ACTION::MOVE_CURSOR_ONE_SUBWORD_RIGHT):
        return (action(
            MOVE_CURSOR | RESET_KILL_ACTION, &Replxx::ReplxxImpl::move_one_word_right<true>, code));
    case (Replxx::ACTION::MOVE_CURSOR_LEFT):
        return (
            action(MOVE_CURSOR | RESET_KILL_ACTION, &Replxx::ReplxxImpl::move_one_char_left, code));
    case (Replxx::ACTION::MOVE_CURSOR_RIGHT):
        return (action(
            MOVE_CURSOR | RESET_KILL_ACTION, &Replxx::ReplxxImpl::move_one_char_right, code));
    ...
    case (Replxx::ACTION::HISTORY_PREVIOUS):
        return (
            action(MOVE_CURSOR | RESET_KILL_ACTION, &Replxx::ReplxxImpl::history_previous, code));
    ...
    case (Replxx::ACTION::HISTORY_RESTORE_CURRENT):
        return (action(
            MOVE_CURSOR | RESET_KILL_ACTION, &Replxx::ReplxxImpl::history_restore_current, code));
    case (Replxx::ACTION::HISTORY_RESTORE):
        return (
            action(MOVE_CURSOR | RESET_KILL_ACTION, &Replxx::ReplxxImpl::history_restore, code));
    ...
    case (Replxx::ACTION::HISTORY_COMMON_PREFIX_SEARCH):
        return (action(RESET_KILL_ACTION | DONT_RESET_PREFIX,
            &Replxx::ReplxxImpl::common_prefix_search, code));
    ...
    case (Replxx::ACTION::CAPITALIZE_WORD):
        return (action(RESET_KILL_ACTION | HISTORY_RECALL_MOST_RECENT,
            &Replxx::ReplxxImpl::capitalize_word<false>, code));
    case (Replxx::ACTION::LOWERCASE_WORD):
        return (action(RESET_KILL_ACTION | HISTORY_RECALL_MOST_RECENT,
            &Replxx::ReplxxImpl::lowercase_word<false>, code));
    case (Replxx::ACTION::UPPERCASE_WORD):
        return (action(RESET_KILL_ACTION | HISTORY_RECALL_MOST_RECENT,
            &Replxx::ReplxxImpl::uppercase_word<false>, code));
    case (Replxx::ACTION::CAPITALIZE_SUBWORD):
        return (action(RESET_KILL_ACTION | HISTORY_RECALL_MOST_RECENT,
            &Replxx::ReplxxImpl::capitalize_word<true>, code));
    case (Replxx::ACTION::LOWERCASE_SUBWORD):
        return (action(RESET_KILL_ACTION | HISTORY_RECALL_MOST_RECENT,
            &Replxx::ReplxxImpl::lowercase_word<true>, code));
    case (Replxx::ACTION::UPPERCASE_SUBWORD):
        return (action(RESET_KILL_ACTION | HISTORY_RECALL_MOST_RECENT,
            &Replxx::ReplxxImpl::uppercase_word<true>, code));
    case (Replxx::ACTION::TRANSPOSE_CHARACTERS):
        return (action(RESET_KILL_ACTION | HISTORY_RECALL_MOST_RECENT,
            &Replxx::ReplxxImpl::transpose_characters, code));
    ...
    case (Replxx::ACTION::VERBATIM_INSERT):
        return (
            action(WANT_REFRESH | RESET_KILL_ACTION, &Replxx::ReplxxImpl::verbatim_insert, code));
    ...
    case (Replxx::ACTION::COMPLETE_NEXT):
        return (action(RESET_KILL_ACTION | DONT_RESET_COMPLETIONS | HISTORY_RECALL_MOST_RECENT,
            &Replxx::ReplxxImpl::complete_next, code));
    case (Replxx::ACTION::COMPLETE_PREVIOUS):
        return (action(RESET_KILL_ACTION | DONT_RESET_COMPLETIONS | HISTORY_RECALL_MOST_RECENT,
            &Replxx::ReplxxImpl::complete_previous, code));
    ...
    case (Replxx::ACTION::ABORT_LINE):
        return (action(
            RESET_KILL_ACTION | HISTORY_RECALL_MOST_RECENT, &Replxx::ReplxxImpl::abort_line, code));
    ...
    case (Replxx::ACTION::BRACKETED_PASTE):
        return (action(WANT_REFRESH | RESET_KILL_ACTION | HISTORY_RECALL_MOST_RECENT,
            &Replxx::ReplxxImpl::bracketed_paste, code));
    }
    return (Replxx::ACTION_RESULT::BAIL);
}

void
Replxx::ReplxxImpl::bind_key(char32_t code_, Replxx::key_press_handler_t handler_)
{
    _keyPressHandlers[code_] = handler_;
}

void
Replxx::ReplxxImpl::bind_key_internal(char32_t code_, char const* actionName_)
{
...
Replxx::State
Replxx::ReplxxImpl::get_state(void) const
{
...
void
Replxx::ReplxxImpl::set_state(Replxx::State const& state_)
{
...
void
Replxx::ReplxxImpl::set_ignore_case(bool val)
{
    _ignoreCase = val;
}

char32_t
Replxx::ReplxxImpl::read_char(HINT_ACTION hintAction_)
{
    ...
    int hintDelay(_refreshSkipped ? static_cast<int>(RAPID_REFRESH_MS * 2)
    ...
    while (true) {
        ...
        if (eventType == Terminal::EVENT_TYPE::MESSAGE) {
            return -3;
        }
...
void
Replxx::ReplxxImpl::call_modify_callback(void)
{
    if (!_modifyCallback) {
        return;
    }
...
Replxx::ReplxxImpl::completions_t
Replxx::ReplxxImpl::call_completer(std::string const& input, int& contextLen_) const
{
    Replxx::completions_t completionsIntermediary(
        !!_completionCallback ? _completionCallback(input, contextLen_) : Replxx::completions_t());
...
Replxx::ReplxxImpl::hints_t
Replxx::ReplxxImpl::call_hinter(
    std::string const& input, int& contextLen, Replxx::Color& color) const
{
    Replxx::hints_t hintsIntermediary(
        !!_hintCallback ? _hintCallback(input, contextLen, color) : Replxx::hints_t());
    hints_t hints;
...
void
Replxx::ReplxxImpl::set_preload_buffer(std::string const& preloadText)
{
...
char const*
Replxx::ReplxxImpl::read_from_stdin(void)
{
    ...
    while (!_preloadedBuffer.empty()
        && ((_preloadedBuffer.back() == '\r') || (_preloadedBuffer.back() == '\n'))) {
...
void
Replxx::ReplxxImpl::emulate_key_press(char32_t keyCode_)
{
    std::lock_guard<std::mutex> l(_mutex);
...
char const*
Replxx::ReplxxImpl::input(std::string const& prompt)
{
    try {
        errno = 0;
        if (!tty::is_a_tty(_in_fd)) { // input not from a terminal, we should work with piped input,
...
char const*
Replxx::ReplxxImpl::finalize_input(char const* retVal_)
{
    std::unique_lock<std::mutex> l(_mutex);
    while (!_messages.empty()) {
        string const& message(_messages.front());
...
int
Replxx::ReplxxImpl::install_window_change_handler(void)
{
#ifndef _WIN32
...
void
Replxx::ReplxxImpl::enable_bracketed_paste(void)
{
    if (_bracketedPaste) {
        return;
    }
...
void
Replxx::ReplxxImpl::disable_bracketed_paste(void)
{
    if (!_bracketedPaste) {
        return;
    }
...
void
Replxx::ReplxxImpl::print(char const* str_, int size_)
{
    std::unique_lock<std::mutex> l(_mutex);
    if ((_currentThread == std::thread::id()) || (_currentThread == std::this_thread::get_id())) {
#ifndef _WIN32
...
void
Replxx::ReplxxImpl::set_prompt(std::string prompt)
{
    std::unique_lock<std::mutex> l(_mutex);
...
void
Replxx::ReplxxImpl::preload_puffer(const char* preloadText)
{
...
void
Replxx::ReplxxImpl::set_color(Replxx::Color color_)
{
...
void
Replxx::ReplxxImpl::render(char32_t ch)
{
...
void
Replxx::ReplxxImpl::render(HINT_ACTION hintAction_)
{
...
void
Replxx::ReplxxImpl::handle_hints(HINT_ACTION hintAction_)
{
    if (_noColor) {
        return;
    }
    ...
    if (hintCount == 1) {
        ...
        int startCol(
            (_indentMultiline || (posInLine == _pos) ? _prompt.indentation() : 0) + posInLine);
...
Replxx::ReplxxImpl::paren_info_t
Replxx::ReplxxImpl::matching_paren(void)
{
    if (_pos >= _data.length()) {
...
int
Replxx::ReplxxImpl::virtual_render(
    char32_t const* buffer_, int len_, int& xPos_, int& yPos_, Prompt const* prompt_)
{
    Prompt const& prompt(prompt_ ? *prompt_ : _prompt);
    return (replxx::virtual_render(buffer_, len_, xPos_, yPos_, prompt.screen_columns(),
                _indentMultiline ? prompt.indentation() : 0),
        _out_fd);
}
 ...
 */
void
Replxx::ReplxxImpl::refresh_line(HINT_ACTION hintAction_, bool refreshPrompt_)
{
    ...
    replxx::virtual_render(_display.data(), static_cast<int>(_display.size()), xEndOfInput,
        yEndOfInput, _prompt.screen_columns(), 0);
    ...
    if (refreshPrompt_) {
        ...
        _terminal.jump_cursor(_prompt.indentation(), // 0-based on Win32
            -(_prompt._cursorRowOffset - _prompt._extraLines));
    }
    ...
    if (_hasNewlines) {
        ...
        _terminal.clear_screen(Terminal::CLEAR_SCREEN::TO_END);
        _terminal.write32(_display.data() + _displayInputLength,
            static_cast<int>(_display.size()) - _displayInputLength);
    }
#ifndef _WIN32
...
void
Replxx::ReplxxImpl::move_cursor(void)
{
    // calculate the desired position of the cursor
    int xCursorPos(_prompt.indentation());
    int yCursorPos(0);
    ...
    _terminal.jump_cursor(
        xCursorPos, -(_prompt._cursorRowOffset - _prompt._extraLines - yCursorPos));
...
int
Replxx::ReplxxImpl::context_length()
{
...
void
Replxx::ReplxxImpl::repaint(void)
{
    _prompt.write();
...
void
Replxx::ReplxxImpl::clear_self_to_end_of_screen(Prompt const* prompt_)
{
...
namespace {
    ...
    int
    longest_common_prefix(Replxx::ReplxxImpl::completions_t const& completions, bool ignoreCase)
    {
 ...
 */
char32_t
Replxx::ReplxxImpl::do_complete_line(bool showCompletions_)
{
    char32_t c = 0;
    ...
    if (completionsCount == 1) {
        ...
        bool ignoreCase(_ignoreCase
            && std::none_of(_data.end() - _completionContextLength, _data.end(),
                [](char32_t x) { return iswupper(static_cast<wint_t>(x)); }));
    ...
    if ((longestCommonPrefix > _completionContextLength) || (completionsCount == 1)) {
        ...
        if (_ignoreCase && (_hintSelection == -1)) {
            ...
            for (int i(0); i < completionsCount; ++i) {
                candidate_prefixes.emplace(std::piecewise_construct,
                ...
                bool prefix_all_lower(std::none_of(valid_prefix.begin(), valid_prefix.end(),
                    [](char32_t x) { return iswupper(static_cast<wint_t>(x)); }));
    ...
    if (static_cast<int>(_completions.size()) > _completionCountCutoff) {
        ...
        dprintf(_out_fd, "\nDisplay all %u possibilities? (y or n)",
            static_cast<unsigned int>(_completions.size()));
        fsync(_out_fd);
        onNewLine = true;
        ...
        for (size_t row = 0; row < rowCount; ++row) {
            ...
            for (int column = 0; column < columnCount; ++column) {
                ...
                if (index < _completions.size()) {
                    ...
                    _terminal.write32(
                        c.text().get() + longestCommonPrefix, itemLength - longestCommonPrefix);
                    if (!_noColor && (c.color() != Replxx::Color::DEFAULT)) {
                        _terminal.write32(res.get(), res.length());
                    }
...
int
Replxx::ReplxxImpl::get_input_line(bool& isAction)
{
    isAction = false;
    ...
    while (next == Replxx::ACTION_RESULT::CONTINUE) {
        ...
        if (it != _keyPressHandlers.end()) {
            ...
            next = action(RESET_KILL_ACTION | HISTORY_RECALL_MOST_RECENT,
                &Replxx::ReplxxImpl::insert_character, c);
        }
    }
...
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::action(
    action_trait_t actionTrait_, key_press_handler_raw_t const& handler_, char32_t code_)
{
    ...
    if (actionTrait_ & MOVE_CURSOR) {
        _modifiedState = (_pos != _oldPos)
            && ((_pos == _data.length()) || (_oldPos == _data.length())
                ...
                || ((_pos < _data.length() && isIdentifier((char)_data[_pos]))
                    != (_oldPos < _data.length() && isIdentifier((char)_data[_oldPos]))));
...
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::insert_character(char32_t c)
{
    /*
    ...
    if ((_pos == _data.length()) && !_modifiedState
        && (_noColor
            || !(!!_highlighterCallback || !!_highlighterCallbackWithPosition || !!_hintCallback))
        && (yCursorPos == 0)) {
...
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::new_line(char32_t)
{
...
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::go_to_begining_of_line(char32_t char_)
{
    if (_hasNewlines) {
...
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::go_to_end_of_line(char32_t char_)
{
    if (_hasNewlines) {
        int newPos(next_newline_position(_pos));
        _pos = (newPos < 0) || ((newPos == _pos) && (char_ == Replxx::KEY::control('E')))
            ? _data.length()
            : newPos;
    } else {
        _pos = _data.length();
...
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::move_one_char_left(char32_t)
{
    if (_pos > 0) {
        --_pos;
    }
...
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::move_one_char_right(char32_t)
{
    if (_pos < _data.length()) {
        ++_pos;
    }
...
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::move_one_word_left(char32_t)
{
    if (_pos > 0) {
...
template <bool subword>
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::move_one_word_right(char32_t)
{
    if (_pos < _data.length()) {
...
template <bool subword>
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::kill_word_to_left(char32_t)
{
    if (_pos > 0) {
...
template <bool subword>
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::kill_word_to_right(char32_t)
{
    if (_pos < _data.length()) {
        int endingPos = _pos;
...
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::kill_to_whitespace_to_left(char32_t)
{
    if (_pos > 0) {
        int startingPos = _pos;
...
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::kill_to_end_of_line(char32_t)
{
    int to(_data.length());
    if (_hasNewlines) {
...
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::kill_to_begining_of_line(char32_t)
{
    if (_pos <= 0) {
        return (Replxx::ACTION_RESULT::CONTINUE);
    }
...
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::yank(char32_t)
{
...
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::yank_cycle(char32_t)
{
...
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::yank_last_arg(char32_t)
{
    if (_history.size() < 2) {
        return (Replxx::ACTION_RESULT::CONTINUE);
    }
...
template <bool subword>
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::capitalize_word(char32_t)
{
    if (_pos < _data.length()) {
        while (_pos < _data.length() && is_word_break_character<subword>(_data[_pos])) {
            ++_pos;
...
template <bool subword>
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::lowercase_word(char32_t)
{
    if (_pos < _data.length()) {
        while (_pos < _data.length() && is_word_break_character<subword>(_data[_pos])) {
            ++_pos;
...
template <bool subword>
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::uppercase_word(char32_t)
{
    if (_pos < _data.length()) {
        while (_pos < _data.length() && is_word_break_character<subword>(_data[_pos])) {
            ++_pos;
...
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::transpose_characters(char32_t)
{
    if (_pos > 0 && _data.length() > 1) {
        size_t leftCharPos = (_pos == _data.length()) ? _pos - 2 : _pos - 1;
        char32_t aux = _data[static_cast<int>(leftCharPos)];
        _data[static_cast<int>(leftCharPos + 1)] = aux;
        if (_pos != _data.length()) {
            ++_pos;
        }
        refresh_line();
...
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::abort_line(char32_t keyCode_)
{
    errno = EAGAIN;
    _history.drop_last();
...
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::delete_character(char32_t)
{
...
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::send_eof(char32_t key_)
{
    if (_data.length() == 0) {
        _history.drop_last();
        return (Replxx::ACTION_RESULT::BAIL);
...
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::backspace_character(char32_t)
{
    if (_pos > 0) {
        --_pos;
        _data.erase(_pos);
...
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::commit_line(char32_t)
{
    // we need one last refresh with the cursor at the end of the line
    // so we don't display the next prompt over the previous input line
    _pos = _data.length(); // pass _data.length() as _pos for EOL
...
int
Replxx::ReplxxImpl::prev_newline_position(int pos_) const
{
...
int
Replxx::ReplxxImpl::next_newline_position(int pos_) const
{
...
int
Replxx::ReplxxImpl::pos_in_line(void) const
{
    if (!_hasNewlines) {
        return (_pos);
    }
...
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::line_previous(char32_t)
{
    ...
    do {
        ...
        int prevLineStart(
            prevNewlinePosition > 0 ? prev_newline_position(prevNewlinePosition - 1) + 1 : 0);
...
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::line_next(char32_t)
{
    assert((_pos >= 0) && (_pos <= _data.length()));
    do {
        if (!_hasNewlines) {
...
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::history_next(char32_t)
{
    return (history_move(false));
}

Replxx::ACTION_RESULT
Replxx::ReplxxImpl::history_previous(char32_t)
{
    return (history_move(true));
}

Replxx::ACTION_RESULT
Replxx::ReplxxImpl::history_move(bool previous_)
{
...
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::history_first(char32_t)
{
    do {
        if (!_hasNewlines) {
            break;
...
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::history_last(char32_t)
{
    do {
        if (!_hasNewlines) {
            break;
...
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::history_restore_current(char32_t)
{
...
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::history_restore(char32_t)
{
...
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::history_jump(bool back_)
{
    // if not already recalling, add the current line to the history list so
    // we don't
...
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::hint_next(char32_t)
{
    return (hint_move(false));
}

Replxx::ACTION_RESULT
Replxx::ReplxxImpl::hint_previous(char32_t)
{
    return (hint_move(true));
}

Replxx::ACTION_RESULT
Replxx::ReplxxImpl::hint_move(bool previous_)
{
    if (!_noColor) {
        _killRing.lastAction = KillRing::actionOther;
        if (previous_) {
...
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::toggle_overwrite_mode(char32_t)
{
...
#ifndef _WIN32
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::verbatim_insert(char32_t)
{
...
// ctrl-Z, job control
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::suspend(char32_t)
{
    /* IOModeGuard scope */ {
        IOModeGuard ioModeGuard(_terminal);
...
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::complete_line(char32_t c)
{
...
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::complete(bool previous_)
{
    if (_completions.empty()) {
    ...
    if (_completionSelection != -1) {
        int oldCompletionLength(
            max(_completions[_completionSelection].text().length() - _completionContextLength, 0));
        _pos -= oldCompletionLength;
        _data.erase(_pos, oldCompletionLength);
    }
    if (newSelection != -1) {
        int newCompletionLength(
            max(_completions[newSelection].text().length() - _completionContextLength, 0));
        _data.insert(
            _pos, _completions[newSelection].text(), _completionContextLength, newCompletionLength);
...
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::complete_next(char32_t)
{
    return (complete(false));
}

Replxx::ACTION_RESULT
Replxx::ReplxxImpl::complete_previous(char32_t)
{
...
// Alt-N, forward history search for prefix
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::common_prefix_search(char32_t startChar)
{
    if (_history.common_prefix_search(_data, _prefix,
            (startChar == (Replxx::KEY::meta('p'))) || (startChar == (Replxx::KEY::meta('P'))),
            _ignoreCase)) {
        _data.assign(_history.current());
        _pos = _data.length();
        refresh_line();
 ...
 */
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::incremental_history_search(char32_t startChar)
{
    ...
    while (keepLooping) {
        ...
        case Replxx::KEY::meta('r'): {
            ...
            if (((dp._direction == 1)
                    && ((c == Replxx::KEY::control('R')) || (c == Replxx::KEY::meta('r'))))
...
// job control is its own thing
        ...
        case Replxx::KEY::control('Z'): { // ctrl-Z, job control
            ...
            dynamic_refresh(
                dp, dp, activeHistoryLine.get(), activeHistoryLine.length(), historyLinePosition);
            continue;
        } break;
#endif
        ...
        default: {
            if (!is_control_code(c)
                && (c < static_cast<int>(Replxx::KEY::BASE))) { // not an action character
        ...
        if (dp._searchText.length() > 0) {
            ...
            searchAgain = false;
            bool ignoreCase(_ignoreCase
                && std::none_of(dp._searchText.begin(), dp._searchText.end(),
                    [](char32_t x) { return iswupper(static_cast<wint_t>(x)); }));
            while (true) {
                while (dp._direction < 0 ? (lineSearchPos >= 0)
                    ...
                    if ((lineSearchPos >= 0)
                        ...
                        && std::equal(dp._searchText.begin(), dp._searchText.end(),
                            activeHistoryLine.begin() + lineSearchPos,
                ...
                if (found) {
                    ...
                    activeHistoryLine.assign(_history.current());
                    lineSearchPos = (dp._direction > 0)
                        ? 0
                        : (activeHistoryLine.length() - dp._searchText.length());
                } else {
                    historyLinePosition = _pos;
                    beep(_err_fd);
                    break;
        ...
        activeHistoryLine.assign(_history.current());
        dynamic_refresh(dp, dp, activeHistoryLine.get(), activeHistoryLine.length(),
    ...
    // current
    Prompt pb(_terminal);
    UnicodeString tempUnicode(&_prompt._text[_prompt._lastLinePosition],
        _prompt._text.length() - _prompt._lastLinePosition);
    ...
    dynamic_refresh(pb, _prompt, _data.get(), _data.length(),
...
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::clear_screen(char32_t c)
{
...
Replxx::ACTION_RESULT
Replxx::ReplxxImpl::bracketed_paste(char32_t)
{
...
template <bool subword>
bool
Replxx::ReplxxImpl::is_word_break_character(char32_t char_) const
{
    bool wbc(false);
    if (char_ < 128) {
        wbc = strchr(subword ? _subwordBreakChars.c_str() : _wordBreakChars.c_str(),
                  static_cast<char>(char_))
            != nullptr;
    }
    return (wbc);
}
...
void
Replxx::ReplxxImpl::history_add(std::string const& line)
{
    _history.add(UnicodeString(line));
}

bool
Replxx::ReplxxImpl::history_save(std::string const& filename)
{
    return (_history.save(filename, false));
}

void
Replxx::ReplxxImpl::history_save(std::ostream& out)
{
    _history.save(out);
}

bool
Replxx::ReplxxImpl::history_sync(std::string const& filename)
{
    return (_history.save(filename, true));
}

bool
Replxx::ReplxxImpl::history_load(std::string const& filename)
{
    return (_history.load(filename));
}

void
Replxx::ReplxxImpl::history_load(std::istream& in)
{
    _history.load(in);
}

void
Replxx::ReplxxImpl::history_clear(void)
{
    _history.clear();
}

int
Replxx::ReplxxImpl::history_size(void) const
{
    return (_history.size());
}

Replxx::HistoryScan::impl_t
Replxx::ReplxxImpl::history_scan(void) const
{
    return (_history.scan());
}

void
Replxx::ReplxxImpl::set_modify_callback(Replxx::modify_callback_t const& fn)
{
    _modifyCallback = fn;
}

void
Replxx::ReplxxImpl::set_completion_callback(Replxx::completion_callback_t const& fn)
{
    _completionCallback = fn;
}

void
Replxx::ReplxxImpl::set_highlighter_callback(Replxx::highlighter_callback_t const& fn)
{
    _highlighterCallback = fn;
}

void
Replxx::ReplxxImpl::set_highlighter_callback_with_pos(
    Replxx::highlighter_callback_with_pos_t const& fn)
{
    _highlighterCallbackWithPosition = fn;
}

void
Replxx::ReplxxImpl::set_hint_callback(Replxx::hint_callback_t const& fn)
{
    _hintCallback = fn;
}

void
Replxx::ReplxxImpl::set_max_history_size(int len)
{
    _history.set_max_size(len);
}

void
Replxx::ReplxxImpl::set_completion_count_cutoff(int count)
{
    _completionCountCutoff = count;
}

void
Replxx::ReplxxImpl::set_max_hint_rows(int count)
{
    _maxHintRows = count;
}

void
Replxx::ReplxxImpl::set_hint_delay(int hintDelay_)
{
    _hintDelay = hintDelay_;
}

void
Replxx::ReplxxImpl::set_word_break_characters(char const* wordBreakers)
{
    _wordBreakChars = wordBreakers;
}

void
Replxx::ReplxxImpl::set_subword_break_characters(char const* subwordBreakers)
{
    _subwordBreakChars = subwordBreakers;
}

void
Replxx::ReplxxImpl::set_double_tab_completion(bool val)
{
    _doubleTabCompletion = val;
}

void
Replxx::ReplxxImpl::set_complete_on_empty(bool val)
{
    _completeOnEmpty = val;
}

void
Replxx::ReplxxImpl::set_beep_on_ambiguous_completion(bool val)
{
    _beepOnAmbiguousCompletion = val;
}

void
Replxx::ReplxxImpl::set_immediate_completion(bool val)
{
    _immediateCompletion = val;
}

void
Replxx::ReplxxImpl::set_unique_history(bool val)
{
    _history.set_unique(val);
}

void
Replxx::ReplxxImpl::set_no_color(bool val)
{
    _noColor = val;
}

void
Replxx::ReplxxImpl::set_indent_multiline(bool val)
{
 ...
 */
void
Replxx::ReplxxImpl::dynamic_refresh(
    Prompt& oldPrompt, Prompt& newPrompt, char32_t* buf32, int len, int pos)
{
    clear_self_to_end_of_screen(&oldPrompt);
    // calculate the position of the end of the prompt
    int xEndOfPrompt(0);
    int yEndOfPrompt(0);
    replxx::virtual_render(newPrompt._text.get(), newPrompt._text.length(), xEndOfPrompt,
        yEndOfPrompt, newPrompt.screen_columns(), 0);
...
#endif
    // position the cursor
    _terminal.jump_cursor(xCursorPos, // 0-based on Win32
