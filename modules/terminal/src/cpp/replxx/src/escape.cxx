...
namespace EscapeSequenceProcessing { // move these out of global namespace
    ...
    //
    char32_t
    doDispatch(int in_fd_, int err_fd_, char32_t c, CharacterDispatch& dispatchTable)
    {
    ...
    //
    static CharacterDispatchRoutine escLeftBracket1Semicolon2or3or5Routines[] = { upArrowKeyRoutine,
        downArrowKeyRoutine, rightArrowKeyRoutine, leftArrowKeyRoutine, homeKeyRoutine,
        endKeyRoutine, f1KeyRoutine, f2KeyRoutine, f3KeyRoutine, f4KeyRoutine, escFailureRoutine };
    ...
    static CharacterDispatchRoutine escLeftBracket1SemicolonRoutines[]
        = { escLeftBracket1Semicolon2Routine, escLeftBracket1Semicolon3Routine,
    ...
    static CharacterDispatchRoutine escLeftBracket15SemicolonRoutines[]
        = { escLeftBracket15Semicolon2Routine, escLeftBracket15Semicolon5Routine,
              escFailureRoutine };
    ...
    static CharacterDispatch escLeftBracket15Dispatch = { 2, "~;", escLeftBracket15Routines };
    static char32_t
    ...
    static CharacterDispatchRoutine escLeftBracket17SemicolonRoutines[]
        = { escLeftBracket17Semicolon2Routine, escLeftBracket17Semicolon5Routine,
              escFailureRoutine };
    ...
    static CharacterDispatch escLeftBracket17Dispatch = { 2, "~;", escLeftBracket17Routines };
    static char32_t
    ...
    static CharacterDispatchRoutine escLeftBracket18SemicolonRoutines[]
        = { escLeftBracket18Semicolon2Routine, escLeftBracket18Semicolon5Routine,
              escFailureRoutine };
    ...
    static CharacterDispatchRoutine escLeftBracket19SemicolonRoutines[]
        = { escLeftBracket19Semicolon2Routine, escLeftBracket19Semicolon5Routine,
              escFailureRoutine };
    ...
    static CharacterDispatch escLeftBracket19Dispatch = { 2, "~;", escLeftBracket19Routines };
    static char32_t
    ...
    // Handle ESC [ 1 <more stuff> escape sequences
    //
    static CharacterDispatchRoutine escLeftBracket1Routines[] = { homeKeyRoutine,
        escLeftBracket1SemicolonRoutine, escLeftBracket15Routine, escLeftBracket17Routine,
        escLeftBracket18Routine, escLeftBracket19Routine, escFailureRoutine };
    static CharacterDispatch escLeftBracket1Dispatch = { 6, "~;5789", escLeftBracket1Routines };
    ...
    static CharacterDispatchRoutine escLeftBracket20SemicolonRoutines[]
        = { escLeftBracket20Semicolon2Routine, escLeftBracket20Semicolon5Routine,
              escFailureRoutine };
    ...
    static CharacterDispatch escLeftBracket200Dispatch = { 1, "~", escLeftBracket200Routines };
    static char32_t
    ...
    static CharacterDispatch escLeftBracket201Dispatch = { 1, "~", escLeftBracket201Routines };
    static char32_t
    ...
    static CharacterDispatchRoutine escLeftBracket20Routines[]
        = { f9KeyRoutine, escLeftBracket20SemicolonRoutine, escLeftBracket200Routine,
              escLeftBracket201Routine, escFailureRoutine };
    static CharacterDispatch escLeftBracket20Dispatch = { 4, "~;01", escLeftBracket20Routines };
    static char32_t
    ...
    static CharacterDispatchRoutine escLeftBracket21SemicolonRoutines[]
        = { escLeftBracket21Semicolon2Routine, escLeftBracket21Semicolon5Routine,
              escFailureRoutine };
    ...
    static CharacterDispatch escLeftBracket21Dispatch = { 2, "~;", escLeftBracket21Routines };
    static char32_t
    ...
    static CharacterDispatchRoutine escLeftBracket23SemicolonRoutines[]
        = { escLeftBracket23Semicolon2Routine, escLeftBracket23Semicolon5Routine,
              escFailureRoutine };
    ...
    static CharacterDispatch escLeftBracket23Dispatch = { 2, "~;", escLeftBracket23Routines };
    static char32_t
    ...
    static CharacterDispatchRoutine escLeftBracket24SemicolonRoutines[]
        = { escLeftBracket24Semicolon2Routine, escLeftBracket24Semicolon5Routine,
              escFailureRoutine };
    ...
    static CharacterDispatchRoutine escLeftBracket2Routines[]
        = { insertKeyRoutine, escLeftBracket20Routine, escLeftBracket21Routine,
              escLeftBracket23Routine, escLeftBracket24Routine, escFailureRoutine };
    static CharacterDispatch escLeftBracket2Dispatch = { 5, "~0134", escLeftBracket2Routines };
    ...
    static CharacterDispatchRoutine escLeftBracket5SemicolonRoutines[]
        = { escLeftBracket5Semicolon5Routine, escFailureRoutine };
    ...
    static CharacterDispatch escLeftBracket5Dispatch = { 2, "~;", escLeftBracket5Routines };
    ...
    static CharacterDispatchRoutine escLeftBracket6SemicolonRoutines[]
        = { escLeftBracket6Semicolon5Routine, escFailureRoutine };
    ...
    static CharacterDispatch escLeftBracket6Dispatch = { 2, "~;", escLeftBracket6Routines };
    ...
    //
    static char32_t
    escLeftBracket0Routine(int in_fd_, int err_fd_, char32_t c)
    {
    ...
    static char32_t
    escLeftBracket9Routine(int in_fd_, int err_fd_, char32_t c)
    {
        return escFailureRoutine(in_fd_, err_fd_, c);
    }
    ...
    static CharacterDispatchRoutine escLeftBracketRoutines[] = { upArrowKeyRoutine,
        downArrowKeyRoutine, rightArrowKeyRoutine, leftArrowKeyRoutine, homeKeyRoutine,
        endKeyRoutine, shiftTabRoutine, escLeftBracket0Routine, escLeftBracket1Routine,
        escLeftBracket2Routine, escLeftBracket3Routine, escLeftBracket4Routine,
        escLeftBracket5Routine, escLeftBracket6Routine, escLeftBracket7Routine,
        escLeftBracket8Routine, escLeftBracket9Routine, escFailureRoutine };
    static CharacterDispatch escLeftBracketDispatch
        = { 17, "ABCDHFZ0123456789", escLeftBracketRoutines };

    // Handle ESC O <char> escape sequences
    //
    static CharacterDispatchRoutine escORoutines[] = { upArrowKeyRoutine, downArrowKeyRoutine,
        rightArrowKeyRoutine, leftArrowKeyRoutine, homeKeyRoutine, endKeyRoutine, f1KeyRoutine,
        f2KeyRoutine, f3KeyRoutine, f4KeyRoutine, ctrlUpArrowKeyRoutine, ctrlDownArrowKeyRoutine,
    ...
    static char32_t
    setMetaRoutine(int in_fd_, int err_fd_, char32_t c); // need forward reference
    ...
    //
    static char32_t
    setMetaRoutine(int in_fd_, int err_fd_, char32_t c)
    {
        thisKeyMetaCtrl = Replxx::KEY::BASE_META;
    ...
    char32_t
    doDispatch(int in_fd_, int err_fd_, char32_t c)
    {
