...
namespace Nelson {
    ...
    NLSINTERPRETER_IMPEXP wstringVector GetKeywords(bool bSorted = false);
    NLSINTERPRETER_IMPEXP bool isKeyword(std::wstring key);
    ...
    */
    typedef struct
    {
        char word[IDENTIFIER_LENGTH_MAX + 1];
        int  token;
        int  ordinal;
    } keywordStruct;
...
#define KEYWORDCOUNT 20
    ...
    */
    int compareKeyword(const void*, const void*);
