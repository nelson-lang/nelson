...
namespace Nelson {
    ...
    public:
        ...
        //=============================================================================
        static std::string information(struct _EXCEPTION_POINTERS* ep, exception_code_t code = 0) {
    ...
    //=============================================================================
    void translator_SE(InfoFromSE::exception_code_t code, struct _EXCEPTION_POINTERS* ep)
    {
...
#endif
    //=============================================================================
    ArrayOfVector EvaluateBuiltinCatchRuntimeException(Evaluator *eval, BuiltInFuncPtr fptr, ArrayOfVector& inputs, int nargout)
    {
