...
namespace Nelson {
    //=============================================================================
    void getSupportedCommentSymbols(stringVector &comments)
    {
        comments.clear();
        comments.push_back("//");
        comments.push_back("%");
    ...
    //=============================================================================
    void getSupportedCommentSymbols(wstringVector &comments)
    {
        comments.clear();
    ...
    //=============================================================================
    bool isCommentedLine(std::string line)
    {
    ...
    //=============================================================================
    bool isCommentedLine(std::wstring line)
    {
