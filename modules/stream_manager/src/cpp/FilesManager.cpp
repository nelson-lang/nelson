...
namespace Nelson {
    ...
    //=============================================================================
    int FilesManager::getAvailableFileID()
    {
        for (size_t i = 0; i < getNumberOfFiles(); i++)
        {
            if (userFiles[i] == nullptr)
    ...
    //=============================================================================
    bool FilesManager::isOpened(int fileID)
    {
        if (fileID < 0)
        {
            return false;
    ...
    //=============================================================================
    bool FilesManager::isStdIn(int fileID)
    {
        return (fileID == 0);
    }
    //=============================================================================
    bool FilesManager::isStdOut(int fileID)
    {
        return (fileID == 1);
    }
    //=============================================================================
    bool FilesManager::isStdErr(int fileID)
    {
        return (fileID == 2);
    }
    //=============================================================================
    bool FilesManager::isStdStream(int fileID)
    {
        return (isStdErr(fileID) || isStdOut(fileID) || isStdIn(fileID));
    }
    //=============================================================================
    bool FilesManager::isOpened(std::wstring filenameToSearch)
    {
        for (size_t i = 0; i < getNumberOfFiles(); i++)
        {
            if (userFiles[i] != nullptr)
    ...
    //=============================================================================
    int FilesManager::addFile(File *userfile)
    {
        if (userfile)
        {
    ...
    bool FilesManager::removeFile(int no)
    {
    ...
    //=============================================================================
    wstringVector FilesManager::getFilenames()
    {
    ...
    //=============================================================================
    wstringVector FilesManager::getMode()
    {
    ...
    //=============================================================================
    void *FilesManager::getFilePointer(int no)
    {
        if (no < 0)
        {
            return nullptr;
    ...
    //=============================================================================
    File *FilesManager::getFile(int no)
    {
        if (no < 0)
        {
            return nullptr;
    ...
    //=============================================================================
    File *FilesManager::getFile(std::wstring filename)
    {
        return nullptr;
    }
    //=============================================================================
    size_t FilesManager::getNumberOfFiles()
    {
        return userFiles.size();
    }
    //=============================================================================
    boost::container::vector<uint64> FilesManager::getIDs()
    {
