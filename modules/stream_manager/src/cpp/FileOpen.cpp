...
namespace Nelson {
    //=============================================================================
    static std::wstring getModeOsDependant(std::wstring mode)
    {
    ...
    //=============================================================================
    static bool isValidMode(std::wstring mode)
    {
    ...
    //=============================================================================
    FOPEN_ERROR_TYPE FileOpen(FilesManager *fm, std::wstring filename, std::wstring filemode, int &fileposition)
    {
...
#else
        FILE *fp = fopen(wstring_to_utf8(canonicalPath.wstring()).c_str(), wstring_to_utf8(getModeOsDependant(filemode)).c_str());
#endif
        if (fp == nullptr)
        {
            delete file;
