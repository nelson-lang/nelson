...
//=============================================================================
static bool
isInteger(single val)
{
    int valAsInt = *reinterpret_cast<int*>(&val);
    int exponent = ((valAsInt >> 23) & 0xFF) - 127;
    int bitsInFraction = 23 - exponent;
    int mask = exponent < 0 ? 0x7FFFFFFF : exponent > 23 ? 0x00 : (1 << bitsInFraction) - 1;
    return !(valAsInt & mask);
}
//=============================================================================
static bool
IsIntegerValues(ArrayOf A, single& minVal, single& maxVal)
{
    bool res = true;
...
//=============================================================================
static std::wstring
printNumber(single number, OutputFormatDisplay currentFormat, bool asInteger, bool asScalar)
{
...
//=============================================================================
static std::wstring
printNumber(single realpart, single imagpart, OutputFormatDisplay currentFormat, bool asInteger,
    bool asScalar)
{
    std::wstring strNumber = L"";
...
//=============================================================================
void
DisplaySingle(Interface* io, const ArrayOf& A, bool fromDispBuiltin, bool& needToOverload)
{
