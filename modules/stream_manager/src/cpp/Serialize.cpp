...
namespace Nelson {
    ...
    //=============================================================================
    void Serialize::sendSignature(const char sig, int count)
    {
        s->writeBytes(&sig, 1);
    ...
    //=============================================================================
    void Serialize::checkSignature(const char sig, int count)
    {
        char rtype = 0;
        s->readBytes(&rtype, 1);
        long rcount = 0;
    ...
    //=============================================================================
    void Serialize::putBools(const bool* ptr, int count)
    {
    }
    //=============================================================================
    void Serialize::putByte(char b)
    {
        putBytes(&b, 1);
    }
    //=============================================================================
    ...
    //=============================================================================
    void Serialize::putInt(int i)
    {
        putInts(&i, 1);
    }
    //=============================================================================
    void Serialize::putInts(const int *i, int count)
    {
        sendSignature('i', count);
        s->writeBytes(i, count * sizeof(int));
    }
    //=============================================================================
    void Serialize::putString(std::string str)
    {
        unsigned int len;
        sendSignature('x', 0);
        if ((str.empty()))
    ...
    //=============================================================================
    void Serialize::putWString(std::wstring wstr)
    {
        putString(wstring_to_utf8(wstr));
    }
    //=============================================================================
    void Serialize::putStringVector(stringVector vstr)
    {
        sendSignature('S', 1);
        putInt(vstr.size());
    ...
    //=============================================================================
    void Serialize::putWStringVector(wstringVector vwstr)
    {
        sendSignature('S', 1);
        putInt(vwstr.size());
    ...
    //=============================================================================
    void Serialize::getBools(bool *b, int count)
    {
    }
    //=============================================================================
    ...
    //=============================================================================
    void Serialize::getBytes(char *b, int count)
    {
    ...
    //=============================================================================
    void Serialize::getInts(int *i, int count)
    {
        checkSignature('i', count);
        s->readBytes(i, count * sizeof(int));
    }
    //=============================================================================
    std::string Serialize::getString()
    {
        std::string res;
        checkSignature('x', 0);
        unsigned int len = 0;
    ...
    //=============================================================================
    std::wstring Serialize::getWString()
    {
    ...
    //=============================================================================
    wstringVector Serialize::getWStringVector()
    {
        wstringVector res;
        checkSignature('S', 1);
        int L = getInt();
