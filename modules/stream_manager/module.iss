...
Source: {#RootPath}modules\{#MODULE_NAME}\tests\loadsavebin\*.m; DestDir: {app}\modules\{#MODULE_NAME}\tests\loadsavebin\; Flags: recursesubdirs;Components: {#COMPONENT_UNIT_TESTS};
Source: {#RootPath}modules\{#MODULE_NAME}\tests\*.bin; DestDir: {app}\modules\{#MODULE_NAME}\tests\; Flags: recursesubdirs;Components: {#COMPONENT_UNIT_TESTS};
