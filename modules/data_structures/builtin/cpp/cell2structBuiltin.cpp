...
//=============================================================================
ArrayOfVector Nelson::DataStructuresGateway::cell2structBuiltin(Evaluator* eval, int nLhs, const ArrayOfVector& argIn)
{
    ArrayOfVector ret;
    if (nLhs > 1)
    {
    ...
    if (!param1.isEmpty())
    {
        ...
        {
            throw Exception(_W("Number of field names must match number of fields in new structure."));
        }
    }
    ...
    if (dim == 0)
    {
        ...
        else
        {
            ...
            dims[1] = 1;
            dims[0] = dims1.getElementCount() / dims1[dim];
            ArrayOf *qp = (ArrayOf*)ArrayOf::allocateArrayOf(NLS_STRUCT_ARRAY, dims.getElementCount(), fieldnames);
