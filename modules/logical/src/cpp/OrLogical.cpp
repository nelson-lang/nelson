...
namespace Nelson {
    //=============================================================================
    void boolOr(size_t n, logical* c, const logical* a, const int stride1, const logical *b, const int stride2)
    {
        int m = 0;
        int p = 0;
    ...
    //=============================================================================
    ArrayOf OrLogical(ArrayOf A, ArrayOf B)
    {
        ArrayOf C;
        if ((A.getDataClass() == NLS_LOGICAL) && (B.getDataClass() == NLS_LOGICAL))
        {
            ...
            if (A.isScalar())
            {
                ...
                boolOr(Blen, Cp, (logical*)A.getDataPointer(), 0, (logical*)B.getDataPointer(), 1);
            ...
            else if (B.isScalar())
            {
                ...
                boolOr(Alen, Cp, (logical*)A.getDataPointer(), 1, (logical*)B.getDataPointer(), 0);
            ...
            else
            {
                size_t Alen(A.getLength());
                logical *Cp = new_with_exception<logical>(Alen);
                boolOr(Alen, Cp, (logical*)A.getDataPointer(), 1, (logical*)B.getDataPointer(), 1);
                C = ArrayOf(NLS_LOGICAL, A.getDimensions(), Cp);
            }
        }
        else
