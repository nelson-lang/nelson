...
//=============================================================================
static void checkArgument(Evaluator *eval, ArrayOf arg, bool &withCompleteNames,
                          int &nbOmits, bool &isCompleteNames,
                          bool &isNbOmits) {
...
//=============================================================================
static std::wstring shortName(std::wstring filename) {
...
Nelson::FunctionsGateway::dbstackBuiltin(Evaluator *eval, int nLhs,
  ...
  case 2: {
    ...
    checkArgument(eval, argIn[1], _withCompleteNames, _nbOmits, isCompleteNames,
                  isNbOmits);
    if (isCompleteNames) {
      withCompleteNames = isCompleteNames;
    }
