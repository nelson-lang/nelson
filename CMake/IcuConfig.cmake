...
if(${CMAKE_SYSTEM_NAME}
	...
	if(NOT CMAKE_ICU_PATH)
		...
		foreach(PATH ${POSSIBLE_ICU_PATHS})
			if(EXISTS
				...
				AND
				EXISTS
				"${PATH}/lib/libicuuc${CMAKE_SHARED_LIBRARY_SUFFIX}"
			)
	...
	if(CMAKE_ICU_PATH)
		...
		set(ICU_LIBRARIES
			"${CMAKE_ICU_PATH}/lib/libicuuc${CMAKE_SHARED_LIBRARY_SUFFIX};${CMAKE_ICU_PATH}/lib/libicui18n${CMAKE_SHARED_LIBRARY_SUFFIX}"
		)
	endif()
endif()
# ==============================================================================
...
if(ICU_INCLUDE_DIRS AND ICU_LIBRARIES)
	...
	if(${CMAKE_SYSTEM_NAME} MATCHES "Darwin" AND NOT DEFINED ENV{IN_NIX_SHELL})
		message(FATAL_ERROR
			"Please install: brew install icu4c and brew link icu4c --force "
		)
	else()
