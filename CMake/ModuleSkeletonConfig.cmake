...
if(EXISTS "${CMAKE_SOURCE_DIR}/module_skeleton")
  install(
    FILES ${CMAKE_SOURCE_DIR}/module_skeleton/etc/startup.m
    DESTINATION ${CMAKE_INSTALL_DATADIR}/${PROJECT_NAME}/module_skeleton/etc
  )
  install(
    FILES ${CMAKE_SOURCE_DIR}/module_skeleton/etc/finish.m
    DESTINATION ${CMAKE_INSTALL_DATADIR}/${PROJECT_NAME}/module_skeleton/etc
  )
  install(
    FILES ${CMAKE_SOURCE_DIR}/module_skeleton/loader.m
    DESTINATION ${CMAKE_INSTALL_DATADIR}/${PROJECT_NAME}/module_skeleton
    OPTIONAL
  )
  install(
    FILES ${CMAKE_SOURCE_DIR}/module_skeleton/builder.m
    DESTINATION ${CMAKE_INSTALL_DATADIR}/${PROJECT_NAME}/module_skeleton
  )
  install(
    FILES ${CMAKE_SOURCE_DIR}/module_skeleton/module.json
    DESTINATION ${CMAKE_INSTALL_DATADIR}/${PROJECT_NAME}/module_skeleton
  )
  install(
