...
if(LAPACK_FOUND)
  ...
  if(LAPACKE_STANDALONE OR NOT LAPACKE_WORKS)
    ...
    if(LAPACKE_LIBRARIES)
      ...
      if(CMAKE_C_COMPILER_ID MATCHES "GNU")
        find_library(FORTRAN_gfortran_LIBRARY
          NAMES
          gfortran
          HINTS
          ${_lib_env}
      ...
      elseif(CMAKE_C_COMPILER_ID MATCHES "Intel")
        find_library(FORTRAN_ifcore_LIBRARY
          NAMES
          ifcore
          HINTS
          ${_lib_env}
  ...
  if(NOT LAPACKE_FIND_QUIETLY)
    message(STATUS
      "LAPACKE requires LAPACK but LAPACK has not been found."
...
if(LAPACKE_LIBRARIES)
  ...
  if(${first_lib_path} MATCHES "(/lib(32|64)?$)|(/lib/intel64$|/lib/ia32$)")
    ...
    set(
      ...
      CACHE
        PATH
        "Installation directory of LAPACKE library"
      FORCE
    )
  else()
    set(
