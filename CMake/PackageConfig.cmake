...
if(UNIX)
  if(APPLE)
    ...
    set(CPACK_PACKAGE_FILE_NAME "nelson-Darwin-${TARGET_TRIPLE}-v${CPACK_PACKAGE_VERSION}")
  else(APPLE)
    set(CPACK_GENERATOR "TGZ")
    set(CPACK_PACKAGE_FILE_NAME "nelson-Unknown-${TARGET_TRIPLE}-v${CPACK_PACKAGE_VERSION}")
    ...
    if(NOT ${CMAKE_VERSION} VERSION_LESS "3.20.0" AND UBUNTU_FOUND)
      ...
      set(CPACK_PACKAGE_FILE_NAME "nelson-Ubuntu-${UBUNTU_VERSION}-${TARGET_TRIPLE}-v${CPACK_PACKAGE_VERSION}")
    ...
    if(DEBIAN_FOUND)
      message(STATUS "Package not managed. Contributions are welcome.")
      set(CPACK_GENERATOR "TGZ")
      set(CPACK_PACKAGE_FILE_NAME "nelson-Debian-${TARGET_TRIPLE}-v${CPACK_PACKAGE_VERSION}")
    endif()
  endif()
else()
  message(STATUS "Package not managed. Contributions are welcome.")
