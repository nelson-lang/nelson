...
# ==============================================================================
if(PORTAUDIO_FOUND)
  if(DEFINED ENV{CONDA_PREFIX} AND NOT DEFINED ENV{IN_NIX_SHELL})
    set(PORTAUDIO_LIBRARIES
      $ENV{CONDA_PREFIX}/lib/libportaudio${CMAKE_SHARED_LIBRARY_SUFFIX}
    )
  ...
  elseif(${CMAKE_SYSTEM_NAME}
    ...
    if(EXISTS "$ENV{HOMEBREW_PREFIX}/include/portaudio.h")
      ...
      set(PORTAUDIO_LIBRARIES
        $ENV{HOMEBREW_PREFIX}/lib/libportaudio${CMAKE_SHARED_LIBRARY_SUFFIX}
      )
    else()
      if(EXISTS "$ENV{HOMEBREW_CELLAR}/portaudio/19.7.0/include")
        set(PORTAUDIO_INCLUDE_DIRS
          $ENV{HOMEBREW_CELLAR}/portaudio/19.7.0/include
        )
      elseif(EXISTS "$ENV{HOMEBREW_CELLAR}/portaudio/19.6.0/include")
        set(PORTAUDIO_INCLUDE_DIRS
          $ENV{HOMEBREW_CELLAR}/portaudio/19.6.0/include
        )
      endif()
      if(EXISTS
        "$ENV{HOMEBREW_PREFIX}/lib/libportaudio${CMAKE_SHARED_LIBRARY_SUFFIX}"
  ...
  if(NOT
    ...
    NOT
    EXISTS
    "${PORTAUDIO_INCLUDE_DIRS}/portaudio.h"
  )
    message(WARNING
      "PortAudio include directory not found or invalid: ${PORTAUDIO_INCLUDE_DIRS}"
    )
    set(PORTAUDIO_FOUND FALSE)
  elseif(NOT PORTAUDIO_LIBRARIES OR NOT EXISTS "${PORTAUDIO_LIBRARIES}")
    message(WARNING
      "PortAudio library not found or invalid: ${PORTAUDIO_LIBRARIES}"
    )
    set(PORTAUDIO_FOUND FALSE)
  else()
    message(STATUS
      "Found PortAudio (${CMAKE_SYSTEM_NAME}):
