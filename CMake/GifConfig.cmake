...
if(WITHOUT_GIF)
	...
	if(DEFINED ENV{IN_NIX_SHELL})
		...
		if(NOT
			...
			AND
			EXISTS
			"$ENV{NIX_GIFLIB_PREFIX}/lib/libgif${CMAKE_SHARED_LIBRARY_SUFFIX}"
		)
			set(
				GIF_LIBRARIES
				"$ENV{NIX_GIFLIB_PREFIX}/lib/libgif${CMAKE_SHARED_LIBRARY_SUFFIX}"
	...
	elseif(DEFINED ENV{CONDA_PREFIX})
		...
		if(EXISTS "${CONDA_LIB_DIR}/libgif${CMAKE_SHARED_LIBRARY_SUFFIX}")
			set(
				GIF_LIBRARIES
				"${CONDA_LIB_DIR}/libgif${CMAKE_SHARED_LIBRARY_SUFFIX}"
				CACHE
					STRING
					"Path to giflib library"
				FORCE
	...
	elseif(DEFINED ENV{HOMEBREW_PREFIX})
		...
		if(EXISTS "${HOMEBREW_LIB_DIR}/libgif${CMAKE_SHARED_LIBRARY_SUFFIX}")
			set(
				GIF_LIBRARIES
				"${HOMEBREW_LIB_DIR}/libgif${CMAKE_SHARED_LIBRARY_SUFFIX}"
				CACHE
					STRING
					"Path to giflib library"
				FORCE
		...
		if(${CMAKE_SYSTEM_NAME} MATCHES "Darwin" AND)
			...
			if(NOT
				...
				AND
				EXISTS
				"${BREW_GIFLIB_PREFIX}/lib/libgif${CMAKE_SHARED_LIBRARY_SUFFIX}"
			)
				set(
					GIF_LIBRARIES
					"${BREW_GIFLIB_PREFIX}/lib/libgif${CMAKE_SHARED_LIBRARY_SUFFIX}"
