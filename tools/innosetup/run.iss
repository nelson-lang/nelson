...
#endif
;==============================================================================
Filename: "{app}\bin\{#BinPath}\MSMpiSetup.exe"; Parameters: " -unattend -minimal"; WorkingDir: {app}\bin\{#BinPath}; Components: {#COMPONENT_MPI};StatusMsg: Installing MS-MPI Redistributables...
;==============================================================================
