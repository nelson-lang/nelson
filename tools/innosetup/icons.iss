...
Name: "{commondesktop}\{#FULL_APPLICATION_NAME}"; Filename: "{app}\bin\{#BinPath}\{#APPLICATION_EXE_GUI_NAME}"; Tasks: desktopicon;Components: {#COMPONENT_GUI};
Name: "{commondesktop}\{#FULL_APPLICATION_NAME}"; Filename: "{app}\bin\{#BinPath}\{#APPLICATION_EXE_CLI_NAME}"; Tasks: desktopicon;Components: not {#COMPONENT_GUI};
;==============================================================================
