...
Root: HKCR; Subkey: {#APPLICATION_EXTENSION_M}\shell\{cm:RegKeyRunWith} Nelson\command; ValueType: string; ValueData: """{app}\bin\{#BinPath}\Nelson-gui.exe"" {#ARGUMENT_ACTION_EXECUTE} ""%1"""; Flags: deletekey uninsdeletekey noerror; Tasks: AssociateMFiles;Components: {#COMPONENT_TEXT_EDITOR};
;==============================================================================
;*.nh5
;==============================================================================
