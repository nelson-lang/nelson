...
if exist "%BAT_PATH%\..\..\..\nelson-thirdparty-arm\" (
    if exist "%BAT_PATH%\..\..\..\nelson-thirdparty-arm\.git" (
        ...
        echo The directory nelson-thirdparty-arm exists but is not a valid git repository.
    ...
    git clone https://github.com/nelson-lang/nelson-thirdparty-arm.git %BAT_PATH%\..\..\..\nelson-thirdparty-arm
    if errorlevel 1 (
...
if exist "%BAT_PATH%\..\..\..\qt_windows_arm\" (
    if exist "%BAT_PATH%\..\..\..\qt_windows_arm\.git" (
        echo Repository Qt already exists. Pulling latest changes...
        cd "%BAT_PATH%\..\..\..\qt_windows_arm"
        git pull
        if errorlevel 1 (
            echo Failed to pull the latest changes. Please check your internet connection or repository state.
            cd "%ORIGINAL_DIR%"
        ...
        echo The directory qt_windows_arm exists but is not a valid git repository.
        echo Please remove the directory and try again.
        cd "%ORIGINAL_DIR%"
        exit /b 1
    )
    ...
    echo Cloning the repository...
    git clone https://github.com/nelson-lang/qt_windows_arm.git %BAT_PATH%\..\..\..\qt_windows_arm
    if errorlevel 1 (
        echo Failed to clone the repository. Please check your internet connection or SSH configuration.
        cd "%ORIGINAL_DIR%"
        exit /b 1
...
rem =============================================================================
rem Resolve QTDIRARM64 to absolute path by temporarily changing directory
pushd "%BAT_PATH%\..\..\..\qt_windows_arm\6.9.0\msvc2022_arm" 2>nul
if errorlevel 1 (
    echo ERROR: Qt directory does not exist: "%BAT_PATH%\..\..\..\qt_windows_arm\6.9.0\msvc2022_arm"
    cd "%ORIGINAL_DIR%"
    exit /b 1
)
set QTDIRARM64=%CD%
popd
echo QTDIRARM64 resolved to: %QTDIRARM64%
rem =============================================================================
rem Check and execute the install.bat script
set INSTALL_SCRIPT=%BAT_PATH%\..\..\..\nelson-thirdparty-arm\install.bat
...
if "%1"=="remove-debug" (
    set REMOVE_DEBUG_SCRIPT=%BAT_PATH%\..\..\..\nelson-thirdparty-arm\remove_debug.bat
