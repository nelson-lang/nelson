...
print_status "Nelson - Installation script for Ubuntu 22.04 dependencies (minimal build)"
...
apt-get install -y build-essential make autotools-dev libtool automake \
                   pkg-config 
